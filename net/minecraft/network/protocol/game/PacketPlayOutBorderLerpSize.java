...
public class PacketPlayOutBorderLerpSize implements Packet<PacketListenerPlayOut> {
    private final double oldSize;
    private final double newSize;
    private final long lerpTime;

    public PacketPlayOutBorderLerpSize(WorldBorder worldBorder) {
        this.oldSize = worldBorder.getSize();
        this.newSize = worldBorder.getLerpTarget();
        this.lerpTime = worldBorder.getLerpRemainingTime();
    }

    public PacketPlayOutBorderLerpSize(PacketDataSerializer buf) {
