...
public class GUIComponentStatistics extends JComponent {
    private static final DecimalFormat DECIMAL_FORMAT = SystemUtils.make(new DecimalFormat("########0.000"), (decimalFormat) -> {
    ...
    public GUIComponentStatistics(MinecraftServer server) {
        this.server = server;
