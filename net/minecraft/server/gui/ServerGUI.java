...
public class ServerGUI extends JComponent {
    ...
    public static ServerGUI showFrameFor(DedicatedServer server) {
        try {
        ...
        final ServerGUI minecraftServerGui = new ServerGUI(server);
    ...
    private JComponent buildChatPanel() {
        ...
        jTextField.addActionListener((event) -> {
            ...
            if (!string.isEmpty()) {
                this.server.issueCommand(string, this.server.getServerCommandListener());
            }
