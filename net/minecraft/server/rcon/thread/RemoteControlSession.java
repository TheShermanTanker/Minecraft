...
public class RemoteControlSession extends RemoteConnectionThread {
    ...
    RemoteControlSession(IMinecraftServer server, String password, Socket socket) {
        ...
        while(true) {
            try {
                ...
                if (10 <= i) {
                    ...
                    j = j + 4;
                    int m = StatusChallengeUtils.intFromByteArray(this.buf, j);
                    j = j + 4;
                    switch(m) {
                    case 2:
                        if (this.authed) {
                            String string2 = StatusChallengeUtils.stringFromByteArray(this.buf, j, i);

                            try {
                                this.sendCmdResponse(l, this.serverInterface.executeRemoteCommand(string2));
                        ...
                        continue;
                    case 3:
                        String string = StatusChallengeUtils.stringFromByteArray(this.buf, j, i);
