...
public class PiglinBarterLoot implements Consumer<BiConsumer<MinecraftKey, LootTable.Builder>> {
    @Override
    public void accept(BiConsumer<MinecraftKey, LootTable.Builder> biConsumer) {
        biConsumer.accept(LootTables.PIGLIN_BARTERING, LootTable.lootTable().withPool(LootSelector.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.BOOK).setWeight(5).apply((new LootItemFunctionEnchant.Builder()).withEnchantment(Enchantments.SOUL_SPEED))).add(LootItem.lootTableItem(Items.IRON_BOOTS).setWeight(8).apply((new LootItemFunctionEnchant.Builder()).withEnchantment(Enchantments.SOUL_SPEED))).add(LootItem.lootTableItem(Items.POTION).setWeight(8).apply(LootItemFunctionSetTag.setTag(SystemUtils.make(new NBTTagCompound(), (compoundTag) -> {
            compoundTag.setString("Potion", "minecraft:fire_resistance");
        })))).add(LootItem.lootTableItem(Items.SPLASH_POTION).setWeight(8).apply(LootItemFunctionSetTag.setTag(SystemUtils.make(new NBTTagCompound(), (compoundTag) -> {
            compoundTag.setString("Potion", "minecraft:fire_resistance");
        })))).add(LootItem.lootTableItem(Items.POTION).setWeight(10).apply(LootItemFunctionSetTag.setTag(SystemUtils.make(new NBTTagCompound(), (compoundTag) -> {
