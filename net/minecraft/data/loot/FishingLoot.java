...
public class FishingLoot implements Consumer<BiConsumer<MinecraftKey, LootTable.Builder>> {
    ...
    public static final LootItemCondition.Builder IN_JUNGLE_HILLS = LootItemConditionLocationCheck.checkLocation(CriterionConditionLocation.Builder.location().setBiome(Biomes.JUNGLE_HILLS));
    public static final LootItemCondition.Builder IN_JUNGLE_EDGE = LootItemConditionLocationCheck.checkLocation(CriterionConditionLocation.Builder.location().setBiome(Biomes.JUNGLE_EDGE));
    ...
    public static final LootItemCondition.Builder IN_MODIFIED_JUNGLE = LootItemConditionLocationCheck.checkLocation(CriterionConditionLocation.Builder.location().setBiome(Biomes.MODIFIED_JUNGLE));
    public static final LootItemCondition.Builder IN_MODIFIED_JUNGLE_EDGE = LootItemConditionLocationCheck.checkLocation(CriterionConditionLocation.Builder.location().setBiome(Biomes.MODIFIED_JUNGLE_EDGE));
    public static final LootItemCondition.Builder IN_BAMBOO_JUNGLE_HILLS = LootItemConditionLocationCheck.checkLocation(CriterionConditionLocation.Builder.location().setBiome(Biomes.BAMBOO_JUNGLE_HILLS));
    ...
    public void accept(BiConsumer<MinecraftKey, LootTable.Builder> biConsumer) {
        ...
        biConsumer.accept(LootTables.FISHING_JUNK, LootTable.lootTable().withPool(LootSelector.lootPool().add(LootItem.lootTableItem(Blocks.LILY_PAD).setWeight(17)).add(LootItem.lootTableItem(Items.LEATHER_BOOTS).setWeight(10).apply(LootItemFunctionSetDamage.setDamage(UniformGenerator.between(0.0F, 0.9F)))).add(LootItem.lootTableItem(Items.LEATHER).setWeight(10)).add(LootItem.lootTableItem(Items.BONE).setWeight(10)).add(LootItem.lootTableItem(Items.POTION).setWeight(10).apply(LootItemFunctionSetTag.setTag(SystemUtils.make(new NBTTagCompound(), (compoundTag) -> {
            compoundTag.setString("Potion", "minecraft:water");
        })))).add(LootItem.lootTableItem(Items.STRING).setWeight(5)).add(LootItem.lootTableItem(Items.FISHING_ROD).setWeight(2).apply(LootItemFunctionSetDamage.setDamage(UniformGenerator.between(0.0F, 0.9F)))).add(LootItem.lootTableItem(Items.BOWL).setWeight(10)).add(LootItem.lootTableItem(Items.STICK).setWeight(5)).add(LootItem.lootTableItem(Items.INK_SAC).setWeight(1).apply(LootItemFunctionSetCount.setCount(ConstantValue.exactly(10.0F)))).add(LootItem.lootTableItem(Blocks.TRIPWIRE_HOOK).setWeight(10)).add(LootItem.lootTableItem(Items.ROTTEN_FLESH).setWeight(10)).add(LootItem.lootTableItem(Blocks.BAMBOO).when(IN_JUNGLE.or(IN_JUNGLE_HILLS).or(IN_JUNGLE_EDGE).or(IN_BAMBOO_JUNGLE).or(IN_MODIFIED_JUNGLE).or(IN_MODIFIED_JUNGLE_EDGE).or(IN_BAMBOO_JUNGLE_HILLS)).setWeight(10))));
