...
public class MiscOverworldPlacements {
    ...
    public static final PlacedFeature BLUE_ICE = PlacementUtils.register("blue_ice", MiscOverworldFeatures.BLUE_ICE.placed(CountPlacement.of(IntProviderUniform.of(0, 19)), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(30), VerticalAnchor.absolute(61)), BiomeFilter.biome()));
