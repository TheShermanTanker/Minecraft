...
import net.minecraft.util.valueproviders.IntProviderClamped;
...
public class VegetationPlacements {
    ...
    public static final PlacedFeature FLOWER_FOREST_FLOWERS = PlacementUtils.register("flower_forest_flowers", VegetationFeatures.FOREST_FLOWERS.placed(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(IntProviderClamped.of(IntProviderUniform.of(-1, 3), 0, 3)), BiomeFilter.biome()));
    public static final PlacedFeature FOREST_FLOWERS = PlacementUtils.register("forest_flowers", VegetationFeatures.FOREST_FLOWERS.placed(RarityFilter.onAverageOnceEvery(7), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(IntProviderClamped.of(IntProviderUniform.of(-3, 1), 0, 1)), BiomeFilter.biome()));
    ...
    public static List<PlacementModifier> treePlacement(PlacementModifier modifier, Block block) {
        return treePlacementBase(modifier).add(BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(block.getBlockData(), BlockPosition.ZERO))).build();
    }
}
