...
public abstract class BiomeRegistry {
    ...
    private static BiomeBase register(ResourceKey<BiomeBase> key, BiomeBase biome) {
        return RegistryGeneration.registerMapping(RegistryGeneration.BIOME, key, biome);
    }
