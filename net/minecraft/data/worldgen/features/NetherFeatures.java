...
public class NetherFeatures {
    public static final WorldGenFeatureConfigured<WorldGenFeatureDeltaConfiguration, ?> DELTA = FeatureUtils.register("delta", WorldGenerator.DELTA_FEATURE.configured(new WorldGenFeatureDeltaConfiguration(Blocks.LAVA.getBlockData(), Blocks.MAGMA_BLOCK.getBlockData(), IntProviderUniform.of(3, 7), IntProviderUniform.of(0, 2))));
    public static final WorldGenFeatureConfigured<WorldGenFeatureBasaltColumnsConfiguration, ?> SMALL_BASALT_COLUMNS = FeatureUtils.register("small_basalt_columns", WorldGenerator.BASALT_COLUMNS.configured(new WorldGenFeatureBasaltColumnsConfiguration(IntProviderConstant.of(1), IntProviderUniform.of(1, 4))));
    public static final WorldGenFeatureConfigured<WorldGenFeatureBasaltColumnsConfiguration, ?> LARGE_BASALT_COLUMNS = FeatureUtils.register("large_basalt_columns", WorldGenerator.BASALT_COLUMNS.configured(new WorldGenFeatureBasaltColumnsConfiguration(IntProviderUniform.of(2, 3), IntProviderUniform.of(5, 10))));
    public static final WorldGenFeatureConfigured<WorldGenFeatureRadiusConfiguration, ?> BASALT_BLOBS = FeatureUtils.register("basalt_blobs", WorldGenerator.REPLACE_BLOBS.configured(new WorldGenFeatureRadiusConfiguration(Blocks.NETHERRACK.getBlockData(), Blocks.BASALT.getBlockData(), IntProviderUniform.of(3, 7))));
    public static final WorldGenFeatureConfigured<WorldGenFeatureRadiusConfiguration, ?> BLACKSTONE_BLOBS = FeatureUtils.register("blackstone_blobs", WorldGenerator.REPLACE_BLOBS.configured(new WorldGenFeatureRadiusConfiguration(Blocks.NETHERRACK.getBlockData(), Blocks.BLACKSTONE.getBlockData(), IntProviderUniform.of(3, 7))));
    ...
    public static final WorldGenFeatureStateProviderWeighted CRIMSON_VEGETATION_PROVIDER = new WorldGenFeatureStateProviderWeighted(SimpleWeightedRandomList.<IBlockData>builder().add(Blocks.CRIMSON_ROOTS.getBlockData(), 87).add(Blocks.CRIMSON_FUNGUS.getBlockData(), 11).add(Blocks.WARPED_FUNGUS.getBlockData(), 1));
    public static final WorldGenFeatureConfigured<?, ?> CRIMSON_FOREST_VEGETATION = FeatureUtils.register("crimson_forest_vegetation", WorldGenerator.NETHER_FOREST_VEGETATION.configured(new NetherForestVegetationConfig(CRIMSON_VEGETATION_PROVIDER, 8, 4)));
    public static final WorldGenFeatureConfigured<?, ?> CRIMSON_FOREST_VEGETATION_BONEMEAL = FeatureUtils.register("crimson_forest_vegetation_bonemeal", WorldGenerator.NETHER_FOREST_VEGETATION.configured(new NetherForestVegetationConfig(CRIMSON_VEGETATION_PROVIDER, 3, 1)));
    public static final WorldGenFeatureStateProviderWeighted WARPED_VEGETATION_PROVIDER = new WorldGenFeatureStateProviderWeighted(SimpleWeightedRandomList.<IBlockData>builder().add(Blocks.WARPED_ROOTS.getBlockData(), 85).add(Blocks.CRIMSON_ROOTS.getBlockData(), 1).add(Blocks.WARPED_FUNGUS.getBlockData(), 13).add(Blocks.CRIMSON_FUNGUS.getBlockData(), 1));
    public static final WorldGenFeatureConfigured<?, ?> WARPED_FOREST_VEGETION = FeatureUtils.register("warped_forest_vegetation", WorldGenerator.NETHER_FOREST_VEGETATION.configured(new NetherForestVegetationConfig(WARPED_VEGETATION_PROVIDER, 8, 4)));
    public static final WorldGenFeatureConfigured<?, ?> WARPED_FOREST_VEGETATION_BONEMEAL = FeatureUtils.register("warped_forest_vegetation_bonemeal", WorldGenerator.NETHER_FOREST_VEGETATION.configured(new NetherForestVegetationConfig(WARPED_VEGETATION_PROVIDER, 3, 1)));
