...
public class PileFeatures {
    ...
    public static final WorldGenFeatureConfigured<?, ?> PILE_ICE = FeatureUtils.register("pile_ice", WorldGenerator.BLOCK_PILE.configured(new WorldGenFeatureBlockPileConfiguration(new WorldGenFeatureStateProviderWeighted(SimpleWeightedRandomList.<IBlockData>builder().add(Blocks.BLUE_ICE.getBlockData(), 1).add(Blocks.PACKED_ICE.getBlockData(), 5)))));
    public static final WorldGenFeatureConfigured<?, ?> PILE_PUMPKIN = FeatureUtils.register("pile_pumpkin", WorldGenerator.BLOCK_PILE.configured(new WorldGenFeatureBlockPileConfiguration(new WorldGenFeatureStateProviderWeighted(SimpleWeightedRandomList.<IBlockData>builder().add(Blocks.PUMPKIN.getBlockData(), 19).add(Blocks.JACK_O_LANTERN.getBlockData(), 1)))));
}
