...
public class NoiseData {
    public static NormalNoise$NoiseParameters bootstrap() {
        ...
        return RegistryGeneration.NOISE.iterator().next();
    }
    ...
    private static void register(ResourceKey<NormalNoise$NoiseParameters> noise, int firstOctave, double firstAmplitude, double... amplitudes) {
        RegistryGeneration.register(RegistryGeneration.NOISE, noise, new NormalNoise$NoiseParameters(firstOctave, firstAmplitude, amplitudes));
    }
}
