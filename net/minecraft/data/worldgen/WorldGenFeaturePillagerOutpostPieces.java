...
public class WorldGenFeaturePillagerOutpostPieces {
    ...
    static {
        WorldGenFeaturePieces.register(new WorldGenFeatureDefinedStructurePoolTemplate(new MinecraftKey("pillager_outpost/towers"), new MinecraftKey("empty"), ImmutableList.of(Pair.of(WorldGenFeatureDefinedStructurePoolStructure.list(ImmutableList.of(WorldGenFeatureDefinedStructurePoolStructure.legacy("pillager_outpost/watchtower"), WorldGenFeatureDefinedStructurePoolStructure.legacy("pillager_outpost/watchtower_overgrown", WorldGenProcessorLists.OUTPOST_ROT))), 1)), WorldGenFeatureDefinedStructurePoolTemplate.Matching.RIGID));
