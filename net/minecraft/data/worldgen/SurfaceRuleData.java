...
public class SurfaceRuleData {
    ...
    private static SurfaceRules.RuleSource makeStateRule(Block block) {
        return SurfaceRules.state(block.getBlockData());
    }
