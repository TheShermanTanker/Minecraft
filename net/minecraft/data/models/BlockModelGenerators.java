...
import net.minecraft.data.models.blockstates.BlockStateGeneratorMultiPart;
import net.minecraft.data.models.blockstates.BlockStateGeneratorMultiVariant;
...
public class BlockModelGenerators {
    final Consumer<IBlockStateGenerator> blockStateOutput;
    ...
    private static IBlockStateGenerator createMirroredCubeGenerator(Block block, MinecraftKey modelId, TextureMapping texture, BiConsumer<MinecraftKey, Supplier<JsonElement>> modelCollector) {
    ...
    private static IBlockStateGenerator createMirroredColumnGenerator(Block block, MinecraftKey modelId, TextureMapping texture, BiConsumer<MinecraftKey, Supplier<JsonElement>> modelCollector) {
    ...
    public BlockModelGenerators(Consumer<IBlockStateGenerator> blockStateCollector, BiConsumer<MinecraftKey, Supplier<JsonElement>> modelCollector, Consumer<Item> simpleItemModelExemptionCollector) {
    ...
    private static BlockStateGeneratorMultiVariant createRotatedVariant(Block block, MinecraftKey modelId) {
        return BlockStateGeneratorMultiVariant.multiVariant(block, createRotatedVariants(modelId));
    }
    ...
    static BlockStateGeneratorMultiVariant createSimpleBlock(Block block, MinecraftKey modelId) {
        return BlockStateGeneratorMultiVariant.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, modelId));
    }
    ...
    static IBlockStateGenerator createAxisAlignedPillarBlock(Block block, MinecraftKey modelId) {
        return BlockStateGeneratorMultiVariant.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, modelId)).with(createRotatedPillar());
    }
    ...
    private void createHorizontallyRotatedBlock(Block block, TexturedModel.Provider modelFactory) {
        MinecraftKey resourceLocation = modelFactory.create(block, this.modelOutput);
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with(createHorizontalFacingDispatch()));
    }

    static IBlockStateGenerator createRotatedPillarWithHorizontalVariant(Block block, MinecraftKey verticalModelId, MinecraftKey horizontalModelId) {
        return BlockStateGeneratorMultiVariant.multiVariant(block).with(PropertyDispatch.property(BlockProperties.AXIS).select(EnumDirection.EnumAxis.Y, Variant.variant().with(VariantProperties.MODEL, verticalModelId)).select(EnumDirection.EnumAxis.Z, Variant.variant().with(VariantProperties.MODEL, horizontalModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)).select(EnumDirection.EnumAxis.X, Variant.variant().with(VariantProperties.MODEL, horizontalModelId).with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)));
    }
    ...
    static IBlockStateGenerator createPressurePlate(Block pressurePlateBlock, MinecraftKey upModelId, MinecraftKey downModelId) {
        return BlockStateGeneratorMultiVariant.multiVariant(pressurePlateBlock).with(createBooleanModelDispatch(BlockProperties.POWERED, downModelId, upModelId));
    }

    static IBlockStateGenerator createSlab(Block slabBlock, MinecraftKey bottomModelId, MinecraftKey topModelId, MinecraftKey fullModelId) {
        return BlockStateGeneratorMultiVariant.multiVariant(slabBlock).with(PropertyDispatch.property(BlockProperties.SLAB_TYPE).select(BlockPropertySlabType.BOTTOM, Variant.variant().with(VariantProperties.MODEL, bottomModelId)).select(BlockPropertySlabType.TOP, Variant.variant().with(VariantProperties.MODEL, topModelId)).select(BlockPropertySlabType.DOUBLE, Variant.variant().with(VariantProperties.MODEL, fullModelId)));
    }
    ...
    private void createBigDripLeafBlock() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.BIG_DRIPLEAF).with(createHorizontalFacingDispatch()).with(PropertyDispatch.property(BlockProperties.TILT).select(Tilt.NONE, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select(Tilt.UNSTABLE, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select(Tilt.PARTIAL, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select(Tilt.FULL, Variant.variant().with(VariantProperties.MODEL, resourceLocation3))));
    }
    ...
    private void createCoralFans(Block coralFanBlock, Block coralWallFanBlock) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(coralWallFanBlock, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).with(createHorizontalFacingDispatch()));
    ...
    private void createStems(Block stemBlock, Block attachedStemBlock) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(attachedStemBlock, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with(PropertyDispatch.property(BlockProperties.HORIZONTAL_FACING).select(EnumDirection.WEST, Variant.variant()).select(EnumDirection.SOUTH, Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(EnumDirection.NORTH, Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(EnumDirection.EAST, Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180))));
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(stemBlock).with(PropertyDispatch.property(BlockProperties.AGE_7).generate((integer) -> {
    ...
    private void createSmallDripleaf() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.SMALL_DRIPLEAF).with(createHorizontalFacingDispatch()).with(PropertyDispatch.property(BlockProperties.DOUBLE_BLOCK_HALF).select(BlockPropertyDoubleBlockHalf.LOWER, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select(BlockPropertyDoubleBlockHalf.UPPER, Variant.variant().with(VariantProperties.MODEL, resourceLocation))));
    }

    private void createDoubleBlock(Block block, MinecraftKey upperHalfModelId, MinecraftKey lowerHalfModelId) {
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(block).with(PropertyDispatch.property(BlockProperties.DOUBLE_BLOCK_HALF).select(BlockPropertyDoubleBlockHalf.LOWER, Variant.variant().with(VariantProperties.MODEL, lowerHalfModelId)).select(BlockPropertyDoubleBlockHalf.UPPER, Variant.variant().with(VariantProperties.MODEL, upperHalfModelId))));
    }
    ...
    private void createPassiveRail(Block rail) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(rail).with(PropertyDispatch.property(BlockProperties.RAIL_SHAPE).select(BlockPropertyTrackPosition.NORTH_SOUTH, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).select(BlockPropertyTrackPosition.EAST_WEST, Variant.variant().with(VariantProperties.MODEL, resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyTrackPosition.ASCENDING_EAST, Variant.variant().with(VariantProperties.MODEL, resourceLocation3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyTrackPosition.ASCENDING_WEST, Variant.variant().with(VariantProperties.MODEL, resourceLocation4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyTrackPosition.ASCENDING_NORTH, Variant.variant().with(VariantProperties.MODEL, resourceLocation3)).select(BlockPropertyTrackPosition.ASCENDING_SOUTH, Variant.variant().with(VariantProperties.MODEL, resourceLocation4)).select(BlockPropertyTrackPosition.SOUTH_EAST, Variant.variant().with(VariantProperties.MODEL, resourceLocation2)).select(BlockPropertyTrackPosition.SOUTH_WEST, Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyTrackPosition.NORTH_WEST, Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(BlockPropertyTrackPosition.NORTH_EAST, Variant.variant().with(VariantProperties.MODEL, resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270))));
    }
    ...
    private void createActiveRail(Block rail) {
        ...
        this.createSimpleFlatItemModel(rail);
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(rail).with(propertyDispatch));
    }
    ...
    private void createColoredBlockWithStateRotations(TexturedModel.Provider modelFactory, Block... blocks) {
        for(Block block : blocks) {
            MinecraftKey resourceLocation = modelFactory.create(block, this.modelOutput);
            this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, resourceLocation)).with(createHorizontalFacingDispatchAlt()));
        }
    ...
    private void createBarrel() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.BARREL).with(this.createColumnWithFacing()).with(PropertyDispatch.property(BlockProperties.OPEN).select(false, Variant.variant().with(VariantProperties.MODEL, TexturedModel.CUBE_TOP_BOTTOM.create(Blocks.BARREL, this.modelOutput))).select(true, Variant.variant().with(VariantProperties.MODEL, TexturedModel.CUBE_TOP_BOTTOM.get(Blocks.BARREL).updateTextures((textureMapping) -> {
    ...
    private void createBeeNest(Block beehive, Function<Block, TextureMapping> textureGetter) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(beehive).with(createHorizontalFacingDispatch()).with(createEmptyOrFullDispatch(BlockProperties.LEVEL_HONEY, 5, resourceLocation2, resourceLocation)));
    }
    ...
    private void createCropBlock(Block crop, IBlockState<Integer> ageProperty, int... ageTextureIndices) {
        if (ageProperty.getValues().size() != ageTextureIndices.length) {
            ...
            this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(crop).with(propertyDispatch));
        }
    }
    ...
    private void createCampfires(Block... blocks) {
        ...
        for(Block block : blocks) {
            ...
            this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(block).with(createBooleanModelDispatch(BlockProperties.LIT, resourceLocation2, resourceLocation)).with(createHorizontalFacingDispatchAlt()));
        }
    ...
    private void createCakeBlock() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.CAKE).with(PropertyDispatch.property(BlockProperties.BITES).select(0, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE))).select(1, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE, "_slice1"))).select(2, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE, "_slice2"))).select(3, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE, "_slice3"))).select(4, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE, "_slice4"))).select(5, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE, "_slice5"))).select(6, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.CAKE, "_slice6")))));
    }
    ...
    private void createPointedDripstone() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.POINTED_DRIPSTONE).with(c2));
    }
    ...
    private void createDaylightDetector() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.DAYLIGHT_DETECTOR).with(PropertyDispatch.property(BlockProperties.INVERTED).select(false, Variant.variant().with(VariantProperties.MODEL, ModelTemplates.DAYLIGHT_DETECTOR.create(Blocks.DAYLIGHT_DETECTOR, textureMapping, this.modelOutput))).select(true, Variant.variant().with(VariantProperties.MODEL, ModelTemplates.DAYLIGHT_DETECTOR.create(ModelLocationUtils.getModelLocation(Blocks.DAYLIGHT_DETECTOR, "_inverted"), textureMapping2, this.modelOutput)))));
    }

    private void createRotatableColumn(Block block) {
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block))).with(this.createColumnWithFacing()));
    }
    ...
    private void createLightningRod() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(block, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block))).with(this.createColumnWithFacing()).with(createBooleanModelDispatch(BlockProperties.POWERED, resourceLocation, resourceLocation2)));
    }
    ...
    private void createFarmland() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.FARMLAND).with(createEmptyOrFullDispatch(BlockProperties.MOISTURE, 7, resourceLocation2, resourceLocation)));
    }
    ...
    private void createFire() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiPart.multiPart(Blocks.FIRE).with(condition, wrapModels(list, (variant) -> {
            return variant;
    ...
    private void createSoulFire() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiPart.multiPart(Blocks.SOUL_FIRE).with(wrapModels(list, (variant) -> {
            return variant;
    ...
    private void createGrassLikeBlock(Block topSoil, MinecraftKey modelId, Variant snowyVariant) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(topSoil).with(PropertyDispatch.property(BlockProperties.SNOWY).select(true, snowyVariant).select(false, list)));
    }

    private void createCocoa() {
        this.createSimpleFlatItemModel(Items.COCOA_BEANS);
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.COCOA).with(PropertyDispatch.property(BlockProperties.AGE_2).select(0, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.COCOA, "_stage0"))).select(1, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.COCOA, "_stage1"))).select(2, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.COCOA, "_stage2")))).with(createHorizontalFacingDispatchAlt()));
    }
    ...
    private void createWeightedPressurePlate(Block pressurePlate, Block textureSource) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(pressurePlate).with(createEmptyOrFullDispatch(BlockProperties.POWER, 1, resourceLocation2, resourceLocation)));
    }
    ...
    private void copyModel(Block modelSource, Block infested) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(infested, Variant.variant().with(VariantProperties.MODEL, resourceLocation)));
    ...
    private void createLever() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.LEVER).with(createBooleanModelDispatch(BlockProperties.POWERED, resourceLocation, resourceLocation2)).with(PropertyDispatch.properties(BlockProperties.ATTACH_FACE, BlockProperties.HORIZONTAL_FACING).select(BlockPropertyAttachPosition.CEILING, EnumDirection.NORTH, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(BlockPropertyAttachPosition.CEILING, EnumDirection.EAST, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(BlockPropertyAttachPosition.CEILING, EnumDirection.SOUTH, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R180)).select(BlockPropertyAttachPosition.CEILING, EnumDirection.WEST, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R180).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyAttachPosition.FLOOR, EnumDirection.NORTH, Variant.variant()).select(BlockPropertyAttachPosition.FLOOR, EnumDirection.EAST, Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyAttachPosition.FLOOR, EnumDirection.SOUTH, Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(BlockPropertyAttachPosition.FLOOR, EnumDirection.WEST, Variant.variant().with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)).select(BlockPropertyAttachPosition.WALL, EnumDirection.NORTH, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyAttachPosition.WALL, EnumDirection.EAST, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).select(BlockPropertyAttachPosition.WALL, EnumDirection.SOUTH, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)).select(BlockPropertyAttachPosition.WALL, EnumDirection.WEST, Variant.variant().with(VariantProperties.X_ROT, VariantProperties.Rotation.R90).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270))));
    }
    ...
    private void createObserver() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.OBSERVER).with(createBooleanModelDispatch(BlockProperties.POWERED, resourceLocation2, resourceLocation)).with(createFacingDispatch()));
    }
    ...
    private void createPistonVariant(Block piston, MinecraftKey extendedModelId, TextureMapping texture) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(piston).with(createBooleanModelDispatch(BlockProperties.EXTENDED, extendedModelId, resourceLocation)).with(createFacingDispatch()));
    }
    ...
    private void createSculkSensor() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.SCULK_SENSOR).with(PropertyDispatch.property(BlockProperties.SCULK_SENSOR_PHASE).generate((sculkSensorPhase) -> {
    ...
    private void createScaffolding() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.SCAFFOLDING).with(createBooleanModelDispatch(BlockProperties.BOTTOM, resourceLocation2, resourceLocation)));
    }
    ...
    private void createCaveVines() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.CAVE_VINES).with(createBooleanModelDispatch(BlockProperties.BERRIES, resourceLocation2, resourceLocation)));
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.CAVE_VINES_PLANT).with(createBooleanModelDispatch(BlockProperties.BERRIES, resourceLocation4, resourceLocation3)));
    }
    ...
    private void createRedstoneLamp() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.REDSTONE_LAMP).with(createBooleanModelDispatch(BlockProperties.LIT, resourceLocation2, resourceLocation)));
    }
    ...
    private void createNormalTorch(Block torch, Block wallTorch) {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(wallTorch, Variant.variant().with(VariantProperties.MODEL, ModelTemplates.WALL_TORCH.create(wallTorch, textureMapping, this.modelOutput))).with(createTorchHorizontalDispatch()));
    ...
    private void createRedstoneTorch() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.REDSTONE_TORCH).with(createBooleanModelDispatch(BlockProperties.LIT, resourceLocation, resourceLocation2)));
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.REDSTONE_WALL_TORCH).with(createBooleanModelDispatch(BlockProperties.LIT, resourceLocation3, resourceLocation4)).with(createTorchHorizontalDispatch()));
    ...
    private void createRepeater() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.REPEATER).with(PropertyDispatch.properties(BlockProperties.DELAY, BlockProperties.LOCKED, BlockProperties.POWERED).generate((integer, boolean_, boolean2) -> {
    ...
    private void createSnowBlocks() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.SNOW).with(PropertyDispatch.property(BlockProperties.LAYERS).generate((integer) -> {
    ...
    private void createStonecutter() {
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.STONECUTTER, Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.STONECUTTER))).with(createHorizontalFacingDispatch()));
    }
    ...
    private void createStructureBlock() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.STRUCTURE_BLOCK).with(PropertyDispatch.property(BlockProperties.STRUCTUREBLOCK_MODE).generate((structureMode) -> {
    ...
    private void createSweetBerryBush() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.SWEET_BERRY_BUSH).with(PropertyDispatch.property(BlockProperties.AGE_3).generate((integer) -> {
    ...
    private void createTurtleEgg() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.TURTLE_EGG).with(PropertyDispatch.properties(BlockProperties.EGGS, BlockProperties.HATCH).generateList((integer, integer2) -> {
    ...
    private void createRespawnAnchor() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.RESPAWN_ANCHOR).with(PropertyDispatch.property(BlockProperties.RESPAWN_ANCHOR_CHARGES).generate((integer) -> {
    ...
    private void createJigsaw() {
        ...
        this.blockStateOutput.accept(BlockStateGeneratorMultiVariant.multiVariant(Blocks.JIGSAW, Variant.variant().with(VariantProperties.MODEL, resourceLocation5)).with(PropertyDispatch.property(BlockProperties.ORIENTATION).generate((frontAndTop) -> {
    ...
    interface BlockStateGeneratorSupplier {
        IBlockStateGenerator create(Block block, MinecraftKey modelId, TextureMapping texture, BiConsumer<MinecraftKey, Supplier<JsonElement>> modelCollector);
    }
