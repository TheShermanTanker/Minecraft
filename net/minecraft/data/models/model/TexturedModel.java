...
public class TexturedModel {
    ...
    private TexturedModel(TextureMapping texture, ModelTemplate model) {
    ...
    public TexturedModel updateTextures(Consumer<TextureMapping> textureConsumer) {
        textureConsumer.accept(this.mapping);
        return this;
    }

    public MinecraftKey create(Block block, BiConsumer<MinecraftKey, Supplier<JsonElement>> writer) {
        return this.template.create(block, this.mapping, writer);
    }

    public MinecraftKey createWithSuffix(Block block, String suffix, BiConsumer<MinecraftKey, Supplier<JsonElement>> writer) {
        return this.template.createWithSuffix(block, suffix, this.mapping, writer);
    }

    private static TexturedModel.Provider createDefault(Function<Block, TextureMapping> textureGetter, ModelTemplate model) {
        return (block) -> {
            return new TexturedModel(textureGetter.apply(block), model);
        };
    }

    public static TexturedModel createAllSame(MinecraftKey id) {
    ...
    public interface Provider {
        ...
        default MinecraftKey create(Block block, BiConsumer<MinecraftKey, Supplier<JsonElement>> writer) {
            return this.get(block).create(block, writer);
        }

        default MinecraftKey createWithSuffix(Block block, String suffix, BiConsumer<MinecraftKey, Supplier<JsonElement>> writer) {
