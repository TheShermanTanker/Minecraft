...
public class ModelTemplates {
    ...
    private static ModelTemplate create(TextureSlot... requiredTextures) {
    ...
    private static ModelTemplate create(String parent, TextureSlot... requiredTextures) {
        return new ModelTemplate(Optional.of(new MinecraftKey("minecraft", "block/" + parent)), Optional.empty(), requiredTextures);
    }

    private static ModelTemplate createItem(String parent, TextureSlot... requiredTextures) {
        return new ModelTemplate(Optional.of(new MinecraftKey("minecraft", "item/" + parent)), Optional.empty(), requiredTextures);
    }

    private static ModelTemplate create(String parent, String variant, TextureSlot... requiredTextures) {
        return new ModelTemplate(Optional.of(new MinecraftKey("minecraft", "block/" + parent)), Optional.of(variant), requiredTextures);
    }
}
