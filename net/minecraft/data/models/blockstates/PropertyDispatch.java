...
public abstract class PropertyDispatch {
    ...
    private void verifyComplete() {
        List<IBlockState<?>> list = this.getDefinedProperties();
        Stream<Selector> stream = Stream.of(Selector.empty());

        for(IBlockState<?> property : list) {
    ...
    abstract List<IBlockState<?>> getDefinedProperties();

    public static <T1 extends Comparable<T1>> PropertyDispatch.C1<T1> property(IBlockState<T1> property) {
        return new PropertyDispatch.C1<>(property);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>> PropertyDispatch.C2<T1, T2> properties(IBlockState<T1> first, IBlockState<T2> second) {
        return new PropertyDispatch.C2<>(first, second);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> PropertyDispatch.C3<T1, T2, T3> properties(IBlockState<T1> first, IBlockState<T2> second, IBlockState<T3> third) {
        return new PropertyDispatch.C3<>(first, second, third);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> PropertyDispatch.C4<T1, T2, T3, T4> properties(IBlockState<T1> first, IBlockState<T2> second, IBlockState<T3> third, IBlockState<T4> fourth) {
        return new PropertyDispatch.C4<>(first, second, third, fourth);
    }

    public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>> PropertyDispatch.C5<T1, T2, T3, T4, T5> properties(IBlockState<T1> first, IBlockState<T2> second, IBlockState<T3> third, IBlockState<T4> fourth, IBlockState<T5> fifth) {
    ...
    public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
        private final IBlockState<T1> property1;

        C1(IBlockState<T1> property) {
            this.property1 = property;
        }

        @Override
        public List<IBlockState<?>> getDefinedProperties() {
        ...
        public PropertyDispatch generate(Function<T1, Variant> variantFactory) {
            this.property1.getValues().forEach((value) -> {
    ...
    public static class C2<T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends PropertyDispatch {
        private final IBlockState<T1> property1;
        private final IBlockState<T2> property2;

        C2(IBlockState<T1> first, IBlockState<T2> second) {
        ...
        public PropertyDispatch generate(BiFunction<T1, T2, Variant> variantFactory) {
            this.property1.getValues().forEach((firstValue) -> {
                this.property2.getValues().forEach((secondValue) -> {
    ...
    public static class C3<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends PropertyDispatch {
        private final IBlockState<T1> property1;
        private final IBlockState<T2> property2;
        private final IBlockState<T3> property3;

        C3(IBlockState<T1> first, IBlockState<T2> second, IBlockState<T3> third) {
            this.property1 = first;
            this.property2 = second;
        ...
        public PropertyDispatch generate(PropertyDispatch.TriFunction<T1, T2, T3, Variant> variantFactory) {
            this.property1.getValues().forEach((firstValue) -> {
                this.property2.getValues().forEach((secondValue) -> {
                    this.property3.getValues().forEach((thirdValue) -> {
    ...
    public static class C4<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch {
        ...
        private final IBlockState<T2> property2;
        private final IBlockState<T3> property3;
        private final IBlockState<T4> property4;

        C4(IBlockState<T1> first, IBlockState<T2> second, IBlockState<T3> third, IBlockState<T4> fourth) {
            this.property1 = first;
            this.property2 = second;
            this.property3 = third;
        ...
        public PropertyDispatch generate(PropertyDispatch.QuadFunction<T1, T2, T3, T4, Variant> variantFactory) {
            this.property1.getValues().forEach((firstValue) -> {
                this.property2.getValues().forEach((secondValue) -> {
                    this.property3.getValues().forEach((thirdValue) -> {
                        this.property4.getValues().forEach((fourthValue) -> {
    ...
    public static class C5<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>> extends PropertyDispatch {
        ...
        private final IBlockState<T3> property3;
        private final IBlockState<T4> property4;
        private final IBlockState<T5> property5;

        C5(IBlockState<T1> first, IBlockState<T2> second, IBlockState<T3> third, IBlockState<T4> fourth, IBlockState<T5> fifth) {
            this.property1 = first;
            this.property2 = second;
            this.property3 = third;
            this.property4 = fourth;
        ...
        public PropertyDispatch generate(PropertyDispatch.PentaFunction<T1, T2, T3, T4, T5, Variant> variantFactory) {
            this.property1.getValues().forEach((firstValue) -> {
                this.property2.getValues().forEach((secondValue) -> {
                    this.property3.getValues().forEach((thirdValue) -> {
                        this.property4.getValues().forEach((fourthValue) -> {
                            this.property5.getValues().forEach((fifthValue) -> {
