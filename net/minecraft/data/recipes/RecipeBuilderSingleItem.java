...
public class RecipeBuilderSingleItem implements IRecipeBuilder {
    ...
    public RecipeBuilderSingleItem(RecipeSerializer<?> serializer, RecipeItemStack input, IMaterial output, int outputCount) {
    ...
    public static RecipeBuilderSingleItem stonecutting(RecipeItemStack input, IMaterial output) {
        return new RecipeBuilderSingleItem(RecipeSerializer.STONECUTTER, input, output, 1);
    }

    public static RecipeBuilderSingleItem stonecutting(RecipeItemStack input, IMaterial output, int outputCount) {
        return new RecipeBuilderSingleItem(RecipeSerializer.STONECUTTER, input, output, outputCount);
    }

    @Override
    public RecipeBuilderSingleItem unlockedBy(String string, CriterionInstance criterionTriggerInstance) {
        this.advancement.addCriterion(string, criterionTriggerInstance);
        return this;
    }

    @Override
    public RecipeBuilderSingleItem group(@Nullable String string) {
        this.group = string;
        return this;
    }
    ...
    public void save(Consumer<IFinishedRecipe> exporter, MinecraftKey recipeId) {
        ...
        exporter.accept(new RecipeBuilderSingleItem.Result(recipeId, this.type, this.group == null ? "" : this.group, this.ingredient, this.result, this.count, this.advancement, new MinecraftKey(recipeId.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + recipeId.getKey())));
    }
