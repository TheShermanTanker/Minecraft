...
public class RecipeBuilderShaped implements IRecipeBuilder {
    ...
    public RecipeBuilderShaped(IMaterial output, int outputCount) {
        this.result = output.getItem();
        this.count = outputCount;
    }

    public static RecipeBuilderShaped shaped(IMaterial output) {
        return shaped(output, 1);
    }

    public static RecipeBuilderShaped shaped(IMaterial output, int outputCount) {
        return new RecipeBuilderShaped(output, outputCount);
    }

    public RecipeBuilderShaped define(Character c, Tag<Item> tag) {
        return this.define(c, RecipeItemStack.of(tag));
    }

    public RecipeBuilderShaped define(Character c, IMaterial itemProvider) {
        return this.define(c, RecipeItemStack.of(itemProvider));
    }

    public RecipeBuilderShaped define(Character c, RecipeItemStack ingredient) {
    ...
    public RecipeBuilderShaped pattern(String patternStr) {
    ...
    @Override
    public RecipeBuilderShaped unlockedBy(String string, CriterionInstance criterionTriggerInstance) {
        this.advancement.addCriterion(string, criterionTriggerInstance);
        return this;
    }

    @Override
    public RecipeBuilderShaped group(@Nullable String string) {
        this.group = string;
        return this;
    }
    ...
    public void save(Consumer<IFinishedRecipe> exporter, MinecraftKey recipeId) {
        ...
        exporter.accept(new RecipeBuilderShaped.Result(recipeId, this.result, this.count, this.group == null ? "" : this.group, this.rows, this.key, this.advancement, new MinecraftKey(recipeId.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + recipeId.getKey())));
    }
