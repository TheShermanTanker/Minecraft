...
import net.minecraft.server.commands.CommandItem;
...
import net.minecraft.server.commands.CommandPerf;
...
public class CommandDispatcher {
    ...
    public CommandDispatcher(CommandDispatcher.ServerType environment) {
        ...
        CommandItem.register(this.dispatcher);
        ...
        if (environment.includeDedicated) {
            ...
            CommandPerf.register(this.dispatcher);
