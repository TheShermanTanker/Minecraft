...
public class VoxelShapeMergerDisjoint extends AbstractDoubleList implements VoxelShapeMerger {
    ...
    protected VoxelShapeMergerDisjoint(DoubleList first, DoubleList second, boolean inverted) {
        this.lower = first;
        this.upper = second;
        this.swap = inverted;
    }
    ...
    private boolean forNonSwappedIndexes(VoxelShapeMerger.IndexConsumer indexConsumer) {
