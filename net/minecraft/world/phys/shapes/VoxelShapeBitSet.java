...
public final class VoxelShapeBitSet extends VoxelShapeDiscrete {
    ...
    public VoxelShapeBitSet(int sizeX, int sizeY, int sizeZ) {
    ...
    public static VoxelShapeBitSet withFilledBounds(int sizeX, int sizeY, int sizeZ, int minX, int minY, int minZ, int maxX, int maxY, int maxZ) {
        VoxelShapeBitSet bitSetDiscreteVoxelShape = new VoxelShapeBitSet(sizeX, sizeY, sizeZ);
    ...
    public VoxelShapeBitSet(VoxelShapeDiscrete other) {
        super(other.xSize, other.ySize, other.zSize);
        if (other instanceof VoxelShapeBitSet) {
            this.storage = (BitSet)((VoxelShapeBitSet)other).storage.clone();
        } else {
        ...
        this.xMin = other.firstFull(EnumDirection.EnumAxis.X);
        this.yMin = other.firstFull(EnumDirection.EnumAxis.Y);
        this.zMin = other.firstFull(EnumDirection.EnumAxis.Z);
        this.xMax = other.lastFull(EnumDirection.EnumAxis.X);
        this.yMax = other.lastFull(EnumDirection.EnumAxis.Y);
        this.zMax = other.lastFull(EnumDirection.EnumAxis.Z);
    }
    ...
    static VoxelShapeBitSet join(VoxelShapeDiscrete first, VoxelShapeDiscrete second, VoxelShapeMerger xPoints, VoxelShapeMerger yPoints, VoxelShapeMerger zPoints, OperatorBoolean function) {
        VoxelShapeBitSet bitSetDiscreteVoxelShape = new VoxelShapeBitSet(xPoints.size() - 1, yPoints.size() - 1, zPoints.size() - 1);
    ...
    protected static void forAllBoxes(VoxelShapeDiscrete discreteVoxelShape, VoxelShapeDiscrete.IntLineConsumer intLineConsumer, boolean bl) {
        VoxelShapeBitSet bitSetDiscreteVoxelShape = new VoxelShapeBitSet(discreteVoxelShape);
