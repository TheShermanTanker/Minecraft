...
public enum EnumArmorMaterial implements ArmorMaterial {
    ...
    private EnumArmorMaterial(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEffect equipSound, float toughness, float knockbackResistance, Supplier<RecipeItemStack> repairIngredientSupplier) {
        this.name = name;
        ...
        this.repairIngredient = new LazyInitVar<>(repairIngredientSupplier);
    }

    @Override
    public int getDurabilityForSlot(EnumItemSlot slot) {
        return HEALTH_PER_SLOT[slot.getIndex()] * this.durabilityMultiplier;
    }

    @Override
    public int getDefenseForSlot(EnumItemSlot slot) {
