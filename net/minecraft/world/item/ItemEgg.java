...
public class ItemEgg extends Item {
    ...
    public InteractionResultWrapper<ItemStack> use(World world, EntityHuman user, EnumHand hand) {
        ...
        world.playSound((EntityHuman)null, user.locX(), user.locY(), user.locZ(), SoundEffects.EGG_THROW, EnumSoundCategory.PLAYERS, 0.5F, 0.4F / (world.getRandom().nextFloat() * 0.4F + 0.8F));
