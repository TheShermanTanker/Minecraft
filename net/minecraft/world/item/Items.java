...
public class Items {
    public static final Item AIR = registerBlock(Blocks.AIR, new ItemAir(Blocks.AIR, new Item.Info()));
    ...
    public static final Item ANCIENT_DEBRIS = registerBlock(new ItemBlock(Blocks.ANCIENT_DEBRIS, (new Item.Info()).tab(CreativeModeTab.TAB_BUILDING_BLOCKS).fireResistant()));
    ...
    public static final Item NETHERITE_BLOCK = registerBlock(new ItemBlock(Blocks.NETHERITE_BLOCK, (new Item.Info()).tab(CreativeModeTab.TAB_BUILDING_BLOCKS).fireResistant()));
    ...
    public static final Item SMALL_DRIPLEAF = registerBlock(new ItemBisected(Blocks.SMALL_DRIPLEAF, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    public static final Item TORCH = registerBlock(new ItemBlockWallable(Blocks.TORCH, Blocks.WALL_TORCH, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    public static final Item SPAWNER = registerBlock(new ItemBlock(Blocks.SPAWNER, (new Item.Info()).rarity(EnumItemRarity.EPIC)));
    ...
    public static final Item SOUL_TORCH = registerBlock(new ItemBlockWallable(Blocks.SOUL_TORCH, Blocks.SOUL_WALL_TORCH, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    public static final Item LILY_PAD = registerBlock(new ItemWaterLily(Blocks.LILY_PAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    public static final Item COMMAND_BLOCK = registerBlock(new ItemRestricted(Blocks.COMMAND_BLOCK, (new Item.Info()).rarity(EnumItemRarity.EPIC)));
    public static final Item BEACON = registerBlock(new ItemBlock(Blocks.BEACON, (new Item.Info()).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    ...
    public static final Item SUNFLOWER = registerBlock(new ItemBisected(Blocks.SUNFLOWER, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LILAC = registerBlock(new ItemBisected(Blocks.LILAC, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item ROSE_BUSH = registerBlock(new ItemBisected(Blocks.ROSE_BUSH, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PEONY = registerBlock(new ItemBisected(Blocks.PEONY, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item TALL_GRASS = registerBlock(new ItemBisected(Blocks.TALL_GRASS, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LARGE_FERN = registerBlock(new ItemBisected(Blocks.LARGE_FERN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    public static final Item REPEATING_COMMAND_BLOCK = registerBlock(new ItemRestricted(Blocks.REPEATING_COMMAND_BLOCK, (new Item.Info()).rarity(EnumItemRarity.EPIC)));
    public static final Item CHAIN_COMMAND_BLOCK = registerBlock(new ItemRestricted(Blocks.CHAIN_COMMAND_BLOCK, (new Item.Info()).rarity(EnumItemRarity.EPIC)));
    ...
    public static final Item SHULKER_BOX = registerBlock(new ItemBlock(Blocks.SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item WHITE_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.WHITE_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item ORANGE_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.ORANGE_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item MAGENTA_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.MAGENTA_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIGHT_BLUE_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.LIGHT_BLUE_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item YELLOW_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.YELLOW_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIME_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.LIME_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PINK_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.PINK_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GRAY_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.GRAY_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIGHT_GRAY_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.LIGHT_GRAY_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item CYAN_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.CYAN_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PURPLE_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.PURPLE_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLUE_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.BLUE_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BROWN_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.BROWN_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GREEN_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.GREEN_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item RED_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.RED_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLACK_SHULKER_BOX = registerBlock(new ItemBlock(Blocks.BLACK_SHULKER_BOX, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    ...
    public static final Item TUBE_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.TUBE_CORAL_FAN, Blocks.TUBE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BRAIN_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.BRAIN_CORAL_FAN, Blocks.BRAIN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BUBBLE_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.BUBBLE_CORAL_FAN, Blocks.BUBBLE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item FIRE_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.FIRE_CORAL_FAN, Blocks.FIRE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item HORN_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.HORN_CORAL_FAN, Blocks.HORN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.DEAD_TUBE_CORAL_FAN, Blocks.DEAD_TUBE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.DEAD_BRAIN_CORAL_FAN, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.DEAD_BUBBLE_CORAL_FAN, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.DEAD_FIRE_CORAL_FAN, Blocks.DEAD_FIRE_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item DEAD_HORN_CORAL_FAN = registerBlock(new ItemBlockWallable(Blocks.DEAD_HORN_CORAL_FAN, Blocks.DEAD_HORN_CORAL_WALL_FAN, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLUE_ICE = registerBlock(Blocks.BLUE_ICE, CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final Item CONDUIT = registerBlock(new ItemBlock(Blocks.CONDUIT, (new Item.Info()).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    ...
    public static final Item SCAFFOLDING = registerBlock(new ItemScaffolding(Blocks.SCAFFOLDING, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item REDSTONE = registerItem("redstone", new ItemNamedBlock(Blocks.REDSTONE_WIRE, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item REDSTONE_TORCH = registerBlock(new ItemBlockWallable(Blocks.REDSTONE_TORCH, Blocks.REDSTONE_WALL_TORCH, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    ...
    public static final Item IRON_DOOR = registerBlock(new ItemBisected(Blocks.IRON_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item OAK_DOOR = registerBlock(new ItemBisected(Blocks.OAK_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item SPRUCE_DOOR = registerBlock(new ItemBisected(Blocks.SPRUCE_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item BIRCH_DOOR = registerBlock(new ItemBisected(Blocks.BIRCH_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item JUNGLE_DOOR = registerBlock(new ItemBisected(Blocks.JUNGLE_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item ACACIA_DOOR = registerBlock(new ItemBisected(Blocks.ACACIA_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item DARK_OAK_DOOR = registerBlock(new ItemBisected(Blocks.DARK_OAK_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item CRIMSON_DOOR = registerBlock(new ItemBisected(Blocks.CRIMSON_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    public static final Item WARPED_DOOR = registerBlock(new ItemBisected(Blocks.WARPED_DOOR, (new Item.Info()).tab(CreativeModeTab.TAB_REDSTONE)));
    ...
    public static final Item SADDLE = registerItem("saddle", new ItemSaddle((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item MINECART = registerItem("minecart", new ItemMinecart(EntityMinecartAbstract.EnumMinecartType.RIDEABLE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item CHEST_MINECART = registerItem("chest_minecart", new ItemMinecart(EntityMinecartAbstract.EnumMinecartType.CHEST, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item FURNACE_MINECART = registerItem("furnace_minecart", new ItemMinecart(EntityMinecartAbstract.EnumMinecartType.FURNACE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item TNT_MINECART = registerItem("tnt_minecart", new ItemMinecart(EntityMinecartAbstract.EnumMinecartType.TNT, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item HOPPER_MINECART = registerItem("hopper_minecart", new ItemMinecart(EntityMinecartAbstract.EnumMinecartType.HOPPER, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item CARROT_ON_A_STICK = registerItem("carrot_on_a_stick", new ItemCarrotStick<>((new Item.Info()).durability(25).tab(CreativeModeTab.TAB_TRANSPORTATION), EntityTypes.PIG, 7));
    public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem("warped_fungus_on_a_stick", new ItemCarrotStick<>((new Item.Info()).durability(100).tab(CreativeModeTab.TAB_TRANSPORTATION), EntityTypes.STRIDER, 1));
    public static final Item ELYTRA = registerItem("elytra", new ItemElytra((new Item.Info()).durability(432).tab(CreativeModeTab.TAB_TRANSPORTATION).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item OAK_BOAT = registerItem("oak_boat", new ItemBoat(EntityBoat.EnumBoatType.OAK, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item SPRUCE_BOAT = registerItem("spruce_boat", new ItemBoat(EntityBoat.EnumBoatType.SPRUCE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item BIRCH_BOAT = registerItem("birch_boat", new ItemBoat(EntityBoat.EnumBoatType.BIRCH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item JUNGLE_BOAT = registerItem("jungle_boat", new ItemBoat(EntityBoat.EnumBoatType.JUNGLE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item ACACIA_BOAT = registerItem("acacia_boat", new ItemBoat(EntityBoat.EnumBoatType.ACACIA, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item DARK_OAK_BOAT = registerItem("dark_oak_boat", new ItemBoat(EntityBoat.EnumBoatType.DARK_OAK, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
    public static final Item STRUCTURE_BLOCK = registerBlock(new ItemRestricted(Blocks.STRUCTURE_BLOCK, (new Item.Info()).rarity(EnumItemRarity.EPIC)));
    public static final Item JIGSAW = registerBlock(new ItemRestricted(Blocks.JIGSAW, (new Item.Info()).rarity(EnumItemRarity.EPIC)));
    public static final Item TURTLE_HELMET = registerItem("turtle_helmet", new ItemArmor(EnumArmorMaterial.TURTLE, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item SCUTE = registerItem("scute", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item FLINT_AND_STEEL = registerItem("flint_and_steel", new ItemFlintAndSteel((new Item.Info()).durability(64).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item APPLE = registerItem("apple", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.APPLE)));
    public static final Item BOW = registerItem("bow", new ItemBow((new Item.Info()).durability(384).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item ARROW = registerItem("arrow", new ItemArrow((new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item COAL = registerItem("coal", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item CHARCOAL = registerItem("charcoal", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item DIAMOND = registerItem("diamond", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item EMERALD = registerItem("emerald", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item LAPIS_LAZULI = registerItem("lapis_lazuli", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item QUARTZ = registerItem("quartz", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item AMETHYST_SHARD = registerItem("amethyst_shard", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item RAW_IRON = registerItem("raw_iron", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item IRON_INGOT = registerItem("iron_ingot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item RAW_COPPER = registerItem("raw_copper", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item COPPER_INGOT = registerItem("copper_ingot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item RAW_GOLD = registerItem("raw_gold", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item GOLD_INGOT = registerItem("gold_ingot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item NETHERITE_INGOT = registerItem("netherite_ingot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS).fireResistant()));
    public static final Item NETHERITE_SCRAP = registerItem("netherite_scrap", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS).fireResistant()));
    public static final Item WOODEN_SWORD = registerItem("wooden_sword", new ItemSword(EnumToolMaterial.WOOD, 3, -2.4F, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", new ItemSpade(EnumToolMaterial.WOOD, 1.5F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", new ItemPickaxe(EnumToolMaterial.WOOD, 1, -2.8F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item WOODEN_AXE = registerItem("wooden_axe", new ItemAxe(EnumToolMaterial.WOOD, 6.0F, -3.2F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item WOODEN_HOE = registerItem("wooden_hoe", new ItemHoe(EnumToolMaterial.WOOD, 0, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item STONE_SWORD = registerItem("stone_sword", new ItemSword(EnumToolMaterial.STONE, 3, -2.4F, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item STONE_SHOVEL = registerItem("stone_shovel", new ItemSpade(EnumToolMaterial.STONE, 1.5F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", new ItemPickaxe(EnumToolMaterial.STONE, 1, -2.8F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item STONE_AXE = registerItem("stone_axe", new ItemAxe(EnumToolMaterial.STONE, 7.0F, -3.2F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item STONE_HOE = registerItem("stone_hoe", new ItemHoe(EnumToolMaterial.STONE, -1, -2.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item GOLDEN_SWORD = registerItem("golden_sword", new ItemSword(EnumToolMaterial.GOLD, 3, -2.4F, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", new ItemSpade(EnumToolMaterial.GOLD, 1.5F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", new ItemPickaxe(EnumToolMaterial.GOLD, 1, -2.8F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item GOLDEN_AXE = registerItem("golden_axe", new ItemAxe(EnumToolMaterial.GOLD, 6.0F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item GOLDEN_HOE = registerItem("golden_hoe", new ItemHoe(EnumToolMaterial.GOLD, 0, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item IRON_SWORD = registerItem("iron_sword", new ItemSword(EnumToolMaterial.IRON, 3, -2.4F, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item IRON_SHOVEL = registerItem("iron_shovel", new ItemSpade(EnumToolMaterial.IRON, 1.5F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", new ItemPickaxe(EnumToolMaterial.IRON, 1, -2.8F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item IRON_AXE = registerItem("iron_axe", new ItemAxe(EnumToolMaterial.IRON, 6.0F, -3.1F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item IRON_HOE = registerItem("iron_hoe", new ItemHoe(EnumToolMaterial.IRON, -2, -1.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item DIAMOND_SWORD = registerItem("diamond_sword", new ItemSword(EnumToolMaterial.DIAMOND, 3, -2.4F, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", new ItemSpade(EnumToolMaterial.DIAMOND, 1.5F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", new ItemPickaxe(EnumToolMaterial.DIAMOND, 1, -2.8F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item DIAMOND_AXE = registerItem("diamond_axe", new ItemAxe(EnumToolMaterial.DIAMOND, 5.0F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item DIAMOND_HOE = registerItem("diamond_hoe", new ItemHoe(EnumToolMaterial.DIAMOND, -3, 0.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item NETHERITE_SWORD = registerItem("netherite_sword", new ItemSword(EnumToolMaterial.NETHERITE, 3, -2.4F, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final Item NETHERITE_SHOVEL = registerItem("netherite_shovel", new ItemSpade(EnumToolMaterial.NETHERITE, 1.5F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
    public static final Item NETHERITE_PICKAXE = registerItem("netherite_pickaxe", new ItemPickaxe(EnumToolMaterial.NETHERITE, 1, -2.8F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
    public static final Item NETHERITE_AXE = registerItem("netherite_axe", new ItemAxe(EnumToolMaterial.NETHERITE, 5.0F, -3.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
    public static final Item NETHERITE_HOE = registerItem("netherite_hoe", new ItemHoe(EnumToolMaterial.NETHERITE, -4, 0.0F, (new Item.Info()).tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
    public static final Item STICK = registerItem("stick", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BOWL = registerItem("bowl", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item MUSHROOM_STEW = registerItem("mushroom_stew", new ItemSoup((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_FOOD).food(Foods.MUSHROOM_STEW)));
    public static final Item STRING = registerItem("string", new ItemNamedBlock(Blocks.TRIPWIRE, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item FEATHER = registerItem("feather", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item GUNPOWDER = registerItem("gunpowder", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item WHEAT_SEEDS = registerItem("wheat_seeds", new ItemNamedBlock(Blocks.WHEAT, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item WHEAT = registerItem("wheat", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BREAD = registerItem("bread", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.BREAD)));
    public static final Item LEATHER_HELMET = registerItem("leather_helmet", new ItemArmorColorable(EnumArmorMaterial.LEATHER, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item LEATHER_CHESTPLATE = registerItem("leather_chestplate", new ItemArmorColorable(EnumArmorMaterial.LEATHER, EnumItemSlot.CHEST, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item LEATHER_LEGGINGS = registerItem("leather_leggings", new ItemArmorColorable(EnumArmorMaterial.LEATHER, EnumItemSlot.LEGS, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item LEATHER_BOOTS = registerItem("leather_boots", new ItemArmorColorable(EnumArmorMaterial.LEATHER, EnumItemSlot.FEET, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item CHAINMAIL_HELMET = registerItem("chainmail_helmet", new ItemArmor(EnumArmorMaterial.CHAIN, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item CHAINMAIL_CHESTPLATE = registerItem("chainmail_chestplate", new ItemArmor(EnumArmorMaterial.CHAIN, EnumItemSlot.CHEST, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item CHAINMAIL_LEGGINGS = registerItem("chainmail_leggings", new ItemArmor(EnumArmorMaterial.CHAIN, EnumItemSlot.LEGS, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item CHAINMAIL_BOOTS = registerItem("chainmail_boots", new ItemArmor(EnumArmorMaterial.CHAIN, EnumItemSlot.FEET, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item IRON_HELMET = registerItem("iron_helmet", new ItemArmor(EnumArmorMaterial.IRON, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item IRON_CHESTPLATE = registerItem("iron_chestplate", new ItemArmor(EnumArmorMaterial.IRON, EnumItemSlot.CHEST, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item IRON_LEGGINGS = registerItem("iron_leggings", new ItemArmor(EnumArmorMaterial.IRON, EnumItemSlot.LEGS, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item IRON_BOOTS = registerItem("iron_boots", new ItemArmor(EnumArmorMaterial.IRON, EnumItemSlot.FEET, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item DIAMOND_HELMET = registerItem("diamond_helmet", new ItemArmor(EnumArmorMaterial.DIAMOND, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item DIAMOND_CHESTPLATE = registerItem("diamond_chestplate", new ItemArmor(EnumArmorMaterial.DIAMOND, EnumItemSlot.CHEST, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item DIAMOND_LEGGINGS = registerItem("diamond_leggings", new ItemArmor(EnumArmorMaterial.DIAMOND, EnumItemSlot.LEGS, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item DIAMOND_BOOTS = registerItem("diamond_boots", new ItemArmor(EnumArmorMaterial.DIAMOND, EnumItemSlot.FEET, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item GOLDEN_HELMET = registerItem("golden_helmet", new ItemArmor(EnumArmorMaterial.GOLD, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item GOLDEN_CHESTPLATE = registerItem("golden_chestplate", new ItemArmor(EnumArmorMaterial.GOLD, EnumItemSlot.CHEST, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item GOLDEN_LEGGINGS = registerItem("golden_leggings", new ItemArmor(EnumArmorMaterial.GOLD, EnumItemSlot.LEGS, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item GOLDEN_BOOTS = registerItem("golden_boots", new ItemArmor(EnumArmorMaterial.GOLD, EnumItemSlot.FEET, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item NETHERITE_HELMET = registerItem("netherite_helmet", new ItemArmor(EnumArmorMaterial.NETHERITE, EnumItemSlot.HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final Item NETHERITE_CHESTPLATE = registerItem("netherite_chestplate", new ItemArmor(EnumArmorMaterial.NETHERITE, EnumItemSlot.CHEST, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final Item NETHERITE_LEGGINGS = registerItem("netherite_leggings", new ItemArmor(EnumArmorMaterial.NETHERITE, EnumItemSlot.LEGS, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final Item NETHERITE_BOOTS = registerItem("netherite_boots", new ItemArmor(EnumArmorMaterial.NETHERITE, EnumItemSlot.FEET, (new Item.Info()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final Item FLINT = registerItem("flint", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item PORKCHOP = registerItem("porkchop", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.PORKCHOP)));
    public static final Item COOKED_PORKCHOP = registerItem("cooked_porkchop", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_PORKCHOP)));
    public static final Item PAINTING = registerItem("painting", new ItemHanging(EntityTypes.PAINTING, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GOLDEN_APPLE = registerItem("golden_apple", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).rarity(EnumItemRarity.RARE).food(Foods.GOLDEN_APPLE)));
    public static final Item ENCHANTED_GOLDEN_APPLE = registerItem("enchanted_golden_apple", new ItemGoldenAppleEnchanted((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).rarity(EnumItemRarity.EPIC).food(Foods.ENCHANTED_GOLDEN_APPLE)));
    public static final Item OAK_SIGN = registerItem("oak_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.OAK_SIGN, Blocks.OAK_WALL_SIGN));
    public static final Item SPRUCE_SIGN = registerItem("spruce_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.SPRUCE_SIGN, Blocks.SPRUCE_WALL_SIGN));
    public static final Item BIRCH_SIGN = registerItem("birch_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.BIRCH_SIGN, Blocks.BIRCH_WALL_SIGN));
    public static final Item JUNGLE_SIGN = registerItem("jungle_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.JUNGLE_SIGN, Blocks.JUNGLE_WALL_SIGN));
    public static final Item ACACIA_SIGN = registerItem("acacia_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.ACACIA_SIGN, Blocks.ACACIA_WALL_SIGN));
    public static final Item DARK_OAK_SIGN = registerItem("dark_oak_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.DARK_OAK_SIGN, Blocks.DARK_OAK_WALL_SIGN));
    public static final Item CRIMSON_SIGN = registerItem("crimson_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.CRIMSON_SIGN, Blocks.CRIMSON_WALL_SIGN));
    public static final Item WARPED_SIGN = registerItem("warped_sign", new ItemSign((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS), Blocks.WARPED_SIGN, Blocks.WARPED_WALL_SIGN));
    public static final Item BUCKET = registerItem("bucket", new ItemBucket(FluidTypes.EMPTY, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WATER_BUCKET = registerItem("water_bucket", new ItemBucket(FluidTypes.WATER, (new Item.Info()).craftRemainder(BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item LAVA_BUCKET = registerItem("lava_bucket", new ItemBucket(FluidTypes.LAVA, (new Item.Info()).craftRemainder(BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item POWDER_SNOW_BUCKET = registerItem("powder_snow_bucket", new SolidBucketItem(Blocks.POWDER_SNOW, SoundEffects.BUCKET_EMPTY_POWDER_SNOW, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SNOWBALL = registerItem("snowball", new ItemSnowball((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_MISC)));
    public static final Item LEATHER = registerItem("leather", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item MILK_BUCKET = registerItem("milk_bucket", new ItemMilkBucket((new Item.Info()).craftRemainder(BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PUFFERFISH_BUCKET = registerItem("pufferfish_bucket", new MobBucketItem(EntityTypes.PUFFERFISH, FluidTypes.WATER, SoundEffects.BUCKET_EMPTY_FISH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SALMON_BUCKET = registerItem("salmon_bucket", new MobBucketItem(EntityTypes.SALMON, FluidTypes.WATER, SoundEffects.BUCKET_EMPTY_FISH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item COD_BUCKET = registerItem("cod_bucket", new MobBucketItem(EntityTypes.COD, FluidTypes.WATER, SoundEffects.BUCKET_EMPTY_FISH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item TROPICAL_FISH_BUCKET = registerItem("tropical_fish_bucket", new MobBucketItem(EntityTypes.TROPICAL_FISH, FluidTypes.WATER, SoundEffects.BUCKET_EMPTY_FISH, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item AXOLOTL_BUCKET = registerItem("axolotl_bucket", new MobBucketItem(EntityTypes.AXOLOTL, FluidTypes.WATER, SoundEffects.BUCKET_EMPTY_AXOLOTL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item BRICK = registerItem("brick", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item CLAY_BALL = registerItem("clay_ball", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item DRIED_KELP_BLOCK = registerBlock(Blocks.DRIED_KELP_BLOCK, CreativeModeTab.TAB_BUILDING_BLOCKS);
    public static final Item PAPER = registerItem("paper", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item BOOK = registerItem("book", new ItemBook((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SLIME_BALL = registerItem("slime_ball", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item EGG = registerItem("egg", new ItemEgg((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item COMPASS = registerItem("compass", new ItemCompass((new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item BUNDLE = registerItem("bundle", new BundleItem((new Item.Info()).stacksTo(1).tab(ifPart2(CreativeModeTab.TAB_TOOLS).orElse((CreativeModeTab)null))));
    public static final Item FISHING_ROD = registerItem("fishing_rod", new ItemFishingRod((new Item.Info()).durability(64).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item CLOCK = registerItem("clock", new Item((new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item SPYGLASS = registerItem("spyglass", new SpyglassItem((new Item.Info()).tab(CreativeModeTab.TAB_TOOLS).stacksTo(1)));
    public static final Item GLOWSTONE_DUST = registerItem("glowstone_dust", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item COD = registerItem("cod", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COD)));
    public static final Item SALMON = registerItem("salmon", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.SALMON)));
    public static final Item TROPICAL_FISH = registerItem("tropical_fish", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.TROPICAL_FISH)));
    public static final Item PUFFERFISH = registerItem("pufferfish", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.PUFFERFISH)));
    public static final Item COOKED_COD = registerItem("cooked_cod", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_COD)));
    public static final Item COOKED_SALMON = registerItem("cooked_salmon", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_SALMON)));
    public static final Item INK_SAC = registerItem("ink_sac", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item GLOW_INK_SAC = registerItem("glow_ink_sac", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item COCOA_BEANS = registerItem("cocoa_beans", new ItemNamedBlock(Blocks.COCOA, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item WHITE_DYE = registerItem("white_dye", new ItemDye(EnumColor.WHITE, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item ORANGE_DYE = registerItem("orange_dye", new ItemDye(EnumColor.ORANGE, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item MAGENTA_DYE = registerItem("magenta_dye", new ItemDye(EnumColor.MAGENTA, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item LIGHT_BLUE_DYE = registerItem("light_blue_dye", new ItemDye(EnumColor.LIGHT_BLUE, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item YELLOW_DYE = registerItem("yellow_dye", new ItemDye(EnumColor.YELLOW, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item LIME_DYE = registerItem("lime_dye", new ItemDye(EnumColor.LIME, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item PINK_DYE = registerItem("pink_dye", new ItemDye(EnumColor.PINK, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item GRAY_DYE = registerItem("gray_dye", new ItemDye(EnumColor.GRAY, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item LIGHT_GRAY_DYE = registerItem("light_gray_dye", new ItemDye(EnumColor.LIGHT_GRAY, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item CYAN_DYE = registerItem("cyan_dye", new ItemDye(EnumColor.CYAN, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item PURPLE_DYE = registerItem("purple_dye", new ItemDye(EnumColor.PURPLE, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BLUE_DYE = registerItem("blue_dye", new ItemDye(EnumColor.BLUE, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BROWN_DYE = registerItem("brown_dye", new ItemDye(EnumColor.BROWN, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item GREEN_DYE = registerItem("green_dye", new ItemDye(EnumColor.GREEN, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item RED_DYE = registerItem("red_dye", new ItemDye(EnumColor.RED, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BLACK_DYE = registerItem("black_dye", new ItemDye(EnumColor.BLACK, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BONE_MEAL = registerItem("bone_meal", new ItemBoneMeal((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BONE = registerItem("bone", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SUGAR = registerItem("sugar", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item CAKE = registerBlock(new ItemBlock(Blocks.CAKE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_FOOD)));
    public static final Item WHITE_BED = registerBlock(new ItemBed(Blocks.WHITE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item ORANGE_BED = registerBlock(new ItemBed(Blocks.ORANGE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item MAGENTA_BED = registerBlock(new ItemBed(Blocks.MAGENTA_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIGHT_BLUE_BED = registerBlock(new ItemBed(Blocks.LIGHT_BLUE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item YELLOW_BED = registerBlock(new ItemBed(Blocks.YELLOW_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIME_BED = registerBlock(new ItemBed(Blocks.LIME_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PINK_BED = registerBlock(new ItemBed(Blocks.PINK_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GRAY_BED = registerBlock(new ItemBed(Blocks.GRAY_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIGHT_GRAY_BED = registerBlock(new ItemBed(Blocks.LIGHT_GRAY_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item CYAN_BED = registerBlock(new ItemBed(Blocks.CYAN_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PURPLE_BED = registerBlock(new ItemBed(Blocks.PURPLE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLUE_BED = registerBlock(new ItemBed(Blocks.BLUE_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BROWN_BED = registerBlock(new ItemBed(Blocks.BROWN_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GREEN_BED = registerBlock(new ItemBed(Blocks.GREEN_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item RED_BED = registerBlock(new ItemBed(Blocks.RED_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLACK_BED = registerBlock(new ItemBed(Blocks.BLACK_BED, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item COOKIE = registerItem("cookie", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKIE)));
    public static final Item FILLED_MAP = registerItem("filled_map", new ItemWorldMap(new Item.Info()));
    public static final Item SHEARS = registerItem("shears", new ItemShears((new Item.Info()).durability(238).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item MELON_SLICE = registerItem("melon_slice", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.MELON_SLICE)));
    public static final Item DRIED_KELP = registerItem("dried_kelp", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.DRIED_KELP)));
    public static final Item PUMPKIN_SEEDS = registerItem("pumpkin_seeds", new ItemNamedBlock(Blocks.PUMPKIN_STEM, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item MELON_SEEDS = registerItem("melon_seeds", new ItemNamedBlock(Blocks.MELON_STEM, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BEEF = registerItem("beef", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.BEEF)));
    public static final Item COOKED_BEEF = registerItem("cooked_beef", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_BEEF)));
    public static final Item CHICKEN = registerItem("chicken", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.CHICKEN)));
    public static final Item COOKED_CHICKEN = registerItem("cooked_chicken", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_CHICKEN)));
    public static final Item ROTTEN_FLESH = registerItem("rotten_flesh", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.ROTTEN_FLESH)));
    public static final Item ENDER_PEARL = registerItem("ender_pearl", new ItemEnderPearl((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_MISC)));
    public static final Item BLAZE_ROD = registerItem("blaze_rod", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item GHAST_TEAR = registerItem("ghast_tear", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item GOLD_NUGGET = registerItem("gold_nugget", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item NETHER_WART = registerItem("nether_wart", new ItemNamedBlock(Blocks.NETHER_WART, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item POTION = registerItem("potion", new ItemPotion((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item GLASS_BOTTLE = registerItem("glass_bottle", new ItemGlassBottle((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item SPIDER_EYE = registerItem("spider_eye", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.SPIDER_EYE)));
    public static final Item FERMENTED_SPIDER_EYE = registerItem("fermented_spider_eye", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item BLAZE_POWDER = registerItem("blaze_powder", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item MAGMA_CREAM = registerItem("magma_cream", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    ...
    public static final Item ENDER_EYE = registerItem("ender_eye", new ItemEnderEye((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GLISTERING_MELON_SLICE = registerItem("glistering_melon_slice", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item AXOLOTL_SPAWN_EGG = registerItem("axolotl_spawn_egg", new ItemMonsterEgg(EntityTypes.AXOLOTL, 16499171, 10890612, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item BAT_SPAWN_EGG = registerItem("bat_spawn_egg", new ItemMonsterEgg(EntityTypes.BAT, 4996656, 986895, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item BEE_SPAWN_EGG = registerItem("bee_spawn_egg", new ItemMonsterEgg(EntityTypes.BEE, 15582019, 4400155, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", new ItemMonsterEgg(EntityTypes.BLAZE, 16167425, 16775294, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item CAT_SPAWN_EGG = registerItem("cat_spawn_egg", new ItemMonsterEgg(EntityTypes.CAT, 15714446, 9794134, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item CAVE_SPIDER_SPAWN_EGG = registerItem("cave_spider_spawn_egg", new ItemMonsterEgg(EntityTypes.CAVE_SPIDER, 803406, 11013646, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", new ItemMonsterEgg(EntityTypes.CHICKEN, 10592673, 16711680, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item COD_SPAWN_EGG = registerItem("cod_spawn_egg", new ItemMonsterEgg(EntityTypes.COD, 12691306, 15058059, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item COW_SPAWN_EGG = registerItem("cow_spawn_egg", new ItemMonsterEgg(EntityTypes.COW, 4470310, 10592673, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", new ItemMonsterEgg(EntityTypes.CREEPER, 894731, 0, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", new ItemMonsterEgg(EntityTypes.DOLPHIN, 2243405, 16382457, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", new ItemMonsterEgg(EntityTypes.DONKEY, 5457209, 8811878, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", new ItemMonsterEgg(EntityTypes.DROWNED, 9433559, 7969893, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ELDER_GUARDIAN_SPAWN_EGG = registerItem("elder_guardian_spawn_egg", new ItemMonsterEgg(EntityTypes.ELDER_GUARDIAN, 13552826, 7632531, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", new ItemMonsterEgg(EntityTypes.ENDERMAN, 1447446, 0, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", new ItemMonsterEgg(EntityTypes.ENDERMITE, 1447446, 7237230, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", new ItemMonsterEgg(EntityTypes.EVOKER, 9804699, 1973274, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item FOX_SPAWN_EGG = registerItem("fox_spawn_egg", new ItemMonsterEgg(EntityTypes.FOX, 14005919, 13396256, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", new ItemMonsterEgg(EntityTypes.GHAST, 16382457, 12369084, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GLOW_SQUID_SPAWN_EGG = registerItem("glow_squid_spawn_egg", new ItemMonsterEgg(EntityTypes.GLOW_SQUID, 611926, 8778172, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GOAT_SPAWN_EGG = registerItem("goat_spawn_egg", new ItemMonsterEgg(EntityTypes.GOAT, 10851452, 5589310, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", new ItemMonsterEgg(EntityTypes.GUARDIAN, 5931634, 15826224, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", new ItemMonsterEgg(EntityTypes.HOGLIN, 13004373, 6251620, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", new ItemMonsterEgg(EntityTypes.HORSE, 12623485, 15656192, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", new ItemMonsterEgg(EntityTypes.HUSK, 7958625, 15125652, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", new ItemMonsterEgg(EntityTypes.LLAMA, 12623485, 10051392, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem("magma_cube_spawn_egg", new ItemMonsterEgg(EntityTypes.MAGMA_CUBE, 3407872, 16579584, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", new ItemMonsterEgg(EntityTypes.MOOSHROOM, 10489616, 12040119, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item MULE_SPAWN_EGG = registerItem("mule_spawn_egg", new ItemMonsterEgg(EntityTypes.MULE, 1769984, 5321501, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", new ItemMonsterEgg(EntityTypes.OCELOT, 15720061, 5653556, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", new ItemMonsterEgg(EntityTypes.PANDA, 15198183, 1776418, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", new ItemMonsterEgg(EntityTypes.PARROT, 894731, 16711680, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", new ItemMonsterEgg(EntityTypes.PHANTOM, 4411786, 8978176, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", new ItemMonsterEgg(EntityTypes.PIG, 15771042, 14377823, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", new ItemMonsterEgg(EntityTypes.PIGLIN, 10051392, 16380836, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem("piglin_brute_spawn_egg", new ItemMonsterEgg(EntityTypes.PIGLIN_BRUTE, 5843472, 16380836, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", new ItemMonsterEgg(EntityTypes.PILLAGER, 5451574, 9804699, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item POLAR_BEAR_SPAWN_EGG = registerItem("polar_bear_spawn_egg", new ItemMonsterEgg(EntityTypes.POLAR_BEAR, 15921906, 9803152, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PUFFERFISH_SPAWN_EGG = registerItem("pufferfish_spawn_egg", new ItemMonsterEgg(EntityTypes.PUFFERFISH, 16167425, 3654642, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", new ItemMonsterEgg(EntityTypes.RABBIT, 10051392, 7555121, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", new ItemMonsterEgg(EntityTypes.RAVAGER, 7697520, 5984329, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", new ItemMonsterEgg(EntityTypes.SALMON, 10489616, 951412, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", new ItemMonsterEgg(EntityTypes.SHEEP, 15198183, 16758197, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", new ItemMonsterEgg(EntityTypes.SHULKER, 9725844, 5060690, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", new ItemMonsterEgg(EntityTypes.SILVERFISH, 7237230, 3158064, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", new ItemMonsterEgg(EntityTypes.SKELETON, 12698049, 4802889, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SKELETON_HORSE_SPAWN_EGG = registerItem("skeleton_horse_spawn_egg", new ItemMonsterEgg(EntityTypes.SKELETON_HORSE, 6842447, 15066584, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", new ItemMonsterEgg(EntityTypes.SLIME, 5349438, 8306542, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", new ItemMonsterEgg(EntityTypes.SPIDER, 3419431, 11013646, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", new ItemMonsterEgg(EntityTypes.SQUID, 2243405, 7375001, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", new ItemMonsterEgg(EntityTypes.STRAY, 6387319, 14543594, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", new ItemMonsterEgg(EntityTypes.STRIDER, 10236982, 5065037, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem("trader_llama_spawn_egg", new ItemMonsterEgg(EntityTypes.TRADER_LLAMA, 15377456, 4547222, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item TROPICAL_FISH_SPAWN_EGG = registerItem("tropical_fish_spawn_egg", new ItemMonsterEgg(EntityTypes.TROPICAL_FISH, 15690005, 16775663, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", new ItemMonsterEgg(EntityTypes.TURTLE, 15198183, 44975, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item VEX_SPAWN_EGG = registerItem("vex_spawn_egg", new ItemMonsterEgg(EntityTypes.VEX, 8032420, 15265265, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", new ItemMonsterEgg(EntityTypes.VILLAGER, 5651507, 12422002, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", new ItemMonsterEgg(EntityTypes.VINDICATOR, 9804699, 2580065, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem("wandering_trader_spawn_egg", new ItemMonsterEgg(EntityTypes.WANDERING_TRADER, 4547222, 15377456, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", new ItemMonsterEgg(EntityTypes.WITCH, 3407872, 5349438, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem("wither_skeleton_spawn_egg", new ItemMonsterEgg(EntityTypes.WITHER_SKELETON, 1315860, 4672845, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", new ItemMonsterEgg(EntityTypes.WOLF, 14144467, 13545366, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", new ItemMonsterEgg(EntityTypes.ZOGLIN, 13004373, 15132390, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", new ItemMonsterEgg(EntityTypes.ZOMBIE, 44975, 7969893, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ZOMBIE_HORSE_SPAWN_EGG = registerItem("zombie_horse_spawn_egg", new ItemMonsterEgg(EntityTypes.ZOMBIE_HORSE, 3232308, 9945732, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = registerItem("zombie_villager_spawn_egg", new ItemMonsterEgg(EntityTypes.ZOMBIE_VILLAGER, 5651507, 7969893, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem("zombified_piglin_spawn_egg", new ItemMonsterEgg(EntityTypes.ZOMBIFIED_PIGLIN, 15373203, 5009705, (new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item EXPERIENCE_BOTTLE = registerItem("experience_bottle", new ItemExpBottle((new Item.Info()).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item FIRE_CHARGE = registerItem("fire_charge", new ItemFireball((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WRITABLE_BOOK = registerItem("writable_book", new ItemBookAndQuill((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item WRITTEN_BOOK = registerItem("written_book", new ItemWrittenBook((new Item.Info()).stacksTo(16)));
    public static final Item ITEM_FRAME = registerItem("item_frame", new ItemItemFrame(EntityTypes.ITEM_FRAME, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GLOW_ITEM_FRAME = registerItem("glow_item_frame", new ItemItemFrame(EntityTypes.GLOW_ITEM_FRAME, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item FLOWER_POT = registerBlock(Blocks.FLOWER_POT, CreativeModeTab.TAB_DECORATIONS);
    public static final Item CARROT = registerItem("carrot", new ItemNamedBlock(Blocks.CARROTS, (new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.CARROT)));
    public static final Item POTATO = registerItem("potato", new ItemNamedBlock(Blocks.POTATOES, (new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.POTATO)));
    public static final Item BAKED_POTATO = registerItem("baked_potato", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.BAKED_POTATO)));
    public static final Item POISONOUS_POTATO = registerItem("poisonous_potato", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.POISONOUS_POTATO)));
    public static final Item MAP = registerItem("map", new ItemMapEmpty((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GOLDEN_CARROT = registerItem("golden_carrot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING).food(Foods.GOLDEN_CARROT)));
    public static final Item SKELETON_SKULL = registerBlock(new ItemBlockWallable(Blocks.SKELETON_SKULL, Blocks.SKELETON_WALL_SKULL, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item WITHER_SKELETON_SKULL = registerBlock(new ItemBlockWallable(Blocks.WITHER_SKELETON_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item PLAYER_HEAD = registerBlock(new ItemSkullPlayer(Blocks.PLAYER_HEAD, Blocks.PLAYER_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item ZOMBIE_HEAD = registerBlock(new ItemBlockWallable(Blocks.ZOMBIE_HEAD, Blocks.ZOMBIE_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item CREEPER_HEAD = registerBlock(new ItemBlockWallable(Blocks.CREEPER_HEAD, Blocks.CREEPER_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item DRAGON_HEAD = registerBlock(new ItemBlockWallable(Blocks.DRAGON_HEAD, Blocks.DRAGON_WALL_HEAD, (new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item NETHER_STAR = registerItem("nether_star", new ItemNetherStar((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item PUMPKIN_PIE = registerItem("pumpkin_pie", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.PUMPKIN_PIE)));
    public static final Item FIREWORK_ROCKET = registerItem("firework_rocket", new ItemFireworks((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    public static final Item FIREWORK_STAR = registerItem("firework_star", new ItemFireworksCharge((new Item.Info()).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item NETHER_BRICK = registerItem("nether_brick", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item PRISMARINE_SHARD = registerItem("prismarine_shard", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item PRISMARINE_CRYSTALS = registerItem("prismarine_crystals", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item RABBIT = registerItem("rabbit", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.RABBIT)));
    public static final Item COOKED_RABBIT = registerItem("cooked_rabbit", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_RABBIT)));
    public static final Item RABBIT_STEW = registerItem("rabbit_stew", new ItemSoup((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_FOOD).food(Foods.RABBIT_STEW)));
    public static final Item RABBIT_FOOT = registerItem("rabbit_foot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item RABBIT_HIDE = registerItem("rabbit_hide", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item ARMOR_STAND = registerItem("armor_stand", new ItemArmorStand((new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item IRON_HORSE_ARMOR = registerItem("iron_horse_armor", new ItemHorseArmor(5, "iron", (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item GOLDEN_HORSE_ARMOR = registerItem("golden_horse_armor", new ItemHorseArmor(7, "gold", (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item DIAMOND_HORSE_ARMOR = registerItem("diamond_horse_armor", new ItemHorseArmor(11, "diamond", (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item LEATHER_HORSE_ARMOR = registerItem("leather_horse_armor", new ItemHorseArmorDyeable(3, "leather", (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item LEAD = registerItem("lead", new ItemLeash((new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    public static final Item NAME_TAG = registerItem("name_tag", new ItemNameTag((new Item.Info()).tab(CreativeModeTab.TAB_TOOLS)));
    ...
    public static final Item MUTTON = registerItem("mutton", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.MUTTON)));
    public static final Item COOKED_MUTTON = registerItem("cooked_mutton", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.COOKED_MUTTON)));
    public static final Item WHITE_BANNER = registerItem("white_banner", new ItemBanner(Blocks.WHITE_BANNER, Blocks.WHITE_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item ORANGE_BANNER = registerItem("orange_banner", new ItemBanner(Blocks.ORANGE_BANNER, Blocks.ORANGE_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item MAGENTA_BANNER = registerItem("magenta_banner", new ItemBanner(Blocks.MAGENTA_BANNER, Blocks.MAGENTA_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIGHT_BLUE_BANNER = registerItem("light_blue_banner", new ItemBanner(Blocks.LIGHT_BLUE_BANNER, Blocks.LIGHT_BLUE_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item YELLOW_BANNER = registerItem("yellow_banner", new ItemBanner(Blocks.YELLOW_BANNER, Blocks.YELLOW_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIME_BANNER = registerItem("lime_banner", new ItemBanner(Blocks.LIME_BANNER, Blocks.LIME_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PINK_BANNER = registerItem("pink_banner", new ItemBanner(Blocks.PINK_BANNER, Blocks.PINK_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GRAY_BANNER = registerItem("gray_banner", new ItemBanner(Blocks.GRAY_BANNER, Blocks.GRAY_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item LIGHT_GRAY_BANNER = registerItem("light_gray_banner", new ItemBanner(Blocks.LIGHT_GRAY_BANNER, Blocks.LIGHT_GRAY_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item CYAN_BANNER = registerItem("cyan_banner", new ItemBanner(Blocks.CYAN_BANNER, Blocks.CYAN_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item PURPLE_BANNER = registerItem("purple_banner", new ItemBanner(Blocks.PURPLE_BANNER, Blocks.PURPLE_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLUE_BANNER = registerItem("blue_banner", new ItemBanner(Blocks.BLUE_BANNER, Blocks.BLUE_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BROWN_BANNER = registerItem("brown_banner", new ItemBanner(Blocks.BROWN_BANNER, Blocks.BROWN_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item GREEN_BANNER = registerItem("green_banner", new ItemBanner(Blocks.GREEN_BANNER, Blocks.GREEN_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item RED_BANNER = registerItem("red_banner", new ItemBanner(Blocks.RED_BANNER, Blocks.RED_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item BLACK_BANNER = registerItem("black_banner", new ItemBanner(Blocks.BLACK_BANNER, Blocks.BLACK_WALL_BANNER, (new Item.Info()).stacksTo(16).tab(CreativeModeTab.TAB_DECORATIONS)));
    public static final Item END_CRYSTAL = registerItem("end_crystal", new ItemEndCrystal((new Item.Info()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(EnumItemRarity.RARE)));
    public static final Item CHORUS_FRUIT = registerItem("chorus_fruit", new ItemChorusFruit((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS).food(Foods.CHORUS_FRUIT)));
    public static final Item POPPED_CHORUS_FRUIT = registerItem("popped_chorus_fruit", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BEETROOT = registerItem("beetroot", new Item((new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.BEETROOT)));
    public static final Item BEETROOT_SEEDS = registerItem("beetroot_seeds", new ItemNamedBlock(Blocks.BEETROOTS, (new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item BEETROOT_SOUP = registerItem("beetroot_soup", new ItemSoup((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_FOOD).food(Foods.BEETROOT_SOUP)));
    public static final Item DRAGON_BREATH = registerItem("dragon_breath", new Item((new Item.Info()).craftRemainder(GLASS_BOTTLE).tab(CreativeModeTab.TAB_BREWING).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item SPLASH_POTION = registerItem("splash_potion", new ItemSplashPotion((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item SPECTRAL_ARROW = registerItem("spectral_arrow", new ItemSpectralArrow((new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item TIPPED_ARROW = registerItem("tipped_arrow", new ItemTippedArrow((new Item.Info()).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item LINGERING_POTION = registerItem("lingering_potion", new ItemLingeringPotion((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item SHIELD = registerItem("shield", new ItemShield((new Item.Info()).durability(336).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item TOTEM_OF_UNDYING = registerItem("totem_of_undying", new Item((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_COMBAT).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item SHULKER_SHELL = registerItem("shulker_shell", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item IRON_NUGGET = registerItem("iron_nugget", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    ...
    public static final Item MUSIC_DISC_13 = registerItem("music_disc_13", new ItemRecord(1, SoundEffects.MUSIC_DISC_13, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_CAT = registerItem("music_disc_cat", new ItemRecord(2, SoundEffects.MUSIC_DISC_CAT, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_BLOCKS = registerItem("music_disc_blocks", new ItemRecord(3, SoundEffects.MUSIC_DISC_BLOCKS, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_CHIRP = registerItem("music_disc_chirp", new ItemRecord(4, SoundEffects.MUSIC_DISC_CHIRP, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_FAR = registerItem("music_disc_far", new ItemRecord(5, SoundEffects.MUSIC_DISC_FAR, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_MALL = registerItem("music_disc_mall", new ItemRecord(6, SoundEffects.MUSIC_DISC_MALL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_MELLOHI = registerItem("music_disc_mellohi", new ItemRecord(7, SoundEffects.MUSIC_DISC_MELLOHI, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_STAL = registerItem("music_disc_stal", new ItemRecord(8, SoundEffects.MUSIC_DISC_STAL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_STRAD = registerItem("music_disc_strad", new ItemRecord(9, SoundEffects.MUSIC_DISC_STRAD, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_WARD = registerItem("music_disc_ward", new ItemRecord(10, SoundEffects.MUSIC_DISC_WARD, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_11 = registerItem("music_disc_11", new ItemRecord(11, SoundEffects.MUSIC_DISC_11, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_WAIT = registerItem("music_disc_wait", new ItemRecord(12, SoundEffects.MUSIC_DISC_WAIT, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_OTHERSIDE = registerItem("music_disc_otherside", new ItemRecord(14, SoundEffects.MUSIC_DISC_OTHERSIDE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item MUSIC_DISC_PIGSTEP = registerItem("music_disc_pigstep", new ItemRecord(13, SoundEffects.MUSIC_DISC_PIGSTEP, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.RARE)));
    public static final Item TRIDENT = registerItem("trident", new ItemTrident((new Item.Info()).durability(250).tab(CreativeModeTab.TAB_COMBAT)));
    public static final Item PHANTOM_MEMBRANE = registerItem("phantom_membrane", new Item((new Item.Info()).tab(CreativeModeTab.TAB_BREWING)));
    public static final Item NAUTILUS_SHELL = registerItem("nautilus_shell", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    public static final Item HEART_OF_THE_SEA = registerItem("heart_of_the_sea", new Item((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item CROSSBOW = registerItem("crossbow", new ItemCrossbow((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_COMBAT).durability(465)));
    ...
    public static final Item FLOWER_BANNER_PATTERN = registerItem("flower_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.FLOWER, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item CREEPER_BANNER_PATTERN = registerItem("creeper_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.CREEPER, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item SKULL_BANNER_PATTERN = registerItem("skull_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.SKULL, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.UNCOMMON)));
    public static final Item MOJANG_BANNER_PATTERN = registerItem("mojang_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.MOJANG, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC).rarity(EnumItemRarity.EPIC)));
    public static final Item GLOBE_BANNER_PATTERN = registerItem("globe_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.GLOBE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    public static final Item PIGLIN_BANNER_PATTERN = registerItem("piglin_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.PIGLIN, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
    ...
    public static final Item SWEET_BERRIES = registerItem("sweet_berries", new ItemNamedBlock(Blocks.SWEET_BERRY_BUSH, (new Item.Info()).tab(CreativeModeTab.TAB_FOOD).food(Foods.SWEET_BERRIES)));
    public static final Item GLOW_BERRIES = registerItem("glow_berries", new ItemNamedBlock(Blocks.CAVE_VINES, (new Item.Info()).food(Foods.GLOW_BERRIES).tab(CreativeModeTab.TAB_FOOD)));
    ...
    public static final Item HONEYCOMB = registerItem("honeycomb", new HoneycombItem((new Item.Info()).tab(CreativeModeTab.TAB_MATERIALS)));
    ...
    public static final Item HONEY_BOTTLE = registerItem("honey_bottle", new ItemHoneyBottle((new Item.Info()).craftRemainder(GLASS_BOTTLE).food(Foods.HONEY_BOTTLE).tab(CreativeModeTab.TAB_FOOD).stacksTo(16)));
    ...
    private static Item registerBlock(Block block, CreativeModeTab group) {
        return registerBlock(new ItemBlock(block, (new Item.Info()).tab(group)));
    }
    ...
    private static Item registerBlock(Block block, CreativeModeTab group, Block... blocks) {
        ItemBlock blockItem = new ItemBlock(block, (new Item.Info()).tab(group));
    ...
    private static Item registerBlock(ItemBlock item) {
        return registerBlock(item.getBlock(), item);
    }

    protected static Item registerBlock(Block block, Item item) {
        return registerItem(IRegistry.BLOCK.getKey(block), item);
    }

    private static Item registerItem(String id, Item item) {
        return registerItem(new MinecraftKey(id), item);
    }

    private static Item registerItem(MinecraftKey id, Item item) {
        if (item instanceof ItemBlock) {
            ((ItemBlock)item).registerBlocks(Item.BY_BLOCK, item);
        }

        return IRegistry.register(IRegistry.ITEM, id, item);
    }
}
