...
public class Items {
    ...
    public static final Item CROSSBOW = registerItem("crossbow", new ItemCrossbow((new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_COMBAT).durability(326)));
    ...
    public static final Item GLOBE_BANNER_PATTER = registerItem("globe_banner_pattern", new ItemBannerPattern(EnumBannerPatternType.GLOBE, (new Item.Info()).stacksTo(1).tab(CreativeModeTab.TAB_MISC)));
