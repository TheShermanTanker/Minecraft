...
public class Foods {
    ...
    public static final FoodInfo CHICKEN = (new FoodInfo.Builder()).nutrition(2).saturationMod(0.3F).effect(new MobEffect(MobEffects.HUNGER, 600, 0), 0.3F).meat().build();
    ...
    public static final FoodInfo ENCHANTED_GOLDEN_APPLE = (new FoodInfo.Builder()).nutrition(4).saturationMod(1.2F).effect(new MobEffect(MobEffects.REGENERATION, 400, 1), 1.0F).effect(new MobEffect(MobEffects.DAMAGE_RESISTANCE, 6000, 0), 1.0F).effect(new MobEffect(MobEffects.FIRE_RESISTANCE, 6000, 0), 1.0F).effect(new MobEffect(MobEffects.ABSORPTION, 2400, 3), 1.0F).alwaysEat().build();
    public static final FoodInfo GOLDEN_APPLE = (new FoodInfo.Builder()).nutrition(4).saturationMod(1.2F).effect(new MobEffect(MobEffects.REGENERATION, 100, 1), 1.0F).effect(new MobEffect(MobEffects.ABSORPTION, 2400, 0), 1.0F).alwaysEat().build();
    ...
    public static final FoodInfo POISONOUS_POTATO = (new FoodInfo.Builder()).nutrition(2).saturationMod(0.3F).effect(new MobEffect(MobEffects.POISON, 100, 0), 0.6F).build();
    ...
    public static final FoodInfo PUFFERFISH = (new FoodInfo.Builder()).nutrition(1).saturationMod(0.1F).effect(new MobEffect(MobEffects.POISON, 1200, 1), 1.0F).effect(new MobEffect(MobEffects.HUNGER, 300, 2), 1.0F).effect(new MobEffect(MobEffects.CONFUSION, 300, 0), 1.0F).build();
    ...
    public static final FoodInfo ROTTEN_FLESH = (new FoodInfo.Builder()).nutrition(4).saturationMod(0.1F).effect(new MobEffect(MobEffects.HUNGER, 600, 0), 0.8F).meat().build();
    public static final FoodInfo SALMON = (new FoodInfo.Builder()).nutrition(2).saturationMod(0.1F).build();
    public static final FoodInfo SPIDER_EYE = (new FoodInfo.Builder()).nutrition(2).saturationMod(0.8F).effect(new MobEffect(MobEffects.POISON, 100, 0), 1.0F).build();
