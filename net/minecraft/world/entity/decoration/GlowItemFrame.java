...
public class GlowItemFrame extends EntityItemFrame {
    public GlowItemFrame(EntityTypes<? extends EntityItemFrame> type, World world) {
        super(type, world);
    }

    public GlowItemFrame(World world, BlockPosition pos, EnumDirection facing) {
        super(EntityTypes.GLOW_ITEM_FRAME, world, pos, facing);
    }
