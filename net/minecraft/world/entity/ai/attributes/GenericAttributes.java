...
public class GenericAttributes {
    ...
    public static final AttributeBase MOVEMENT_SPEED = register("generic.movement_speed", (new AttributeRanged("attribute.name.generic.movement_speed", (double)0.7F, 0.0D, 1024.0D)).setSyncable(true));
    public static final AttributeBase FLYING_SPEED = register("generic.flying_speed", (new AttributeRanged("attribute.name.generic.flying_speed", (double)0.4F, 0.0D, 1024.0D)).setSyncable(true));
    ...
    private static AttributeBase register(String id, AttributeBase attribute) {
        return IRegistry.register(IRegistry.ATTRIBUTE, id, attribute);
    }
}
