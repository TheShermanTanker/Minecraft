...
public class BehaviorFollowAdult<E extends EntityAgeable> extends Behavior<E> {
    private final IntProviderUniform followRange;
    private final Function<EntityLiving, Float> speedModifier;

    public BehaviorFollowAdult(IntProviderUniform executionRange, float speed) {
        this(executionRange, (entity) -> {
            return speed;
        });
    }

    public BehaviorFollowAdult(IntProviderUniform executionRange, Function<EntityLiving, Float> speed) {
