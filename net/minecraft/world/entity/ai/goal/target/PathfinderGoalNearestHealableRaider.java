...
public class PathfinderGoalNearestHealableRaider<T extends EntityLiving> extends PathfinderGoalNearestAttackableTarget<T> {
    ...
    public PathfinderGoalNearestHealableRaider(EntityRaider raider, Class<T> targetEntityClass, boolean checkVisibility, @Nullable Predicate<EntityLiving> targetPredicate) {
