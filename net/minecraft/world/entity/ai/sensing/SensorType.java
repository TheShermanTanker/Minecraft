...
public class SensorType<U extends Sensor<?>> {
    ...
    public static final SensorType<SensorAxolotlAttackables> AXOLOTL_ATTACKABLES = register("axolotl_attackables", SensorAxolotlAttackables::new);
    ...
    private static <U extends Sensor<?>> SensorType<U> register(String id, Supplier<U> factory) {
        return IRegistry.register(IRegistry.SENSOR_TYPE, new MinecraftKey(id), new SensorType<>(factory));
    }
}
