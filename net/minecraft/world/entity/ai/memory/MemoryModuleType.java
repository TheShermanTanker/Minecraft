...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<List<EntityLiving>> NEAREST_VISIBLE_LIVING_ENTITIES = register("visible_mobs");
    ...
    private MemoryModuleType(Optional<Codec<U>> codec) {
        this.codec = codec.map(ExpirableMemory::codec);
    }
    ...
    private static <U> MemoryModuleType<U> register(String id, Codec<U> codec) {
        return IRegistry.register(IRegistry.MEMORY_MODULE_TYPE, new MinecraftKey(id), new MemoryModuleType<>(Optional.of(codec)));
    }

    private static <U> MemoryModuleType<U> register(String id) {
        return IRegistry.register(IRegistry.MEMORY_MODULE_TYPE, new MinecraftKey(id), new MemoryModuleType<>(Optional.empty()));
    }
}
