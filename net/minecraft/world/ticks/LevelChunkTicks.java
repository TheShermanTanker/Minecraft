...
public class LevelChunkTicks<T> implements SerializableTickContainer<T>, TickContainerAccess<T> {
    ...
    @Override
    public NBTTagList save(long l, Function<T, String> function) {
    ...
    public static <T> LevelChunkTicks<T> load(NBTTagList tickQueue, Function<String, Optional<T>> nameToTypeFunction, ChunkCoordIntPair pos) {
