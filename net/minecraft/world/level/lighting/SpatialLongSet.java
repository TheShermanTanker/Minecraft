...
public class SpatialLongSet extends LongLinkedOpenHashSet {
    ...
    protected static class InternalMap extends Long2LongLinkedOpenHashMap {
        private static final int X_BITS = MathHelper.log2(60000000);
        private static final int Z_BITS = MathHelper.log2(60000000);
        ...
        static long getFullKey(long key, int valueLength) {
            key = key | (long)(valueLength >>> 4 & 3) << X_OFFSET;
            key = key | (long)(valueLength >>> 2 & 3) << Z_OFFSET;
