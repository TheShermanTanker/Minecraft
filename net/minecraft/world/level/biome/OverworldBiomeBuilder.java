...
public final class OverworldBiomeBuilder {
    ...
    protected void addBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters) {
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters) {
    ...
    private void addInlandBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters) {
    ...
    private void addPeaks(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter weirdness) {
        for(int i = 0; i < this.temperatures.length; ++i) {
            Climate.Parameter parameter = this.temperatures[i];

            for(int j = 0; j < this.humidities.length; ++j) {
                Climate.Parameter parameter2 = this.humidities[j];
                ResourceKey<BiomeBase> resourceKey = this.pickMiddleBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey2 = this.pickMiddleBiomeOrBadlandsIfHot(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey3 = this.pickMiddleBiomeOrBadlandsIfHotOrSlopeIfCold(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey4 = this.pickPlateauBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey5 = this.pickExtremeHillsBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey6 = this.maybePickShatteredBiome(i, j, weirdness, resourceKey5);
                ResourceKey<BiomeBase> resourceKey7 = this.pickPeakBiome(i, j, weirdness);
    ...
    private void addHighSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter weirdness) {
        for(int i = 0; i < this.temperatures.length; ++i) {
            Climate.Parameter parameter = this.temperatures[i];
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                ResourceKey<BiomeBase> resourceKey4 = this.pickPlateauBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey5 = this.pickExtremeHillsBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey6 = this.maybePickShatteredBiome(i, j, weirdness, resourceKey);
                ResourceKey<BiomeBase> resourceKey7 = this.pickSlopeBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey8 = this.pickPeakBiome(i, j, weirdness);
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter weirdness) {
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                ResourceKey<BiomeBase> resourceKey2 = this.pickMiddleBiomeOrBadlandsIfHot(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey3 = this.pickMiddleBiomeOrBadlandsIfHotOrSlopeIfCold(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey4 = this.pickExtremeHillsBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey5 = this.pickPlateauBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey6 = this.pickBeachBiome(i, j);
                ResourceKey<BiomeBase> resourceKey7 = this.maybePickShatteredBiome(i, j, weirdness, resourceKey);
                ResourceKey<BiomeBase> resourceKey8 = this.pickShatteredCoastBiome(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey9 = this.pickSlopeBiome(i, j, weirdness);
    ...
    private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter weirdness) {
        this.addSurfaceBiome(parameters, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), weirdness, 0.0F, Biomes.STONY_SHORE);
        this.addSurfaceBiome(parameters, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], weirdness, 0.0F, Biomes.SWAMP);
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                ...
                ResourceKey<BiomeBase> resourceKey2 = this.pickMiddleBiomeOrBadlandsIfHot(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey3 = this.pickMiddleBiomeOrBadlandsIfHotOrSlopeIfCold(i, j, weirdness);
                ResourceKey<BiomeBase> resourceKey4 = this.pickBeachBiome(i, j);
                ResourceKey<BiomeBase> resourceKey5 = this.maybePickShatteredBiome(i, j, weirdness, resourceKey);
                ResourceKey<BiomeBase> resourceKey6 = this.pickShatteredCoastBiome(i, j, weirdness);
    ...
    private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter weirdness) {
        ...
        for(int i = 0; i < this.temperatures.length; ++i) {
            ...
            for(int j = 0; j < this.humidities.length; ++j) {
                Climate.Parameter parameter2 = this.humidities[j];
                ResourceKey<BiomeBase> resourceKey = this.pickMiddleBiomeOrBadlandsIfHot(i, j, weirdness);
    ...
    private void addUndergroundBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters) {
    ...
    private ResourceKey<BiomeBase> pickMiddleBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        if (weirdness.max() < 0L) {
            return this.MIDDLE_BIOMES[temperature][humidity];
        } else {
            ResourceKey<BiomeBase> resourceKey = this.MIDDLE_BIOMES_VARIANT[temperature][humidity];
            return resourceKey == null ? this.MIDDLE_BIOMES[temperature][humidity] : resourceKey;
        }
    }

    private ResourceKey<BiomeBase> pickMiddleBiomeOrBadlandsIfHot(int temperature, int humidity, Climate.Parameter weirdness) {
        return temperature == 4 ? this.pickBadlandsBiome(humidity, weirdness) : this.pickMiddleBiome(temperature, humidity, weirdness);
    }

    private ResourceKey<BiomeBase> pickMiddleBiomeOrBadlandsIfHotOrSlopeIfCold(int temperature, int humidity, Climate.Parameter weirdness) {
    ...
    private ResourceKey<BiomeBase> maybePickShatteredBiome(int temperature, int humidity, Climate.Parameter weirdness, ResourceKey<BiomeBase> biome) {
        return temperature > 1 && humidity < 4 && weirdness.max() >= 0L ? Biomes.WINDSWEPT_SAVANNA : biome;
    }

    private ResourceKey<BiomeBase> pickShatteredCoastBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        ResourceKey<BiomeBase> resourceKey = weirdness.max() >= 0L ? this.pickMiddleBiome(temperature, humidity, weirdness) : this.pickBeachBiome(temperature, humidity);
        return this.maybePickShatteredBiome(temperature, humidity, weirdness, resourceKey);
    }

    private ResourceKey<BiomeBase> pickBeachBiome(int temperature, int humidity) {
        if (temperature == 0) {
    ...
    private ResourceKey<BiomeBase> pickBadlandsBiome(int humidity, Climate.Parameter weirdness) {
        if (humidity < 2) {
    ...
    private ResourceKey<BiomeBase> pickPlateauBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        if (weirdness.max() < 0L) {
            return this.PLATEAU_BIOMES[temperature][humidity];
        } else {
            ResourceKey<BiomeBase> resourceKey = this.PLATEAU_BIOMES_VARIANT[temperature][humidity];
            return resourceKey == null ? this.PLATEAU_BIOMES[temperature][humidity] : resourceKey;
        }
    }

    private ResourceKey<BiomeBase> pickPeakBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        if (temperature <= 2) {
    ...
    private ResourceKey<BiomeBase> pickSlopeBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        if (temperature >= 3) {
    ...
    private ResourceKey<BiomeBase> pickExtremeHillsBiome(int temperature, int humidity, Climate.Parameter weirdness) {
        ResourceKey<BiomeBase> resourceKey = this.EXTREME_HILLS[temperature][humidity];
        return resourceKey == null ? this.pickMiddleBiome(temperature, humidity, weirdness) : resourceKey;
    }

    private void addSurfaceBiome(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter temperature, Climate.Parameter humidity, Climate.Parameter continentalness, Climate.Parameter erosion, Climate.Parameter weirdness, float offset, ResourceKey<BiomeBase> biome) {
    ...
    private void addUndergroundBiome(Consumer<Pair<Climate.ParameterPoint, ResourceKey<BiomeBase>>> parameters, Climate.Parameter temperature, Climate.Parameter humidity, Climate.Parameter continentalness, Climate.Parameter erosion, Climate.Parameter weirdness, float offset, ResourceKey<BiomeBase> biome) {
