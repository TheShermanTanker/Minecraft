...
public abstract class TileEntity {
    ...
    private NBTTagCompound saveMetadata(NBTTagCompound nbt) {
    ...
    public static TileEntity create(BlockPosition pos, IBlockData state, NBTTagCompound nbt) {
        ...
        if (resourceLocation == null) {
            ...
            return IRegistry.BLOCK_ENTITY_TYPE.getOptional(resourceLocation).map((blockEntityType) -> {
                try {
    ...
    public NBTTagCompound getUpdateTag() {
        return this.saveMetadata(new NBTTagCompound());
    }
