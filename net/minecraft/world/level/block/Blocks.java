...
public class Blocks {
    ...
    public static final Block LAVA = register("lava", new BlockFluids(FluidTypes.LAVA, BlockBase.Info.of(Material.LAVA).noCollission().randomTicks().strength(100.0F).lightLevel((state) -> {
        return 15;
    }).noDrops()));
    ...
    public static final Block SEAGRASS = register("seagrass", new BlockSeagrass(BlockBase.Info.of(Material.REPLACEABLE_WATER_PLANT).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    ...
    public static final Block TORCH = register("torch", new BlockTorch(BlockBase.Info.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> {
        return 14;
    }).sound(SoundEffectType.WOOD), Particles.FLAME));
    public static final Block WALL_TORCH = register("wall_torch", new BlockTorchWall(BlockBase.Info.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> {
        return 14;
    }).sound(SoundEffectType.WOOD).dropsLike(TORCH), Particles.FLAME));
    public static final Block FIRE = register("fire", new BlockFire(BlockBase.Info.of(Material.FIRE, MaterialMapColor.FIRE).noCollission().instabreak().lightLevel((state) -> {
        return 15;
    }).sound(SoundEffectType.WOOL)));
    public static final Block SOUL_FIRE = register("soul_fire", new BlockSoulFire(BlockBase.Info.of(Material.FIRE, MaterialMapColor.COLOR_LIGHT_BLUE).noCollission().instabreak().lightLevel((state) -> {
        return 10;
    }).sound(SoundEffectType.WOOL)));
    ...
    public static final Block OAK_STAIRS = register("oak_stairs", new BlockStairs(OAK_PLANKS.getBlockData(), BlockBase.Info.copy(OAK_PLANKS)));
    ...
    public static final Block SPRUCE_SIGN = register("spruce_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, SPRUCE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD), BlockPropertyWood.SPRUCE));
    ...
    public static final Block JUNGLE_SIGN = register("jungle_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_SIGN = register("dark_oak_sign", new BlockFloorSign(BlockBase.Info.of(Material.WOOD, DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD), BlockPropertyWood.DARK_OAK));
    public static final Block OAK_DOOR = register("oak_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, OAK_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    ...
    public static final Block COBBLESTONE_STAIRS = register("cobblestone_stairs", new BlockStairs(COBBLESTONE.getBlockData(), BlockBase.Info.copy(COBBLESTONE)));
    public static final Block OAK_WALL_SIGN = register("oak_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(OAK_SIGN), BlockPropertyWood.OAK));
    public static final Block SPRUCE_WALL_SIGN = register("spruce_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, SPRUCE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(SPRUCE_SIGN), BlockPropertyWood.SPRUCE));
    public static final Block BIRCH_WALL_SIGN = register("birch_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, MaterialMapColor.SAND).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(BIRCH_SIGN), BlockPropertyWood.BIRCH));
    public static final Block ACACIA_WALL_SIGN = register("acacia_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, MaterialMapColor.COLOR_ORANGE).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(ACACIA_SIGN), BlockPropertyWood.ACACIA));
    public static final Block JUNGLE_WALL_SIGN = register("jungle_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, JUNGLE_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(JUNGLE_SIGN), BlockPropertyWood.JUNGLE));
    public static final Block DARK_OAK_WALL_SIGN = register("dark_oak_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.WOOD, DARK_OAK_LOG.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(DARK_OAK_SIGN), BlockPropertyWood.DARK_OAK));
    ...
    public static final Block OAK_PRESSURE_PLATE = register("oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, OAK_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block SPRUCE_PRESSURE_PLATE = register("spruce_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, SPRUCE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block BIRCH_PRESSURE_PLATE = register("birch_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, BIRCH_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block JUNGLE_PRESSURE_PLATE = register("jungle_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, JUNGLE_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block ACACIA_PRESSURE_PLATE = register("acacia_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, ACACIA_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block DARK_OAK_PRESSURE_PLATE = register("dark_oak_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.WOOD, DARK_OAK_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    ...
    public static final Block DEEPSLATE_REDSTONE_ORE = register("deepslate_redstone_ore", new BlockRedstoneOre(BlockBase.Info.copy(REDSTONE_ORE).color(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE)));
    ...
    public static final Block OAK_FENCE = register("oak_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    ...
    public static final Block SOUL_TORCH = register("soul_torch", new BlockTorch(BlockBase.Info.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> {
        return 10;
    }).sound(SoundEffectType.WOOD), Particles.SOUL_FIRE_FLAME));
    public static final Block SOUL_WALL_TORCH = register("soul_wall_torch", new BlockTorchWall(BlockBase.Info.of(Material.DECORATION).noCollission().instabreak().lightLevel((state) -> {
        return 10;
    }).sound(SoundEffectType.WOOD).dropsLike(SOUL_TORCH), Particles.SOUL_FIRE_FLAME));
    public static final Block GLOWSTONE = register("glowstone", new Block(BlockBase.Info.of(Material.GLASS, MaterialMapColor.SAND).strength(0.3F).sound(SoundEffectType.GLASS).lightLevel((state) -> {
        return 15;
    })));
    public static final Block NETHER_PORTAL = register("nether_portal", new BlockPortal(BlockBase.Info.of(Material.PORTAL).noCollission().randomTicks().strength(-1.0F).sound(SoundEffectType.GLASS).lightLevel((state) -> {
        return 11;
    })));
    ...
    public static final Block JACK_O_LANTERN = register("jack_o_lantern", new BlockPumpkinCarved(BlockBase.Info.of(Material.VEGETABLE, MaterialMapColor.COLOR_ORANGE).strength(1.0F).sound(SoundEffectType.WOOD).lightLevel((state) -> {
        return 15;
    ...
    public static final Block INFESTED_STONE = register("infested_stone", new BlockMonsterEggs(STONE, BlockBase.Info.of(Material.CLAY)));
    public static final Block INFESTED_COBBLESTONE = register("infested_cobblestone", new BlockMonsterEggs(COBBLESTONE, BlockBase.Info.of(Material.CLAY)));
    public static final Block INFESTED_STONE_BRICKS = register("infested_stone_bricks", new BlockMonsterEggs(STONE_BRICKS, BlockBase.Info.of(Material.CLAY)));
    public static final Block INFESTED_MOSSY_STONE_BRICKS = register("infested_mossy_stone_bricks", new BlockMonsterEggs(MOSSY_STONE_BRICKS, BlockBase.Info.of(Material.CLAY)));
    public static final Block INFESTED_CRACKED_STONE_BRICKS = register("infested_cracked_stone_bricks", new BlockMonsterEggs(CRACKED_STONE_BRICKS, BlockBase.Info.of(Material.CLAY)));
    public static final Block INFESTED_CHISELED_STONE_BRICKS = register("infested_chiseled_stone_bricks", new BlockMonsterEggs(CHISELED_STONE_BRICKS, BlockBase.Info.of(Material.CLAY)));
    ...
    public static final Block ATTACHED_PUMPKIN_STEM = register("attached_pumpkin_stem", new BlockStemAttached((BlockStemmed)PUMPKIN, () -> {
        return Items.PUMPKIN_SEEDS;
    }, BlockBase.Info.of(Material.PLANT).noCollission().instabreak().sound(SoundEffectType.WOOD)));
    public static final Block ATTACHED_MELON_STEM = register("attached_melon_stem", new BlockStemAttached((BlockStemmed)MELON, () -> {
        return Items.MELON_SEEDS;
    }, BlockBase.Info.of(Material.PLANT).noCollission().instabreak().sound(SoundEffectType.WOOD)));
    public static final Block PUMPKIN_STEM = register("pumpkin_stem", new BlockStem((BlockStemmed)PUMPKIN, () -> {
        return Items.PUMPKIN_SEEDS;
    }, BlockBase.Info.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.HARD_CROP)));
    public static final Block MELON_STEM = register("melon_stem", new BlockStem((BlockStemmed)MELON, () -> {
        return Items.MELON_SEEDS;
    }, BlockBase.Info.of(Material.PLANT).noCollission().randomTicks().instabreak().sound(SoundEffectType.HARD_CROP)));
    ...
    public static final Block OAK_FENCE_GATE = register("oak_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block BRICK_STAIRS = register("brick_stairs", new BlockStairs(BRICKS.getBlockData(), BlockBase.Info.copy(BRICKS)));
    public static final Block STONE_BRICK_STAIRS = register("stone_brick_stairs", new BlockStairs(STONE_BRICKS.getBlockData(), BlockBase.Info.copy(STONE_BRICKS)));
    ...
    public static final Block END_PORTAL_FRAME = register("end_portal_frame", new BlockEnderPortalFrame(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_GREEN).sound(SoundEffectType.GLASS).lightLevel((state) -> {
        return 1;
    }).strength(-1.0F, 3600000.0F).noDrops()));
    ...
    public static final Block DRAGON_EGG = register("dragon_egg", new BlockDragonEgg(BlockBase.Info.of(Material.EGG, MaterialMapColor.COLOR_BLACK).strength(3.0F, 9.0F).lightLevel((state) -> {
        return 1;
    }).noOcclusion()));
    ...
    public static final Block TRIPWIRE = register("tripwire", new BlockTripwire((BlockTripwireHook)TRIPWIRE_HOOK, BlockBase.Info.of(Material.DECORATION).noCollission()));
    ...
    public static final Block SPRUCE_STAIRS = register("spruce_stairs", new BlockStairs(SPRUCE_PLANKS.getBlockData(), BlockBase.Info.copy(SPRUCE_PLANKS)));
    public static final Block BIRCH_STAIRS = register("birch_stairs", new BlockStairs(BIRCH_PLANKS.getBlockData(), BlockBase.Info.copy(BIRCH_PLANKS)));
    public static final Block JUNGLE_STAIRS = register("jungle_stairs", new BlockStairs(JUNGLE_PLANKS.getBlockData(), BlockBase.Info.copy(JUNGLE_PLANKS)));
    ...
    public static final Block BEACON = register("beacon", new BlockBeacon(BlockBase.Info.of(Material.GLASS, MaterialMapColor.DIAMOND).strength(3.0F).lightLevel((state) -> {
        return 15;
    }).noOcclusion().isRedstoneConductor(Blocks::never)));
    public static final Block COBBLESTONE_WALL = register("cobblestone_wall", new BlockCobbleWall(BlockBase.Info.copy(COBBLESTONE)));
    public static final Block MOSSY_COBBLESTONE_WALL = register("mossy_cobblestone_wall", new BlockCobbleWall(BlockBase.Info.copy(COBBLESTONE)));
    public static final Block FLOWER_POT = register("flower_pot", new BlockFlowerPot(AIR, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_OAK_SAPLING = register("potted_oak_sapling", new BlockFlowerPot(OAK_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_SPRUCE_SAPLING = register("potted_spruce_sapling", new BlockFlowerPot(SPRUCE_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_BIRCH_SAPLING = register("potted_birch_sapling", new BlockFlowerPot(BIRCH_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_JUNGLE_SAPLING = register("potted_jungle_sapling", new BlockFlowerPot(JUNGLE_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_ACACIA_SAPLING = register("potted_acacia_sapling", new BlockFlowerPot(ACACIA_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_DARK_OAK_SAPLING = register("potted_dark_oak_sapling", new BlockFlowerPot(DARK_OAK_SAPLING, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_FERN = register("potted_fern", new BlockFlowerPot(FERN, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_DANDELION = register("potted_dandelion", new BlockFlowerPot(DANDELION, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_POPPY = register("potted_poppy", new BlockFlowerPot(POPPY, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_BLUE_ORCHID = register("potted_blue_orchid", new BlockFlowerPot(BLUE_ORCHID, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_ALLIUM = register("potted_allium", new BlockFlowerPot(ALLIUM, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_AZURE_BLUET = register("potted_azure_bluet", new BlockFlowerPot(AZURE_BLUET, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_RED_TULIP = register("potted_red_tulip", new BlockFlowerPot(RED_TULIP, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_ORANGE_TULIP = register("potted_orange_tulip", new BlockFlowerPot(ORANGE_TULIP, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_WHITE_TULIP = register("potted_white_tulip", new BlockFlowerPot(WHITE_TULIP, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_PINK_TULIP = register("potted_pink_tulip", new BlockFlowerPot(PINK_TULIP, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_OXEYE_DAISY = register("potted_oxeye_daisy", new BlockFlowerPot(OXEYE_DAISY, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_CORNFLOWER = register("potted_cornflower", new BlockFlowerPot(CORNFLOWER, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_LILY_OF_THE_VALLEY = register("potted_lily_of_the_valley", new BlockFlowerPot(LILY_OF_THE_VALLEY, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_WITHER_ROSE = register("potted_wither_rose", new BlockFlowerPot(WITHER_ROSE, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_RED_MUSHROOM = register("potted_red_mushroom", new BlockFlowerPot(RED_MUSHROOM, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_BROWN_MUSHROOM = register("potted_brown_mushroom", new BlockFlowerPot(BROWN_MUSHROOM, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_DEAD_BUSH = register("potted_dead_bush", new BlockFlowerPot(DEAD_BUSH, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_CACTUS = register("potted_cactus", new BlockFlowerPot(CACTUS, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    ...
    public static final Block SKELETON_WALL_SKULL = register("skeleton_wall_skull", new BlockSkullWall(BlockSkull.Type.SKELETON, BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(SKELETON_SKULL)));
    ...
    public static final Block WITHER_SKELETON_WALL_SKULL = register("wither_skeleton_wall_skull", new BlockWitherSkullWall(BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(WITHER_SKELETON_SKULL)));
    ...
    public static final Block ZOMBIE_WALL_HEAD = register("zombie_wall_head", new BlockSkullWall(BlockSkull.Type.ZOMBIE, BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(ZOMBIE_HEAD)));
    ...
    public static final Block PLAYER_WALL_HEAD = register("player_wall_head", new BlockSkullPlayerWall(BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(PLAYER_HEAD)));
    ...
    public static final Block CREEPER_WALL_HEAD = register("creeper_wall_head", new BlockSkullWall(BlockSkull.Type.CREEPER, BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(CREEPER_HEAD)));
    ...
    public static final Block DRAGON_WALL_HEAD = register("dragon_wall_head", new BlockSkullWall(BlockSkull.Type.DRAGON, BlockBase.Info.of(Material.DECORATION).strength(1.0F).dropsLike(DRAGON_HEAD)));
    ...
    public static final Block QUARTZ_STAIRS = register("quartz_stairs", new BlockStairs(QUARTZ_BLOCK.getBlockData(), BlockBase.Info.copy(QUARTZ_BLOCK)));
    ...
    public static final Block ACACIA_STAIRS = register("acacia_stairs", new BlockStairs(ACACIA_PLANKS.getBlockData(), BlockBase.Info.copy(ACACIA_PLANKS)));
    public static final Block DARK_OAK_STAIRS = register("dark_oak_stairs", new BlockStairs(DARK_OAK_PLANKS.getBlockData(), BlockBase.Info.copy(DARK_OAK_PLANKS)));
    ...
    public static final Block LIGHT = register("light", new BlockLight(BlockBase.Info.of(Material.AIR).strength(-1.0F, 3600000.8F).noDrops().noOcclusion().lightLevel(BlockLight.LIGHT_EMISSION)));
    ...
    public static final Block PRISMARINE_STAIRS = register("prismarine_stairs", new BlockStairs(PRISMARINE.getBlockData(), BlockBase.Info.copy(PRISMARINE)));
    public static final Block PRISMARINE_BRICK_STAIRS = register("prismarine_brick_stairs", new BlockStairs(PRISMARINE_BRICKS.getBlockData(), BlockBase.Info.copy(PRISMARINE_BRICKS)));
    public static final Block DARK_PRISMARINE_STAIRS = register("dark_prismarine_stairs", new BlockStairs(DARK_PRISMARINE.getBlockData(), BlockBase.Info.copy(DARK_PRISMARINE)));
    ...
    public static final Block SEA_LANTERN = register("sea_lantern", new Block(BlockBase.Info.of(Material.GLASS, MaterialMapColor.QUARTZ).strength(0.3F).sound(SoundEffectType.GLASS).lightLevel((state) -> {
        return 15;
    })));
    ...
    public static final Block WHITE_WALL_BANNER = register("white_wall_banner", new BlockBannerWall(EnumColor.WHITE, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(WHITE_BANNER)));
    public static final Block ORANGE_WALL_BANNER = register("orange_wall_banner", new BlockBannerWall(EnumColor.ORANGE, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(ORANGE_BANNER)));
    public static final Block MAGENTA_WALL_BANNER = register("magenta_wall_banner", new BlockBannerWall(EnumColor.MAGENTA, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(MAGENTA_BANNER)));
    public static final Block LIGHT_BLUE_WALL_BANNER = register("light_blue_wall_banner", new BlockBannerWall(EnumColor.LIGHT_BLUE, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(LIGHT_BLUE_BANNER)));
    public static final Block YELLOW_WALL_BANNER = register("yellow_wall_banner", new BlockBannerWall(EnumColor.YELLOW, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(YELLOW_BANNER)));
    public static final Block LIME_WALL_BANNER = register("lime_wall_banner", new BlockBannerWall(EnumColor.LIME, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(LIME_BANNER)));
    public static final Block PINK_WALL_BANNER = register("pink_wall_banner", new BlockBannerWall(EnumColor.PINK, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(PINK_BANNER)));
    public static final Block GRAY_WALL_BANNER = register("gray_wall_banner", new BlockBannerWall(EnumColor.GRAY, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(GRAY_BANNER)));
    public static final Block LIGHT_GRAY_WALL_BANNER = register("light_gray_wall_banner", new BlockBannerWall(EnumColor.LIGHT_GRAY, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(LIGHT_GRAY_BANNER)));
    public static final Block CYAN_WALL_BANNER = register("cyan_wall_banner", new BlockBannerWall(EnumColor.CYAN, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(CYAN_BANNER)));
    public static final Block PURPLE_WALL_BANNER = register("purple_wall_banner", new BlockBannerWall(EnumColor.PURPLE, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(PURPLE_BANNER)));
    public static final Block BLUE_WALL_BANNER = register("blue_wall_banner", new BlockBannerWall(EnumColor.BLUE, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(BLUE_BANNER)));
    public static final Block BROWN_WALL_BANNER = register("brown_wall_banner", new BlockBannerWall(EnumColor.BROWN, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(BROWN_BANNER)));
    public static final Block GREEN_WALL_BANNER = register("green_wall_banner", new BlockBannerWall(EnumColor.GREEN, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(GREEN_BANNER)));
    public static final Block RED_WALL_BANNER = register("red_wall_banner", new BlockBannerWall(EnumColor.RED, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(RED_BANNER)));
    public static final Block BLACK_WALL_BANNER = register("black_wall_banner", new BlockBannerWall(EnumColor.BLACK, BlockBase.Info.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(BLACK_BANNER)));
    ...
    public static final Block RED_SANDSTONE_STAIRS = register("red_sandstone_stairs", new BlockStairs(RED_SANDSTONE.getBlockData(), BlockBase.Info.copy(RED_SANDSTONE)));
    ...
    public static final Block SPRUCE_FENCE_GATE = register("spruce_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, SPRUCE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block BIRCH_FENCE_GATE = register("birch_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, BIRCH_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block JUNGLE_FENCE_GATE = register("jungle_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, JUNGLE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block ACACIA_FENCE_GATE = register("acacia_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, ACACIA_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block DARK_OAK_FENCE_GATE = register("dark_oak_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.WOOD, DARK_OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block SPRUCE_FENCE = register("spruce_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, SPRUCE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block BIRCH_FENCE = register("birch_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, BIRCH_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block JUNGLE_FENCE = register("jungle_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, JUNGLE_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block ACACIA_FENCE = register("acacia_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, ACACIA_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block DARK_OAK_FENCE = register("dark_oak_fence", new BlockFence(BlockBase.Info.of(Material.WOOD, DARK_OAK_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block SPRUCE_DOOR = register("spruce_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, SPRUCE_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block BIRCH_DOOR = register("birch_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, BIRCH_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block JUNGLE_DOOR = register("jungle_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, JUNGLE_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block ACACIA_DOOR = register("acacia_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, ACACIA_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block DARK_OAK_DOOR = register("dark_oak_door", new BlockDoor(BlockBase.Info.of(Material.WOOD, DARK_OAK_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block END_ROD = register("end_rod", new BlockEndRod(BlockBase.Info.of(Material.DECORATION).instabreak().lightLevel((state) -> {
        return 14;
    ...
    public static final Block CHORUS_FLOWER = register("chorus_flower", new BlockChorusFlower((BlockChorusFruit)CHORUS_PLANT, BlockBase.Info.of(Material.PLANT, MaterialMapColor.COLOR_PURPLE).randomTicks().strength(0.4F).sound(SoundEffectType.WOOD).noOcclusion()));
    ...
    public static final Block PURPUR_STAIRS = register("purpur_stairs", new BlockStairs(PURPUR_BLOCK.getBlockData(), BlockBase.Info.copy(PURPUR_BLOCK)));
    ...
    public static final Block END_GATEWAY = register("end_gateway", new BlockEndGateway(BlockBase.Info.of(Material.PORTAL, MaterialMapColor.COLOR_BLACK).noCollission().lightLevel((state) -> {
        return 15;
    }).strength(-1.0F, 3600000.0F).noDrops()));
    ...
    public static final Block FROSTED_ICE = register("frosted_ice", new BlockIceFrost(BlockBase.Info.of(Material.ICE).friction(0.98F).randomTicks().strength(0.5F).sound(SoundEffectType.GLASS).noOcclusion().isValidSpawn((state, world, pos, entityType) -> {
        return entityType == EntityTypes.POLAR_BEAR;
    })));
    public static final Block MAGMA_BLOCK = register("magma_block", new BlockMagma(BlockBase.Info.of(Material.STONE, MaterialMapColor.NETHER).requiresCorrectToolForDrops().lightLevel((state) -> {
        return 3;
    ...
    public static final Block WHITE_CONCRETE_POWDER = register("white_concrete_powder", new BlockConcretePowder(WHITE_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.WHITE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block ORANGE_CONCRETE_POWDER = register("orange_concrete_powder", new BlockConcretePowder(ORANGE_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.ORANGE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block MAGENTA_CONCRETE_POWDER = register("magenta_concrete_powder", new BlockConcretePowder(MAGENTA_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.MAGENTA).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block LIGHT_BLUE_CONCRETE_POWDER = register("light_blue_concrete_powder", new BlockConcretePowder(LIGHT_BLUE_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.LIGHT_BLUE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block YELLOW_CONCRETE_POWDER = register("yellow_concrete_powder", new BlockConcretePowder(YELLOW_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.YELLOW).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block LIME_CONCRETE_POWDER = register("lime_concrete_powder", new BlockConcretePowder(LIME_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.LIME).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block PINK_CONCRETE_POWDER = register("pink_concrete_powder", new BlockConcretePowder(PINK_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.PINK).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block GRAY_CONCRETE_POWDER = register("gray_concrete_powder", new BlockConcretePowder(GRAY_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.GRAY).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block LIGHT_GRAY_CONCRETE_POWDER = register("light_gray_concrete_powder", new BlockConcretePowder(LIGHT_GRAY_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.LIGHT_GRAY).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block CYAN_CONCRETE_POWDER = register("cyan_concrete_powder", new BlockConcretePowder(CYAN_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.CYAN).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block PURPLE_CONCRETE_POWDER = register("purple_concrete_powder", new BlockConcretePowder(PURPLE_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.PURPLE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block BLUE_CONCRETE_POWDER = register("blue_concrete_powder", new BlockConcretePowder(BLUE_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.BLUE).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block BROWN_CONCRETE_POWDER = register("brown_concrete_powder", new BlockConcretePowder(BROWN_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.BROWN).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block GREEN_CONCRETE_POWDER = register("green_concrete_powder", new BlockConcretePowder(GREEN_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.GREEN).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block RED_CONCRETE_POWDER = register("red_concrete_powder", new BlockConcretePowder(RED_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.RED).strength(0.5F).sound(SoundEffectType.SAND)));
    public static final Block BLACK_CONCRETE_POWDER = register("black_concrete_powder", new BlockConcretePowder(BLACK_CONCRETE, BlockBase.Info.of(Material.SAND, EnumColor.BLACK).strength(0.5F).sound(SoundEffectType.SAND)));
    ...
    public static final Block TUBE_CORAL_BLOCK = register("tube_coral_block", new BlockCoral(DEAD_TUBE_CORAL_BLOCK, BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_BLUE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundEffectType.CORAL_BLOCK)));
    public static final Block BRAIN_CORAL_BLOCK = register("brain_coral_block", new BlockCoral(DEAD_BRAIN_CORAL_BLOCK, BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_PINK).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundEffectType.CORAL_BLOCK)));
    public static final Block BUBBLE_CORAL_BLOCK = register("bubble_coral_block", new BlockCoral(DEAD_BUBBLE_CORAL_BLOCK, BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_PURPLE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundEffectType.CORAL_BLOCK)));
    public static final Block FIRE_CORAL_BLOCK = register("fire_coral_block", new BlockCoral(DEAD_FIRE_CORAL_BLOCK, BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_RED).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundEffectType.CORAL_BLOCK)));
    public static final Block HORN_CORAL_BLOCK = register("horn_coral_block", new BlockCoral(DEAD_HORN_CORAL_BLOCK, BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_YELLOW).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundEffectType.CORAL_BLOCK)));
    ...
    public static final Block TUBE_CORAL = register("tube_coral", new BlockCoralPlant(DEAD_TUBE_CORAL, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_BLUE).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block BRAIN_CORAL = register("brain_coral", new BlockCoralPlant(DEAD_BRAIN_CORAL, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_PINK).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block BUBBLE_CORAL = register("bubble_coral", new BlockCoralPlant(DEAD_BUBBLE_CORAL, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_PURPLE).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block FIRE_CORAL = register("fire_coral", new BlockCoralPlant(DEAD_FIRE_CORAL, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_RED).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block HORN_CORAL = register("horn_coral", new BlockCoralPlant(DEAD_HORN_CORAL, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_YELLOW).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    ...
    public static final Block TUBE_CORAL_FAN = register("tube_coral_fan", new BlockCoralFan(DEAD_TUBE_CORAL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_BLUE).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block BRAIN_CORAL_FAN = register("brain_coral_fan", new BlockCoralFan(DEAD_BRAIN_CORAL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_PINK).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block BUBBLE_CORAL_FAN = register("bubble_coral_fan", new BlockCoralFan(DEAD_BUBBLE_CORAL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_PURPLE).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block FIRE_CORAL_FAN = register("fire_coral_fan", new BlockCoralFan(DEAD_FIRE_CORAL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_RED).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block HORN_CORAL_FAN = register("horn_coral_fan", new BlockCoralFan(DEAD_HORN_CORAL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_YELLOW).noCollission().instabreak().sound(SoundEffectType.WET_GRASS)));
    public static final Block DEAD_TUBE_CORAL_WALL_FAN = register("dead_tube_coral_wall_fan", new BlockCoralFanWallAbstract(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission().instabreak().dropsLike(DEAD_TUBE_CORAL_FAN)));
    public static final Block DEAD_BRAIN_CORAL_WALL_FAN = register("dead_brain_coral_wall_fan", new BlockCoralFanWallAbstract(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission().instabreak().dropsLike(DEAD_BRAIN_CORAL_FAN)));
    public static final Block DEAD_BUBBLE_CORAL_WALL_FAN = register("dead_bubble_coral_wall_fan", new BlockCoralFanWallAbstract(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission().instabreak().dropsLike(DEAD_BUBBLE_CORAL_FAN)));
    public static final Block DEAD_FIRE_CORAL_WALL_FAN = register("dead_fire_coral_wall_fan", new BlockCoralFanWallAbstract(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission().instabreak().dropsLike(DEAD_FIRE_CORAL_FAN)));
    public static final Block DEAD_HORN_CORAL_WALL_FAN = register("dead_horn_coral_wall_fan", new BlockCoralFanWallAbstract(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_GRAY).requiresCorrectToolForDrops().noCollission().instabreak().dropsLike(DEAD_HORN_CORAL_FAN)));
    public static final Block TUBE_CORAL_WALL_FAN = register("tube_coral_wall_fan", new BlockCoralFanWall(DEAD_TUBE_CORAL_WALL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_BLUE).noCollission().instabreak().sound(SoundEffectType.WET_GRASS).dropsLike(TUBE_CORAL_FAN)));
    public static final Block BRAIN_CORAL_WALL_FAN = register("brain_coral_wall_fan", new BlockCoralFanWall(DEAD_BRAIN_CORAL_WALL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_PINK).noCollission().instabreak().sound(SoundEffectType.WET_GRASS).dropsLike(BRAIN_CORAL_FAN)));
    public static final Block BUBBLE_CORAL_WALL_FAN = register("bubble_coral_wall_fan", new BlockCoralFanWall(DEAD_BUBBLE_CORAL_WALL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_PURPLE).noCollission().instabreak().sound(SoundEffectType.WET_GRASS).dropsLike(BUBBLE_CORAL_FAN)));
    public static final Block FIRE_CORAL_WALL_FAN = register("fire_coral_wall_fan", new BlockCoralFanWall(DEAD_FIRE_CORAL_WALL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_RED).noCollission().instabreak().sound(SoundEffectType.WET_GRASS).dropsLike(FIRE_CORAL_FAN)));
    public static final Block HORN_CORAL_WALL_FAN = register("horn_coral_wall_fan", new BlockCoralFanWall(DEAD_HORN_CORAL_WALL_FAN, BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_YELLOW).noCollission().instabreak().sound(SoundEffectType.WET_GRASS).dropsLike(HORN_CORAL_FAN)));
    public static final Block SEA_PICKLE = register("sea_pickle", new BlockSeaPickle(BlockBase.Info.of(Material.WATER_PLANT, MaterialMapColor.COLOR_GREEN).lightLevel((state) -> {
    ...
    public static final Block POTTED_BAMBOO = register("potted_bamboo", new BlockFlowerPot(BAMBOO, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    ...
    public static final Block POLISHED_GRANITE_STAIRS = register("polished_granite_stairs", new BlockStairs(POLISHED_GRANITE.getBlockData(), BlockBase.Info.copy(POLISHED_GRANITE)));
    public static final Block SMOOTH_RED_SANDSTONE_STAIRS = register("smooth_red_sandstone_stairs", new BlockStairs(SMOOTH_RED_SANDSTONE.getBlockData(), BlockBase.Info.copy(SMOOTH_RED_SANDSTONE)));
    public static final Block MOSSY_STONE_BRICK_STAIRS = register("mossy_stone_brick_stairs", new BlockStairs(MOSSY_STONE_BRICKS.getBlockData(), BlockBase.Info.copy(MOSSY_STONE_BRICKS)));
    public static final Block POLISHED_DIORITE_STAIRS = register("polished_diorite_stairs", new BlockStairs(POLISHED_DIORITE.getBlockData(), BlockBase.Info.copy(POLISHED_DIORITE)));
    public static final Block MOSSY_COBBLESTONE_STAIRS = register("mossy_cobblestone_stairs", new BlockStairs(MOSSY_COBBLESTONE.getBlockData(), BlockBase.Info.copy(MOSSY_COBBLESTONE)));
    public static final Block END_STONE_BRICK_STAIRS = register("end_stone_brick_stairs", new BlockStairs(END_STONE_BRICKS.getBlockData(), BlockBase.Info.copy(END_STONE_BRICKS)));
    public static final Block STONE_STAIRS = register("stone_stairs", new BlockStairs(STONE.getBlockData(), BlockBase.Info.copy(STONE)));
    public static final Block SMOOTH_SANDSTONE_STAIRS = register("smooth_sandstone_stairs", new BlockStairs(SMOOTH_SANDSTONE.getBlockData(), BlockBase.Info.copy(SMOOTH_SANDSTONE)));
    public static final Block SMOOTH_QUARTZ_STAIRS = register("smooth_quartz_stairs", new BlockStairs(SMOOTH_QUARTZ.getBlockData(), BlockBase.Info.copy(SMOOTH_QUARTZ)));
    public static final Block GRANITE_STAIRS = register("granite_stairs", new BlockStairs(GRANITE.getBlockData(), BlockBase.Info.copy(GRANITE)));
    public static final Block ANDESITE_STAIRS = register("andesite_stairs", new BlockStairs(ANDESITE.getBlockData(), BlockBase.Info.copy(ANDESITE)));
    public static final Block RED_NETHER_BRICK_STAIRS = register("red_nether_brick_stairs", new BlockStairs(RED_NETHER_BRICKS.getBlockData(), BlockBase.Info.copy(RED_NETHER_BRICKS)));
    public static final Block POLISHED_ANDESITE_STAIRS = register("polished_andesite_stairs", new BlockStairs(POLISHED_ANDESITE.getBlockData(), BlockBase.Info.copy(POLISHED_ANDESITE)));
    public static final Block DIORITE_STAIRS = register("diorite_stairs", new BlockStairs(DIORITE.getBlockData(), BlockBase.Info.copy(DIORITE)));
    public static final Block POLISHED_GRANITE_SLAB = register("polished_granite_slab", new BlockStepAbstract(BlockBase.Info.copy(POLISHED_GRANITE)));
    public static final Block SMOOTH_RED_SANDSTONE_SLAB = register("smooth_red_sandstone_slab", new BlockStepAbstract(BlockBase.Info.copy(SMOOTH_RED_SANDSTONE)));
    public static final Block MOSSY_STONE_BRICK_SLAB = register("mossy_stone_brick_slab", new BlockStepAbstract(BlockBase.Info.copy(MOSSY_STONE_BRICKS)));
    public static final Block POLISHED_DIORITE_SLAB = register("polished_diorite_slab", new BlockStepAbstract(BlockBase.Info.copy(POLISHED_DIORITE)));
    public static final Block MOSSY_COBBLESTONE_SLAB = register("mossy_cobblestone_slab", new BlockStepAbstract(BlockBase.Info.copy(MOSSY_COBBLESTONE)));
    public static final Block END_STONE_BRICK_SLAB = register("end_stone_brick_slab", new BlockStepAbstract(BlockBase.Info.copy(END_STONE_BRICKS)));
    public static final Block SMOOTH_SANDSTONE_SLAB = register("smooth_sandstone_slab", new BlockStepAbstract(BlockBase.Info.copy(SMOOTH_SANDSTONE)));
    public static final Block SMOOTH_QUARTZ_SLAB = register("smooth_quartz_slab", new BlockStepAbstract(BlockBase.Info.copy(SMOOTH_QUARTZ)));
    public static final Block GRANITE_SLAB = register("granite_slab", new BlockStepAbstract(BlockBase.Info.copy(GRANITE)));
    public static final Block ANDESITE_SLAB = register("andesite_slab", new BlockStepAbstract(BlockBase.Info.copy(ANDESITE)));
    public static final Block RED_NETHER_BRICK_SLAB = register("red_nether_brick_slab", new BlockStepAbstract(BlockBase.Info.copy(RED_NETHER_BRICKS)));
    public static final Block POLISHED_ANDESITE_SLAB = register("polished_andesite_slab", new BlockStepAbstract(BlockBase.Info.copy(POLISHED_ANDESITE)));
    public static final Block DIORITE_SLAB = register("diorite_slab", new BlockStepAbstract(BlockBase.Info.copy(DIORITE)));
    public static final Block BRICK_WALL = register("brick_wall", new BlockCobbleWall(BlockBase.Info.copy(BRICKS)));
    public static final Block PRISMARINE_WALL = register("prismarine_wall", new BlockCobbleWall(BlockBase.Info.copy(PRISMARINE)));
    public static final Block RED_SANDSTONE_WALL = register("red_sandstone_wall", new BlockCobbleWall(BlockBase.Info.copy(RED_SANDSTONE)));
    public static final Block MOSSY_STONE_BRICK_WALL = register("mossy_stone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(MOSSY_STONE_BRICKS)));
    public static final Block GRANITE_WALL = register("granite_wall", new BlockCobbleWall(BlockBase.Info.copy(GRANITE)));
    public static final Block STONE_BRICK_WALL = register("stone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(STONE_BRICKS)));
    public static final Block NETHER_BRICK_WALL = register("nether_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(NETHER_BRICKS)));
    public static final Block ANDESITE_WALL = register("andesite_wall", new BlockCobbleWall(BlockBase.Info.copy(ANDESITE)));
    public static final Block RED_NETHER_BRICK_WALL = register("red_nether_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(RED_NETHER_BRICKS)));
    public static final Block SANDSTONE_WALL = register("sandstone_wall", new BlockCobbleWall(BlockBase.Info.copy(SANDSTONE)));
    public static final Block END_STONE_BRICK_WALL = register("end_stone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(END_STONE_BRICKS)));
    public static final Block DIORITE_WALL = register("diorite_wall", new BlockCobbleWall(BlockBase.Info.copy(DIORITE)));
    ...
    public static final Block LANTERN = register("lantern", new BlockLantern(BlockBase.Info.of(Material.METAL).requiresCorrectToolForDrops().strength(3.5F).sound(SoundEffectType.LANTERN).lightLevel((state) -> {
        return 15;
    }).noOcclusion()));
    public static final Block SOUL_LANTERN = register("soul_lantern", new BlockLantern(BlockBase.Info.of(Material.METAL).requiresCorrectToolForDrops().strength(3.5F).sound(SoundEffectType.LANTERN).lightLevel((state) -> {
        return 10;
    }).noOcclusion()));
    ...
    public static final Block CRIMSON_SLAB = register("crimson_slab", new BlockStepAbstract(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block WARPED_SLAB = register("warped_slab", new BlockStepAbstract(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block CRIMSON_PRESSURE_PLATE = register("crimson_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block WARPED_PRESSURE_PLATE = register("warped_pressure_plate", new BlockPressurePlateBinary(BlockPressurePlateBinary.EnumMobType.EVERYTHING, BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundEffectType.WOOD)));
    public static final Block CRIMSON_FENCE = register("crimson_fence", new BlockFence(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block WARPED_FENCE = register("warped_fence", new BlockFence(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block CRIMSON_TRAPDOOR = register("crimson_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never)));
    public static final Block WARPED_TRAPDOOR = register("warped_trapdoor", new BlockTrapdoor(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion().isValidSpawn(Blocks::never)));
    public static final Block CRIMSON_FENCE_GATE = register("crimson_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block WARPED_FENCE_GATE = register("warped_fence_gate", new BlockFenceGate(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundEffectType.WOOD)));
    public static final Block CRIMSON_STAIRS = register("crimson_stairs", new BlockStairs(CRIMSON_PLANKS.getBlockData(), BlockBase.Info.copy(CRIMSON_PLANKS)));
    public static final Block WARPED_STAIRS = register("warped_stairs", new BlockStairs(WARPED_PLANKS.getBlockData(), BlockBase.Info.copy(WARPED_PLANKS)));
    ...
    public static final Block CRIMSON_DOOR = register("crimson_door", new BlockDoor(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block WARPED_DOOR = register("warped_door", new BlockDoor(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).strength(3.0F).sound(SoundEffectType.WOOD).noOcclusion()));
    public static final Block CRIMSON_SIGN = register("crimson_sign", new BlockFloorSign(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_SIGN = register("warped_sign", new BlockFloorSign(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD), BlockPropertyWood.WARPED));
    public static final Block CRIMSON_WALL_SIGN = register("crimson_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.NETHER_WOOD, CRIMSON_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(CRIMSON_SIGN), BlockPropertyWood.CRIMSON));
    public static final Block WARPED_WALL_SIGN = register("warped_wall_sign", new BlockWallSign(BlockBase.Info.of(Material.NETHER_WOOD, WARPED_PLANKS.defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundEffectType.WOOD).dropsLike(WARPED_SIGN), BlockPropertyWood.WARPED));
    ...
    public static final Block CRYING_OBSIDIAN = register("crying_obsidian", new BlockCryingObsidian(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_BLACK).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).lightLevel((state) -> {
        return 10;
    })));
    public static final Block RESPAWN_ANCHOR = register("respawn_anchor", new BlockRespawnAnchor(BlockBase.Info.of(Material.STONE, MaterialMapColor.COLOR_BLACK).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).lightLevel((state) -> {
        return BlockRespawnAnchor.getScaledChargeLevel(state, 15);
    })));
    public static final Block POTTED_CRIMSON_FUNGUS = register("potted_crimson_fungus", new BlockFlowerPot(CRIMSON_FUNGUS, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_WARPED_FUNGUS = register("potted_warped_fungus", new BlockFlowerPot(WARPED_FUNGUS, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_CRIMSON_ROOTS = register("potted_crimson_roots", new BlockFlowerPot(CRIMSON_ROOTS, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_WARPED_ROOTS = register("potted_warped_roots", new BlockFlowerPot(WARPED_ROOTS, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    ...
    public static final Block BLACKSTONE_STAIRS = register("blackstone_stairs", new BlockStairs(BLACKSTONE.getBlockData(), BlockBase.Info.copy(BLACKSTONE)));
    public static final Block BLACKSTONE_WALL = register("blackstone_wall", new BlockCobbleWall(BlockBase.Info.copy(BLACKSTONE)));
    public static final Block BLACKSTONE_SLAB = register("blackstone_slab", new BlockStepAbstract(BlockBase.Info.copy(BLACKSTONE).strength(2.0F, 6.0F)));
    public static final Block POLISHED_BLACKSTONE = register("polished_blackstone", new Block(BlockBase.Info.copy(BLACKSTONE).strength(2.0F, 6.0F)));
    public static final Block POLISHED_BLACKSTONE_BRICKS = register("polished_blackstone_bricks", new Block(BlockBase.Info.copy(POLISHED_BLACKSTONE).strength(1.5F, 6.0F)));
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICKS = register("cracked_polished_blackstone_bricks", new Block(BlockBase.Info.copy(POLISHED_BLACKSTONE_BRICKS)));
    public static final Block CHISELED_POLISHED_BLACKSTONE = register("chiseled_polished_blackstone", new Block(BlockBase.Info.copy(POLISHED_BLACKSTONE).strength(1.5F, 6.0F)));
    public static final Block POLISHED_BLACKSTONE_BRICK_SLAB = register("polished_blackstone_brick_slab", new BlockStepAbstract(BlockBase.Info.copy(POLISHED_BLACKSTONE_BRICKS).strength(2.0F, 6.0F)));
    public static final Block POLISHED_BLACKSTONE_BRICK_STAIRS = register("polished_blackstone_brick_stairs", new BlockStairs(POLISHED_BLACKSTONE_BRICKS.getBlockData(), BlockBase.Info.copy(POLISHED_BLACKSTONE_BRICKS)));
    public static final Block POLISHED_BLACKSTONE_BRICK_WALL = register("polished_blackstone_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(POLISHED_BLACKSTONE_BRICKS)));
    public static final Block GILDED_BLACKSTONE = register("gilded_blackstone", new Block(BlockBase.Info.copy(BLACKSTONE).sound(SoundEffectType.GILDED_BLACKSTONE)));
    public static final Block POLISHED_BLACKSTONE_STAIRS = register("polished_blackstone_stairs", new BlockStairs(POLISHED_BLACKSTONE.getBlockData(), BlockBase.Info.copy(POLISHED_BLACKSTONE)));
    public static final Block POLISHED_BLACKSTONE_SLAB = register("polished_blackstone_slab", new BlockStepAbstract(BlockBase.Info.copy(POLISHED_BLACKSTONE)));
    ...
    public static final Block POLISHED_BLACKSTONE_WALL = register("polished_blackstone_wall", new BlockCobbleWall(BlockBase.Info.copy(POLISHED_BLACKSTONE)));
    ...
    public static final Block QUARTZ_BRICKS = register("quartz_bricks", new Block(BlockBase.Info.copy(QUARTZ_BLOCK)));
    public static final Block CANDLE = register("candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.SAND).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block WHITE_CANDLE = register("white_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.WOOL).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block ORANGE_CANDLE = register("orange_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_ORANGE).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block MAGENTA_CANDLE = register("magenta_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_MAGENTA).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block LIGHT_BLUE_CANDLE = register("light_blue_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_LIGHT_BLUE).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block YELLOW_CANDLE = register("yellow_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_YELLOW).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block LIME_CANDLE = register("lime_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_LIGHT_GREEN).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block PINK_CANDLE = register("pink_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_PINK).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block GRAY_CANDLE = register("gray_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_GRAY).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block LIGHT_GRAY_CANDLE = register("light_gray_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_LIGHT_GRAY).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block CYAN_CANDLE = register("cyan_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_CYAN).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block PURPLE_CANDLE = register("purple_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_PURPLE).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block BLUE_CANDLE = register("blue_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_BLUE).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block BROWN_CANDLE = register("brown_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_BROWN).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block GREEN_CANDLE = register("green_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_GREEN).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block RED_CANDLE = register("red_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_RED).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block BLACK_CANDLE = register("black_candle", new BlockCandle(BlockBase.Info.of(Material.DECORATION, MaterialMapColor.COLOR_BLACK).noOcclusion().strength(0.1F).sound(SoundEffectType.CANDLE).lightLevel(BlockCandle.LIGHT_EMISSION)));
    public static final Block CANDLE_CAKE = register("candle_cake", new BlockCandleCake(CANDLE, BlockBase.Info.copy(CAKE).lightLevel(litBlockEmission(3))));
    public static final Block WHITE_CANDLE_CAKE = register("white_candle_cake", new BlockCandleCake(WHITE_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block ORANGE_CANDLE_CAKE = register("orange_candle_cake", new BlockCandleCake(ORANGE_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block MAGENTA_CANDLE_CAKE = register("magenta_candle_cake", new BlockCandleCake(MAGENTA_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block LIGHT_BLUE_CANDLE_CAKE = register("light_blue_candle_cake", new BlockCandleCake(LIGHT_BLUE_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block YELLOW_CANDLE_CAKE = register("yellow_candle_cake", new BlockCandleCake(YELLOW_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block LIME_CANDLE_CAKE = register("lime_candle_cake", new BlockCandleCake(LIME_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block PINK_CANDLE_CAKE = register("pink_candle_cake", new BlockCandleCake(PINK_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block GRAY_CANDLE_CAKE = register("gray_candle_cake", new BlockCandleCake(GRAY_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block LIGHT_GRAY_CANDLE_CAKE = register("light_gray_candle_cake", new BlockCandleCake(LIGHT_GRAY_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block CYAN_CANDLE_CAKE = register("cyan_candle_cake", new BlockCandleCake(CYAN_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block PURPLE_CANDLE_CAKE = register("purple_candle_cake", new BlockCandleCake(PURPLE_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block BLUE_CANDLE_CAKE = register("blue_candle_cake", new BlockCandleCake(BLUE_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block BROWN_CANDLE_CAKE = register("brown_candle_cake", new BlockCandleCake(BROWN_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block GREEN_CANDLE_CAKE = register("green_candle_cake", new BlockCandleCake(GREEN_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block RED_CANDLE_CAKE = register("red_candle_cake", new BlockCandleCake(RED_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block BLACK_CANDLE_CAKE = register("black_candle_cake", new BlockCandleCake(BLACK_CANDLE, BlockBase.Info.copy(CANDLE_CAKE)));
    public static final Block AMETHYST_BLOCK = register("amethyst_block", new BlockAmethyst(BlockBase.Info.of(Material.AMETHYST, MaterialMapColor.COLOR_PURPLE).strength(1.5F).sound(SoundEffectType.AMETHYST).requiresCorrectToolForDrops()));
    ...
    public static final Block AMETHYST_CLUSTER = register("amethyst_cluster", new BlockAmethystCluster(7, 3, BlockBase.Info.of(Material.AMETHYST).noOcclusion().randomTicks().sound(SoundEffectType.AMETHYST_CLUSTER).strength(1.5F).lightLevel((state) -> {
        return 5;
    })));
    ...
    public static final Block TINTED_GLASS = register("tinted_glass", new TintedGlassBlock(BlockBase.Info.copy(GLASS).color(MaterialMapColor.COLOR_GRAY).noOcclusion().isValidSpawn(Blocks::never).isRedstoneConductor(Blocks::never).isSuffocating(Blocks::never).isViewBlocking(Blocks::never)));
    public static final Block POWDER_SNOW = register("powder_snow", new BlockPowderSnow(BlockBase.Info.of(Material.POWDER_SNOW).strength(0.25F).sound(SoundEffectType.POWDER_SNOW).dynamicShape()));
    public static final Block SCULK_SENSOR = register("sculk_sensor", new BlockSculkSensor(BlockBase.Info.of(Material.SCULK, MaterialMapColor.COLOR_CYAN).strength(1.5F).sound(SoundEffectType.SCULK_SENSOR).lightLevel((blockStatex) -> {
        return 1;
    }).emissiveRendering((state, world, pos) -> {
        return BlockSculkSensor.getPhase(state) == SculkSensorPhase.ACTIVE;
    }), 8));
    public static final Block OXIDIZED_COPPER = register("oxidized_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBase.Info.of(Material.METAL, MaterialMapColor.WARPED_NYLIUM).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    public static final Block WEATHERED_COPPER = register("weathered_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBase.Info.of(Material.METAL, MaterialMapColor.WARPED_STEM).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    public static final Block EXPOSED_COPPER = register("exposed_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBase.Info.of(Material.METAL, MaterialMapColor.TERRACOTTA_LIGHT_GRAY).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    public static final Block COPPER_BLOCK = register("copper_block", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBase.Info.of(Material.METAL, MaterialMapColor.COLOR_ORANGE).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER)));
    public static final Block COPPER_ORE = register("copper_ore", new BlockOre(BlockBase.Info.copy(IRON_ORE)));
    public static final Block DEEPSLATE_COPPER_ORE = register("deepslate_copper_ore", new BlockOre(BlockBase.Info.copy(COPPER_ORE).color(MaterialMapColor.DEEPSLATE).strength(4.5F, 3.0F).sound(SoundEffectType.DEEPSLATE)));
    public static final Block OXIDIZED_CUT_COPPER = register("oxidized_cut_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBase.Info.copy(OXIDIZED_COPPER)));
    public static final Block WEATHERED_CUT_COPPER = register("weathered_cut_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBase.Info.copy(WEATHERED_COPPER)));
    public static final Block EXPOSED_CUT_COPPER = register("exposed_cut_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBase.Info.copy(EXPOSED_COPPER)));
    public static final Block CUT_COPPER = register("cut_copper", new WeatheringCopperFullBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBase.Info.copy(COPPER_BLOCK)));
    public static final Block OXIDIZED_CUT_COPPER_STAIRS = register("oxidized_cut_copper_stairs", new WeatheringCopperStairBlock(WeatheringCopper.WeatherState.OXIDIZED, OXIDIZED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(OXIDIZED_CUT_COPPER)));
    public static final Block WEATHERED_CUT_COPPER_STAIRS = register("weathered_cut_copper_stairs", new WeatheringCopperStairBlock(WeatheringCopper.WeatherState.WEATHERED, WEATHERED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(WEATHERED_COPPER)));
    public static final Block EXPOSED_CUT_COPPER_STAIRS = register("exposed_cut_copper_stairs", new WeatheringCopperStairBlock(WeatheringCopper.WeatherState.EXPOSED, EXPOSED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(EXPOSED_COPPER)));
    public static final Block CUT_COPPER_STAIRS = register("cut_copper_stairs", new WeatheringCopperStairBlock(WeatheringCopper.WeatherState.UNAFFECTED, CUT_COPPER.getBlockData(), BlockBase.Info.copy(COPPER_BLOCK)));
    public static final Block OXIDIZED_CUT_COPPER_SLAB = register("oxidized_cut_copper_slab", new WeatheringCopperSlabBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBase.Info.copy(OXIDIZED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block WEATHERED_CUT_COPPER_SLAB = register("weathered_cut_copper_slab", new WeatheringCopperSlabBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBase.Info.copy(WEATHERED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block EXPOSED_CUT_COPPER_SLAB = register("exposed_cut_copper_slab", new WeatheringCopperSlabBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBase.Info.copy(EXPOSED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block CUT_COPPER_SLAB = register("cut_copper_slab", new WeatheringCopperSlabBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBase.Info.copy(CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block WAXED_COPPER_BLOCK = register("waxed_copper_block", new Block(BlockBase.Info.copy(COPPER_BLOCK)));
    public static final Block WAXED_WEATHERED_COPPER = register("waxed_weathered_copper", new Block(BlockBase.Info.copy(WEATHERED_COPPER)));
    public static final Block WAXED_EXPOSED_COPPER = register("waxed_exposed_copper", new Block(BlockBase.Info.copy(EXPOSED_COPPER)));
    public static final Block WAXED_OXIDIZED_COPPER = register("waxed_oxidized_copper", new Block(BlockBase.Info.copy(OXIDIZED_COPPER)));
    public static final Block WAXED_OXIDIZED_CUT_COPPER = register("waxed_oxidized_cut_copper", new Block(BlockBase.Info.copy(OXIDIZED_COPPER)));
    public static final Block WAXED_WEATHERED_CUT_COPPER = register("waxed_weathered_cut_copper", new Block(BlockBase.Info.copy(WEATHERED_COPPER)));
    public static final Block WAXED_EXPOSED_CUT_COPPER = register("waxed_exposed_cut_copper", new Block(BlockBase.Info.copy(EXPOSED_COPPER)));
    public static final Block WAXED_CUT_COPPER = register("waxed_cut_copper", new Block(BlockBase.Info.copy(COPPER_BLOCK)));
    public static final Block WAXED_OXIDIZED_CUT_COPPER_STAIRS = register("waxed_oxidized_cut_copper_stairs", new BlockStairs(WAXED_OXIDIZED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(OXIDIZED_COPPER)));
    public static final Block WAXED_WEATHERED_CUT_COPPER_STAIRS = register("waxed_weathered_cut_copper_stairs", new BlockStairs(WAXED_WEATHERED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(WEATHERED_COPPER)));
    public static final Block WAXED_EXPOSED_CUT_COPPER_STAIRS = register("waxed_exposed_cut_copper_stairs", new BlockStairs(WAXED_EXPOSED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(EXPOSED_COPPER)));
    public static final Block WAXED_CUT_COPPER_STAIRS = register("waxed_cut_copper_stairs", new BlockStairs(WAXED_CUT_COPPER.getBlockData(), BlockBase.Info.copy(COPPER_BLOCK)));
    public static final Block WAXED_OXIDIZED_CUT_COPPER_SLAB = register("waxed_oxidized_cut_copper_slab", new BlockStepAbstract(BlockBase.Info.copy(WAXED_OXIDIZED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block WAXED_WEATHERED_CUT_COPPER_SLAB = register("waxed_weathered_cut_copper_slab", new BlockStepAbstract(BlockBase.Info.copy(WAXED_WEATHERED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block WAXED_EXPOSED_CUT_COPPER_SLAB = register("waxed_exposed_cut_copper_slab", new BlockStepAbstract(BlockBase.Info.copy(WAXED_EXPOSED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block WAXED_CUT_COPPER_SLAB = register("waxed_cut_copper_slab", new BlockStepAbstract(BlockBase.Info.copy(WAXED_CUT_COPPER).requiresCorrectToolForDrops()));
    public static final Block LIGHTNING_ROD = register("lightning_rod", new BlockLightningRod(BlockBase.Info.of(Material.METAL, MaterialMapColor.COLOR_ORANGE).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundEffectType.COPPER).noOcclusion()));
    public static final Block POINTED_DRIPSTONE = register("pointed_dripstone", new BlockDripstonePointed(BlockBase.Info.of(Material.STONE, MaterialMapColor.TERRACOTTA_BROWN).noOcclusion().sound(SoundEffectType.POINTED_DRIPSTONE).randomTicks().strength(1.5F, 3.0F).dynamicShape()));
    ...
    public static final Block CAVE_VINES = register("cave_vines", new BlockCaveVines(BlockBase.Info.of(Material.PLANT).randomTicks().noCollission().lightLevel(ICaveVine.emission(14)).instabreak().sound(SoundEffectType.CAVE_VINES)));
    public static final Block CAVE_VINES_PLANT = register("cave_vines_plant", new BlockCaveVinesPlant(BlockBase.Info.of(Material.PLANT).noCollission().lightLevel(ICaveVine.emission(14)).instabreak().sound(SoundEffectType.CAVE_VINES)));
    public static final Block SPORE_BLOSSOM = register("spore_blossom", new BlockSporeBlossom(BlockBase.Info.of(Material.PLANT).instabreak().noCollission().sound(SoundEffectType.SPORE_BLOSSOM)));
    public static final Block AZALEA = register("azalea", new BlockAzalea(BlockBase.Info.of(Material.PLANT).instabreak().sound(SoundEffectType.AZALEA).noOcclusion()));
    public static final Block FLOWERING_AZALEA = register("flowering_azalea", new BlockAzalea(BlockBase.Info.of(Material.PLANT).instabreak().sound(SoundEffectType.FLOWERING_AZALEA).noOcclusion()));
    public static final Block MOSS_CARPET = register("moss_carpet", new BlockCarpetBase(BlockBase.Info.of(Material.PLANT, MaterialMapColor.COLOR_GREEN).strength(0.1F).sound(SoundEffectType.MOSS_CARPET)));
    public static final Block MOSS_BLOCK = register("moss_block", new BlockMoss(BlockBase.Info.of(Material.MOSS, MaterialMapColor.COLOR_GREEN).strength(0.1F).sound(SoundEffectType.MOSS)));
    public static final Block BIG_DRIPLEAF = register("big_dripleaf", new BlockDripleafBig(BlockBase.Info.of(Material.PLANT).strength(0.1F).sound(SoundEffectType.BIG_DRIPLEAF)));
    public static final Block BIG_DRIPLEAF_STEM = register("big_dripleaf_stem", new BlockDripleafStemBig(BlockBase.Info.of(Material.PLANT).noCollission().strength(0.1F).sound(SoundEffectType.BIG_DRIPLEAF)));
    public static final Block SMALL_DRIPLEAF = register("small_dripleaf", new BlockDripleafSmall(BlockBase.Info.of(Material.PLANT).noCollission().instabreak().sound(SoundEffectType.SMALL_DRIPLEAF)));
    ...
    public static final Block ROOTED_DIRT = register("rooted_dirt", new BlockRootedDirt(BlockBase.Info.of(Material.DIRT, MaterialMapColor.DIRT).strength(0.5F).sound(SoundEffectType.ROOTED_DIRT)));
    ...
    public static final Block COBBLED_DEEPSLATE = register("cobbled_deepslate", new Block(BlockBase.Info.copy(DEEPSLATE).strength(3.5F, 6.0F)));
    public static final Block COBBLED_DEEPSLATE_STAIRS = register("cobbled_deepslate_stairs", new BlockStairs(COBBLED_DEEPSLATE.getBlockData(), BlockBase.Info.copy(COBBLED_DEEPSLATE)));
    public static final Block COBBLED_DEEPSLATE_SLAB = register("cobbled_deepslate_slab", new BlockStepAbstract(BlockBase.Info.copy(COBBLED_DEEPSLATE)));
    public static final Block COBBLED_DEEPSLATE_WALL = register("cobbled_deepslate_wall", new BlockCobbleWall(BlockBase.Info.copy(COBBLED_DEEPSLATE)));
    public static final Block POLISHED_DEEPSLATE = register("polished_deepslate", new Block(BlockBase.Info.copy(COBBLED_DEEPSLATE).sound(SoundEffectType.POLISHED_DEEPSLATE)));
    public static final Block POLISHED_DEEPSLATE_STAIRS = register("polished_deepslate_stairs", new BlockStairs(POLISHED_DEEPSLATE.getBlockData(), BlockBase.Info.copy(POLISHED_DEEPSLATE)));
    public static final Block POLISHED_DEEPSLATE_SLAB = register("polished_deepslate_slab", new BlockStepAbstract(BlockBase.Info.copy(POLISHED_DEEPSLATE)));
    public static final Block POLISHED_DEEPSLATE_WALL = register("polished_deepslate_wall", new BlockCobbleWall(BlockBase.Info.copy(POLISHED_DEEPSLATE)));
    public static final Block DEEPSLATE_TILES = register("deepslate_tiles", new Block(BlockBase.Info.copy(COBBLED_DEEPSLATE).sound(SoundEffectType.DEEPSLATE_TILES)));
    public static final Block DEEPSLATE_TILE_STAIRS = register("deepslate_tile_stairs", new BlockStairs(DEEPSLATE_TILES.getBlockData(), BlockBase.Info.copy(DEEPSLATE_TILES)));
    public static final Block DEEPSLATE_TILE_SLAB = register("deepslate_tile_slab", new BlockStepAbstract(BlockBase.Info.copy(DEEPSLATE_TILES)));
    public static final Block DEEPSLATE_TILE_WALL = register("deepslate_tile_wall", new BlockCobbleWall(BlockBase.Info.copy(DEEPSLATE_TILES)));
    public static final Block DEEPSLATE_BRICKS = register("deepslate_bricks", new Block(BlockBase.Info.copy(COBBLED_DEEPSLATE).sound(SoundEffectType.DEEPSLATE_BRICKS)));
    public static final Block DEEPSLATE_BRICK_STAIRS = register("deepslate_brick_stairs", new BlockStairs(DEEPSLATE_BRICKS.getBlockData(), BlockBase.Info.copy(DEEPSLATE_BRICKS)));
    public static final Block DEEPSLATE_BRICK_SLAB = register("deepslate_brick_slab", new BlockStepAbstract(BlockBase.Info.copy(DEEPSLATE_BRICKS)));
    public static final Block DEEPSLATE_BRICK_WALL = register("deepslate_brick_wall", new BlockCobbleWall(BlockBase.Info.copy(DEEPSLATE_BRICKS)));
    public static final Block CHISELED_DEEPSLATE = register("chiseled_deepslate", new Block(BlockBase.Info.copy(COBBLED_DEEPSLATE).sound(SoundEffectType.DEEPSLATE_BRICKS)));
    public static final Block CRACKED_DEEPSLATE_BRICKS = register("cracked_deepslate_bricks", new Block(BlockBase.Info.copy(DEEPSLATE_BRICKS)));
    public static final Block CRACKED_DEEPSLATE_TILES = register("cracked_deepslate_tiles", new Block(BlockBase.Info.copy(DEEPSLATE_TILES)));
    public static final Block INFESTED_DEEPSLATE = register("infested_deepslate", new BlockInfestedRotatedPillar(DEEPSLATE, BlockBase.Info.of(Material.CLAY, MaterialMapColor.DEEPSLATE).sound(SoundEffectType.DEEPSLATE)));
    public static final Block SMOOTH_BASALT = register("smooth_basalt", new Block(BlockBase.Info.copy(BASALT)));
    ...
    public static final Block POTTED_AZALEA = register("potted_azalea_bush", new BlockFlowerPot(AZALEA, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));
    public static final Block POTTED_FLOWERING_AZALEA = register("potted_flowering_azalea_bush", new BlockFlowerPot(FLOWERING_AZALEA, BlockBase.Info.of(Material.DECORATION).instabreak().noOcclusion()));

    private static ToIntFunction<IBlockData> litBlockEmission(int litLevel) {
        return (state) -> {
            return state.get(BlockProperties.LIT) ? litLevel : 0;
        };
    }

    private static Boolean never(IBlockData state, IBlockAccess world, BlockPosition pos, EntityTypes<?> type) {
        return (boolean)false;
    }

    private static Boolean always(IBlockData state, IBlockAccess world, BlockPosition pos, EntityTypes<?> type) {
        return (boolean)true;
    }

    private static Boolean ocelotOrParrot(IBlockData state, IBlockAccess world, BlockPosition pos, EntityTypes<?> type) {
        return type == EntityTypes.OCELOT || type == EntityTypes.PARROT;
    }

    private static BlockBed bed(EnumColor color) {
        return new BlockBed(color, BlockBase.Info.of(Material.WOOL, (state) -> {
            return state.get(BlockBed.PART) == BlockPropertyBedPart.FOOT ? color.getMaterialColor() : MaterialMapColor.WOOL;
        }).sound(SoundEffectType.WOOD).strength(0.2F).noOcclusion());
    }

    private static BlockRotatable log(MaterialMapColor topMapColor, MaterialMapColor sideMapColor) {
        return new BlockRotatable(BlockBase.Info.of(Material.WOOD, (state) -> {
            return state.get(BlockRotatable.AXIS) == EnumDirection.EnumAxis.Y ? topMapColor : sideMapColor;
        }).strength(2.0F).sound(SoundEffectType.WOOD));
    }

    private static Block netherStem(MaterialMapColor mapColor) {
        return new BlockRotatable(BlockBase.Info.of(Material.NETHER_WOOD, (state) -> {
            return mapColor;
        }).strength(2.0F).sound(SoundEffectType.STEM));
    }

    private static boolean always(IBlockData state, IBlockAccess world, BlockPosition pos) {
        return true;
    }

    private static boolean never(IBlockData state, IBlockAccess world, BlockPosition pos) {
        return false;
    }

    private static BlockStainedGlass stainedGlass(EnumColor color) {
        return new BlockStainedGlass(color, BlockBase.Info.of(Material.GLASS, color).strength(0.3F).sound(SoundEffectType.GLASS).noOcclusion().isValidSpawn(Blocks::never).isRedstoneConductor(Blocks::never).isSuffocating(Blocks::never).isViewBlocking(Blocks::never));
    }

    private static BlockLeaves leaves(SoundEffectType soundGroup) {
        return new BlockLeaves(BlockBase.Info.of(Material.LEAVES).strength(0.2F).randomTicks().sound(soundGroup).noOcclusion().isValidSpawn(Blocks::ocelotOrParrot).isSuffocating(Blocks::never).isViewBlocking(Blocks::never));
    }

    private static BlockShulkerBox shulkerBox(EnumColor color, BlockBase.Info settings) {
        BlockBase.StatePredicate statePredicate = (state, world, pos) -> {
        ...
        return new BlockShulkerBox(color, settings.strength(2.0F).dynamicShape().noOcclusion().isSuffocating(statePredicate).isViewBlocking(statePredicate));
    }

    private static BlockPiston pistonBase(boolean sticky) {
        BlockBase.StatePredicate statePredicate = (state, world, pos) -> {
            return !state.get(BlockPiston.EXTENDED);
        };
        return new BlockPiston(sticky, BlockBase.Info.of(Material.PISTON).strength(1.5F).isRedstoneConductor(Blocks::never).isSuffocating(statePredicate).isViewBlocking(statePredicate));
    }

    private static Block register(String id, Block block) {
        return IRegistry.register(IRegistry.BLOCK, id, block);
    }
    ...
    static {
        for(Block block : IRegistry.BLOCK) {
            for(IBlockData blockState : block.getStates().getPossibleStates()) {
