...
public class BlockProperties {
    ...
    public static final BlockStateDirection FACING_HOPPER = BlockStateDirection.create("facing", (facing) -> {
        return facing != EnumDirection.UP;
    });
    ...
    public static final BlockStateEnum<BlockPropertyTrackPosition> RAIL_SHAPE_STRAIGHT = BlockStateEnum.create("shape", BlockPropertyTrackPosition.class, (shape) -> {
        return shape != BlockPropertyTrackPosition.NORTH_EAST && shape != BlockPropertyTrackPosition.NORTH_WEST && shape != BlockPropertyTrackPosition.SOUTH_EAST && shape != BlockPropertyTrackPosition.SOUTH_WEST;
    });
