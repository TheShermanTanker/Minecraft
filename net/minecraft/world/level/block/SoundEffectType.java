...
public class SoundEffectType {
    ...
    public SoundEffectType(float volume, float pitch, SoundEffect breakSound, SoundEffect stepSound, SoundEffect placeSound, SoundEffect hitSound, SoundEffect fallSound) {
        this.volume = volume;
        this.pitch = pitch;
