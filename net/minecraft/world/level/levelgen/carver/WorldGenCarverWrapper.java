...
public class WorldGenCarverWrapper<WC extends WorldGenCarverConfiguration> {
    public static final Codec<WorldGenCarverWrapper<?>> DIRECT_CODEC = IRegistry.CARVER.dispatch((configuredWorldCarver) -> {
    ...
    public boolean carve(CarvingContext context, IChunkAccess chunk, Function<BlockPosition, BiomeBase> posToBiome, Random random, Aquifer aquifer, ChunkCoordIntPair pos, BitSet carvingMask) {
        return this.worldCarver.carve(context, this.config, chunk, posToBiome, random, aquifer, pos, carvingMask);
    }
}
