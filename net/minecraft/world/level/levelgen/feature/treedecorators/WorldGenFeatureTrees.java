...
public class WorldGenFeatureTrees<P extends WorldGenFeatureTree> {
    ...
    private static <P extends WorldGenFeatureTree> WorldGenFeatureTrees<P> register(String id, Codec<P> codec) {
        return IRegistry.register(IRegistry.TREE_DECORATOR_TYPES, id, new WorldGenFeatureTrees<>(codec));
    }
