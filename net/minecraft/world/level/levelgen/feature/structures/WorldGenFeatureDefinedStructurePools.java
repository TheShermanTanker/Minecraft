...
public interface WorldGenFeatureDefinedStructurePools<P extends WorldGenFeatureDefinedStructurePoolStructure> {
    ...
    static <P extends WorldGenFeatureDefinedStructurePoolStructure> WorldGenFeatureDefinedStructurePools<P> register(String id, Codec<P> codec) {
        return IRegistry.register(IRegistry.STRUCTURE_POOL_ELEMENT, id, () -> {
            return codec;
        });
    }
}
