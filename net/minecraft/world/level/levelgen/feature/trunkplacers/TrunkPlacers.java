...
public class TrunkPlacers<P extends TrunkPlacer> {
    ...
    public static final TrunkPlacers<TrunkPlacerBending> BENDING_TRUNK_PLACER = register("bending_trunk_placer", TrunkPlacerBending.CODEC);
    private final Codec<P> codec;

    private static <P extends TrunkPlacer> TrunkPlacers<P> register(String id, Codec<P> codec) {
        return IRegistry.register(IRegistry.TRUNK_PLACER_TYPES, id, new TrunkPlacers<>(codec));
    }
