...
public class WorldGenFoilagePlacers<P extends WorldGenFoilagePlacer> {
    ...
    public static final WorldGenFoilagePlacers<WorldGenFoliagePlacerRandomSpread> RANDOM_SPREAD_FOLIAGE_PLACER = register("random_spread_foliage_placer", WorldGenFoliagePlacerRandomSpread.CODEC);
    private final Codec<P> codec;

    private static <P extends WorldGenFoilagePlacer> WorldGenFoilagePlacers<P> register(String id, Codec<P> codec) {
        return IRegistry.register(IRegistry.FOLIAGE_PLACER_TYPES, id, new WorldGenFoilagePlacers<>(codec));
    }
