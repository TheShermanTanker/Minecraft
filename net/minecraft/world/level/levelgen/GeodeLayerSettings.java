...
public class GeodeLayerSettings {
    ...
    public static final Codec<GeodeLayerSettings> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(LAYER_RANGE.fieldOf("filling").orElse(1.7D).forGetter((geodeLayerSettings) -> {
            return geodeLayerSettings.filling;
        }), LAYER_RANGE.fieldOf("inner_layer").orElse(2.2D).forGetter((geodeLayerSettings) -> {
            return geodeLayerSettings.innerLayer;
        }), LAYER_RANGE.fieldOf("middle_layer").orElse(3.2D).forGetter((geodeLayerSettings) -> {
            return geodeLayerSettings.middleLayer;
        }), LAYER_RANGE.fieldOf("outer_layer").orElse(4.2D).forGetter((geodeLayerSettings) -> {
