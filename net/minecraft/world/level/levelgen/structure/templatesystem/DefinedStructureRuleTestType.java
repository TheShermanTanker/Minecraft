...
public interface DefinedStructureRuleTestType<P extends DefinedStructureRuleTest> {
    ...
    static <P extends DefinedStructureRuleTest> DefinedStructureRuleTestType<P> register(String id, Codec<P> codec) {
        return IRegistry.register(IRegistry.RULE_TEST, id, () -> {
            return codec;
        });
    }
}
