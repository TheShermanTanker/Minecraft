...
public class WorldGenJunglePyramidPiece extends WorldGenScatteredPiece {
    ...
    public WorldGenJunglePyramidPiece(NBTTagCompound nbt) {
    ...
    public void postProcess(GeneratorAccessSeed world, StructureManager structureAccessor, ChunkGenerator chunkGenerator, Random random, StructureBoundingBox chunkBox, ChunkCoordIntPair chunkPos, BlockPosition pos) {
        if (this.updateAverageGroundHeight(world, chunkBox, 0)) {
            ...
            this.placeBlock(world, Blocks.AIR.getBlockData(), 1, 5, 5, chunkBox);
            this.placeBlock(world, Blocks.AIR.getBlockData(), 10, 5, 5, chunkBox);
            this.placeBlock(world, Blocks.AIR.getBlockData(), 1, 5, 9, chunkBox);
            this.placeBlock(world, Blocks.AIR.getBlockData(), 10, 5, 9, chunkBox);
            ...
            this.placeBlock(world, Blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.EAST).set(BlockTripwireHook.ATTACHED, Boolean.valueOf(true)), 1, -3, 8, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.WEST).set(BlockTripwireHook.ATTACHED, Boolean.valueOf(true)), 4, -3, 8, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.EAST, Boolean.valueOf(true)).set(BlockTripwire.WEST, Boolean.valueOf(true)).set(BlockTripwire.ATTACHED, Boolean.valueOf(true)), 2, -3, 8, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.EAST, Boolean.valueOf(true)).set(BlockTripwire.WEST, Boolean.valueOf(true)).set(BlockTripwire.ATTACHED, Boolean.valueOf(true)), 3, -3, 8, chunkBox);
            ...
            this.placeBlock(world, Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.NORTH, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.WEST, BlockPropertyRedstoneSide.SIDE), 5, -3, 1, chunkBox);
            this.placeBlock(world, Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.EAST, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.WEST, BlockPropertyRedstoneSide.SIDE), 4, -3, 1, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 3, -3, 1, chunkBox);
            if (!this.placedTrap1) {
                this.placedTrap1 = this.createDispenser(world, chunkBox, random, 3, -2, 1, EnumDirection.NORTH, LootTables.JUNGLE_TEMPLE_DISPENSER);
            }

            this.placeBlock(world, Blocks.VINE.getBlockData().set(BlockVine.SOUTH, Boolean.valueOf(true)), 3, -2, 2, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.NORTH).set(BlockTripwireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 1, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE_HOOK.getBlockData().set(BlockTripwireHook.FACING, EnumDirection.SOUTH).set(BlockTripwireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 5, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.NORTH, Boolean.valueOf(true)).set(BlockTripwire.SOUTH, Boolean.valueOf(true)).set(BlockTripwire.ATTACHED, Boolean.valueOf(true)), 7, -3, 2, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.NORTH, Boolean.valueOf(true)).set(BlockTripwire.SOUTH, Boolean.valueOf(true)).set(BlockTripwire.ATTACHED, Boolean.valueOf(true)), 7, -3, 3, chunkBox);
            this.placeBlock(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.NORTH, Boolean.valueOf(true)).set(BlockTripwire.SOUTH, Boolean.valueOf(true)).set(BlockTripwire.ATTACHED, Boolean.valueOf(true)), 7, -3, 4, chunkBox);
            this.placeBlock(world, Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.EAST, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.WEST, BlockPropertyRedstoneSide.SIDE), 8, -3, 6, chunkBox);
            this.placeBlock(world, Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.WEST, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.SOUTH, BlockPropertyRedstoneSide.SIDE), 9, -3, 6, chunkBox);
            this.placeBlock(world, Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.NORTH, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.SOUTH, BlockPropertyRedstoneSide.UP), 9, -3, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 9, -3, 4, chunkBox);
            this.placeBlock(world, blockState5, 9, -2, 4, chunkBox);
            if (!this.placedTrap2) {
                this.placedTrap2 = this.createDispenser(world, chunkBox, random, 9, -2, 3, EnumDirection.WEST, LootTables.JUNGLE_TEMPLE_DISPENSER);
            }

            this.placeBlock(world, Blocks.VINE.getBlockData().set(BlockVine.EAST, Boolean.valueOf(true)), 8, -1, 3, chunkBox);
            this.placeBlock(world, Blocks.VINE.getBlockData().set(BlockVine.EAST, Boolean.valueOf(true)), 8, -2, 3, chunkBox);
            if (!this.placedMainChest) {
                this.placedMainChest = this.createChest(world, chunkBox, random, 8, -3, 3, LootTables.JUNGLE_TEMPLE);
            }

            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 9, -3, 2, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 8, -3, 1, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 4, -3, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 5, -2, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 5, -1, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 6, -3, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 7, -2, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 7, -1, 5, chunkBox);
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 8, -3, 5, chunkBox);
            this.generateBox(world, chunkBox, 9, -1, 1, 9, -1, 5, false, random, STONE_SELECTOR);
            this.generateAirBox(world, chunkBox, 8, -3, 8, 10, -1, 10);
            this.placeBlock(world, Blocks.CHISELED_STONE_BRICKS.getBlockData(), 8, -2, 11, chunkBox);
            this.placeBlock(world, Blocks.CHISELED_STONE_BRICKS.getBlockData(), 9, -2, 11, chunkBox);
            this.placeBlock(world, Blocks.CHISELED_STONE_BRICKS.getBlockData(), 10, -2, 11, chunkBox);
            ...
            this.placeBlock(world, Blocks.MOSSY_COBBLESTONE.getBlockData(), 10, -2, 9, chunkBox);
            this.placeBlock(world, blockState5, 8, -2, 9, chunkBox);
            this.placeBlock(world, blockState5, 8, -2, 10, chunkBox);
            this.placeBlock(world, Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.NORTH, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.SOUTH, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.EAST, BlockPropertyRedstoneSide.SIDE).set(BlockRedstoneWire.WEST, BlockPropertyRedstoneSide.SIDE), 10, -1, 9, chunkBox);
            this.placeBlock(world, Blocks.STICKY_PISTON.getBlockData().set(BlockPiston.FACING, EnumDirection.UP), 9, -2, 8, chunkBox);
            this.placeBlock(world, Blocks.STICKY_PISTON.getBlockData().set(BlockPiston.FACING, EnumDirection.WEST), 10, -2, 8, chunkBox);
            this.placeBlock(world, Blocks.STICKY_PISTON.getBlockData().set(BlockPiston.FACING, EnumDirection.WEST), 10, -1, 8, chunkBox);
            this.placeBlock(world, Blocks.REPEATER.getBlockData().set(BlockRepeater.FACING, EnumDirection.NORTH), 10, -2, 10, chunkBox);
            if (!this.placedHiddenChest) {
                this.placedHiddenChest = this.createChest(world, chunkBox, random, 9, -3, 10, LootTables.JUNGLE_TEMPLE);
            }
