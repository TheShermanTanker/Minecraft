...
public class Containers<T extends Container> {
    ...
    private static <T extends Container> Containers<T> register(String id, Containers.Supplier<T> factory) {
        return IRegistry.register(IRegistry.MENU, id, new Containers<>(factory));
    }

    private Containers(Containers.Supplier<T> factory) {
