...
public class MobEffectBase {
    ...
    @Nullable
    public static MobEffectBase fromId(int rawId) {
        return IRegistry.MOB_EFFECT.fromId(rawId);
    }

    public static int getId(MobEffectBase type) {
    ...
    public void tick(EntityLiving entity, int amplifier) {
        ...
        } else if ((this != MobEffectList.HEAL || entity.isInvertedHealAndHarm()) && (this != MobEffectList.HARM || !entity.isInvertedHealAndHarm())) {
            if (this == MobEffectList.HARM && !entity.isInvertedHealAndHarm() || this == MobEffectList.HEAL && entity.isInvertedHealAndHarm()) {
    ...
    public void applyInstantEffect(@Nullable Entity source, @Nullable Entity attacker, EntityLiving target, int amplifier, double proximity) {
        if ((this != MobEffectList.HEAL || target.isInvertedHealAndHarm()) && (this != MobEffectList.HARM || !target.isInvertedHealAndHarm())) {
            if (this == MobEffectList.HARM && !target.isInvertedHealAndHarm() || this == MobEffectList.HEAL && target.isInvertedHealAndHarm()) {
    ...
    public MobEffectBase addAttributeModifier(AttributeBase attribute, String uuid, double amount, AttributeModifier.Operation operation) {
