...
public class CriterionSlideDownBlock extends CriterionTriggerAbstract<CriterionSlideDownBlock.TriggerInstance> {
    ...
    @Override
    public CriterionSlideDownBlock.TriggerInstance createInstance(JsonObject jsonObject, CriterionConditionEntity.Composite composite, LootDeserializationContext deserializationContext) {
        ...
        return new CriterionSlideDownBlock.TriggerInstance(composite, block, statePropertiesPredicate);
    }
    ...
    public static class TriggerInstance extends CriterionInstanceAbstract {
        ...
        public TriggerInstance(CriterionConditionEntity.Composite player, @Nullable Block block, CriterionTriggerProperties state) {
            super(CriterionSlideDownBlock.ID, player);
            this.block = block;
            this.state = state;
        }

        public static CriterionSlideDownBlock.TriggerInstance slidesDownBlock(Block block) {
            return new CriterionSlideDownBlock.TriggerInstance(CriterionConditionEntity.Composite.ANY, block, CriterionTriggerProperties.ANY);
        }
