...
public class MathHelper {
    ...
    private static final float[] SIN = SystemUtils.make(new float[65536], (sineTable) -> {
    ...
    public static Vec3D catmullRomSplinePos(Vec3D vec3, Vec3D vec32, Vec3D vec33, Vec3D vec34, double d) {
        ...
        return new Vec3D(vec3.x * e + vec32.x * f + vec33.x * g + vec34.x * h, vec3.y * e + vec32.y * f + vec33.y * g + vec34.y * h, vec3.z * e + vec32.z * f + vec33.z * g + vec34.z * h);
    }

    public static long getSeed(BaseBlockPosition vec) {
    ...
    public static boolean rayIntersectsAABB(Vec3D vec3, Vec3D vec32, AxisAlignedBB aABB) {
