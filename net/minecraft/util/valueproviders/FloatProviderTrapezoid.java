...
public class FloatProviderTrapezoid extends FloatProvider {
    public static final Codec<FloatProviderTrapezoid> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        })).apply(instance, FloatProviderTrapezoid::new);
    ...
    public static FloatProviderTrapezoid of(float min, float max, float plateau) {
        return new FloatProviderTrapezoid(min, max, plateau);
    }

    private FloatProviderTrapezoid(float min, float max, float plateau) {
        this.min = min;
        this.max = max;
