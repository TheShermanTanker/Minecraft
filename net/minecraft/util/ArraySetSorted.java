...
public class ArraySetSorted<T> extends AbstractSet<T> {
    ...
    public static <T extends Comparable<T>> ArraySetSorted<T> create(int initialCapacity) {
    ...
    public static <T> ArraySetSorted<T> create(Comparator<T> comparator, int initialCapacity) {
        return new ArraySetSorted<>(initialCapacity, comparator);
    }
    ...
    public Iterator<T> iterator() {
        return new ArraySetSorted.ArrayIterator();
    }
