...
public class DataConverterRegistry {
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        builder.addFixer(DataConverterBlockRenameWithJigsaw.create(schema134, "Renamed grimstone blocks to deepslate", createRenamer(immutableMap3)));
        Schema schema135 = builder.addSchema(2700, SAME_NAMESPACED);
        builder.addFixer(DataConverterBlockRenameWithJigsaw.create(schema135, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        Schema schema136 = builder.addSchema(2701, SAME_NAMESPACED);
        builder.addFixer(new DataConverterSavedDataFeaturePoolElement(schema136));
        Schema schema137 = builder.addSchema(2702, SAME_NAMESPACED);
        builder.addFixer(new DataConverterAbstractArrowPickup(schema137));
        Schema schema138 = builder.addSchema(2704, DataConverterSchemaV2704::new);
        builder.addFixer(new DataConverterAddChoices(schema138, "Added Goat", DataConverterTypes.ENTITY));
        Schema schema139 = builder.addSchema(2707, DataConverterSchemaV2707::new);
        ...
        builder.addFixer(new DataConverterStatsRename(schema140, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time")));
