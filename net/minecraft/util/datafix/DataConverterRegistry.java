...
public class DataConverterRegistry {
    ...
    private static void addFixers(DataFixerBuilder builder) {
        ...
        builder.addFixer(new DataConverterBedBlock(schema34, true));
        ...
        builder.addFixer(new ChunkConverterPalette(schema39, true));
        ...
        builder.addFixer(BlockRenameFixWithJigsaw.create(schema128, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        builder.addFixer(BlockRenameFixWithJigsaw.create(schema132, "Renamed copper blocks to new oxidized terms", createRenamer(immutableMap)));
        ...
        builder.addFixer(BlockRenameFixWithJigsaw.create(schema133, "Rename copper blocks suffixes", createRenamer(immutableMap2)));
        ...
        builder.addFixer(DataConverterItemName.create(schema134, "Renamed grimstone block items to deepslate", createRenamer(immutableMap3)));
        builder.addFixer(BlockRenameFixWithJigsaw.create(schema134, "Renamed grimstone blocks to deepslate", createRenamer(immutableMap3)));
        Schema schema135 = builder.addSchema(2700, SAME_NAMESPACED);
        builder.addFixer(BlockRenameFixWithJigsaw.create(schema135, "Renamed cave vines blocks", createRenamer(ImmutableMap.of("minecraft:cave_vines_head", "minecraft:cave_vines", "minecraft:cave_vines_body", "minecraft:cave_vines_plant"))));
        ...
        builder.addFixer(new DataConverterAddChoices(schema138, "Added Goat", DataConverterTypes.ENTITY));
        Schema schema139 = builder.addSchema(2707, V2707::new);
        builder.addFixer(new DataConverterAddChoices(schema139, "Added Marker", DataConverterTypes.ENTITY));
        ...
        builder.addFixer(DataConverterItemName.create(schema141, "Rename azalea_leaves_flowers", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
        builder.addFixer(DataConverterBlockRename.create(schema141, "Rename azalea_leaves_flowers items", createRenamer(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))));
    }
