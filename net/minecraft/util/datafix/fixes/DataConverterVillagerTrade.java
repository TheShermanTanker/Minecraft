...
public class DataConverterVillagerTrade extends DataConverterNamedEntity {
    public DataConverterVillagerTrade(Schema outputSchema, boolean changesType) {
        super(outputSchema, changesType, "Villager trade fix", DataConverterTypes.ENTITY, "minecraft:villager");
    }
    ...
    protected Typed<?> fix(Typed<?> inputType) {
        ...
        if (!(type instanceof ListType)) {
            ...
            OpticFinder<Pair<String, String>> opticFinder7 = DSL.fieldFinder("id", DSL.named(DataConverterTypes.ITEM_NAME.typeName(), DataConverterSchemaNamed.namespacedString()));
