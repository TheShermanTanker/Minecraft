...
public class DataConverterSpawnEgg extends DataFix {
    ...
    public DataConverterSpawnEgg(Schema outputSchema, boolean changesType) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder<?> opticFinder5 = DSL.typeFinder(schema.getTypeRaw(DataConverterTypes.ENTITY));
        Type<?> type2 = this.getOutputSchema().getTypeRaw(DataConverterTypes.ENTITY);
