...
public class DataConverterNewVillage extends DataFix {
    public DataConverterNewVillage(Schema outputSchema, boolean changesType) {
    ...
    private <SF> TypeRewriteRule cap(CompoundListType<String, SF> compoundListType) {
        ...
        Type<?> type2 = this.getInputSchema().getType(DataConverterTypes.STRUCTURE_FEATURE);
        ...
        return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("NewVillageFix", type, (typed) -> {
            ...
            return typed.update(DSL.remainderFinder(), (dynamic) -> {
                return dynamic.update("id", (dynamicx) -> {
                    return Objects.equals(DataConverterSchemaNamed.ensureNamespaced(dynamicx.asString("")), "minecraft:new_village") ? dynamicx.createString("minecraft:village") : dynamicx;
                });
            });
        }));
    }
