...
public class DataConverterPotionId extends DataFix {
    ...
    public DataConverterPotionId(Schema outputSchema, boolean changesType) {
            ...
            if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:potion")) {
                ...
                if (optional2.isPresent()) {
                    ...
                    if (!optional3.isPresent()) {
                        ...
                        if ((s & 16384) == 16384) {
                            typed2 = typed2.set(opticFinder, Pair.of(DataConverterTypes.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                        }
                    }
