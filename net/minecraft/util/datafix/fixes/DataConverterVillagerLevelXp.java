...
public class DataConverterVillagerLevelXp extends DataFix {
    ...
    public static int getMinXpPerLevel(int level) {
        return LEVEL_XP_THRESHOLDS[MathHelper.clamp(level - 1, 0, LEVEL_XP_THRESHOLDS.length - 1)];
    }

    public DataConverterVillagerLevelXp(Schema outputSchema, boolean changesType) {
