...
public class DataConverterStatsRename extends DataFix {
    private final String name;
    private final Map<String, String> renames;

    public DataConverterStatsRename(Schema outputSchema, String name, Map<String, String> replacements) {
    ...
    private TypeRewriteRule createCriteriaRule() {
        ...
        Type<?> type2 = this.getInputSchema().getType(DataConverterTypes.OBJECTIVE);
        ...
        if (type3 == null) {
            ...
            OpticFinder<String> opticFinder3 = DSL.fieldFinder("id", DataConverterSchemaNamed.namespacedString());
    ...
    private TypeRewriteRule createStatRule() {
        ...
        Type<?> type2 = this.getInputSchema().getType(DataConverterTypes.STATS);
        OpticFinder<?> opticFinder = type2.findField("stats");
        OpticFinder<?> opticFinder2 = opticFinder.type().findField("minecraft:custom");
        OpticFinder<String> opticFinder3 = DataConverterSchemaNamed.namespacedString().finder();
        return this.fixTypeEverywhereTyped(this.name, type2, type, (typed) -> {
            return typed.updateTyped(opticFinder, (typedx) -> {
                return typedx.updateTyped(opticFinder2, (typed) -> {
                    return typed.update(opticFinder3, (old) -> {
