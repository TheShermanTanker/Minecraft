...
public class DataConverterTrappedChest extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        if (!(type3 instanceof ListType)) {
            ...
            Type<?> type4 = this.getInputSchema().getType(DataConverterTypes.CHUNK);
            ...
            if (!(type5 instanceof ListType)) {
                ...
                return TypeRewriteRule.seq((new DataConverterAddChoices(this.getOutputSchema(), "AddTrappedChestFix", DataConverterTypes.BLOCK_ENTITY)).makeRule(), this.fixTypeEverywhereTyped("Trapped Chest fix", type4, (typed) -> {
                    return typed.updateTyped(opticFinder2, (typedx) -> {
                        ...
                        if (!optional.isPresent()) {
                            ...
                            for(Typed<?> typed2 : list) {
                                DataConverterTrappedChest.TrappedChestSection trappedChestSection = new DataConverterTrappedChest.TrappedChestSection(typed2, this.getInputSchema());
                            ...
                            return typedx.updateTyped(opticFinder, (typed) -> {
                                return typed.updateTyped(taggedChoiceType.finder(), (typedx) -> {
                                    ...
                                    return intSet.contains(DataConverterLeaves.getIndex(k, l, m)) ? typedx.update(taggedChoiceType.finder(), (pair) -> {
    ...
    public static final class TrappedChestSection extends DataConverterLeaves.Section {
        @Nullable
