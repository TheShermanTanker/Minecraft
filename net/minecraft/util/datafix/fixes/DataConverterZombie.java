...
public class DataConverterZombie extends DataConverterNamedEntity {
    ...
    public DataConverterZombie(Schema outputSchema, boolean changesType) {
        super(outputSchema, changesType, "EntityZombieVillagerTypeFix", DataConverterTypes.ENTITY, "Zombie");
    }
