...
public class DataConverterEntityShulkerRotation extends DataConverterNamedEntity {
    public DataConverterEntityShulkerRotation(Schema outputSchema) {
        super(outputSchema, false, "EntityShulkerRotationFix", DataConverterTypes.ENTITY, "minecraft:shulker");
    }
