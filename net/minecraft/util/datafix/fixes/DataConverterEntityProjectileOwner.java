...
public class DataConverterEntityProjectileOwner extends DataFix {
    ...
    private Typed<?> updateEntity(Typed<?> typed, String string, Function<Dynamic<?>, Dynamic<?>> function) {
        Type<?> type = this.getInputSchema().getChoiceType(DataConverterTypes.ENTITY, string);
        Type<?> type2 = this.getOutputSchema().getChoiceType(DataConverterTypes.ENTITY, string);
