...
public class DataConverterHorse extends DataConverterEntityName {
    public DataConverterHorse(Schema outputSchema, boolean changesType) {
    ...
    protected Pair<String, Typed<?>> fix(String choice, Typed<?> typed) {
        ...
        if (Objects.equals("EntityHorse", choice)) {
            ...
            dynamic.remove("Type");
            Type<?> type = this.getOutputSchema().findChoiceType(DataConverterTypes.ENTITY).types().get(string);
