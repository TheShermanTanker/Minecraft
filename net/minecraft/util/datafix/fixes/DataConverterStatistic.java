...
public class DataConverterStatistic extends DataFix {
    ...
    public DataConverterStatistic(Schema outputSchema, boolean changesType) {
    ...
    protected String upgradeItem(String string) {
        return DataConverterFlatten.updateItem(string, 0);
    }

    protected String upgradeBlock(String string) {
        return DataConverterFlattenData.upgradeBlock(string);
    }
}
