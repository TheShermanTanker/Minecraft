...
public class DataConverterShulkerBoxItem extends DataFix {
    ...
    public DataConverterShulkerBoxItem(Schema outputSchema, boolean changesType) {
            ...
            if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:shulker_box")) {
                ...
                if (optional2.isPresent()) {
                    ...
                    if (optional3.isPresent()) {
                        ...
                        return typed.set(opticFinder2, typed2.set(opticFinder3, typed3.set(DSL.remainderFinder(), dynamic))).set(opticFinder, Pair.of(DataConverterTypes.ITEM_NAME.typeName(), NAMES_BY_COLOR[i % 16]));
                    }
                }
            }
