...
public abstract class DataConverterBlockRename extends DataFix {
    ...
    public DataConverterBlockRename(Schema oldSchema, String name) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        if (!Objects.equals(type, type2)) {
            ...
            TypeRewriteRule typeRewriteRule2 = this.fixTypeEverywhereTyped(this.name + " for block_state", this.getInputSchema().getType(DataConverterTypes.BLOCK_STATE), (typed) -> {
    ...
    public static DataFix create(Schema oldSchema, String name, Function<String, String> rename) {
        return new DataConverterBlockRename(oldSchema, name) {
            @Override
