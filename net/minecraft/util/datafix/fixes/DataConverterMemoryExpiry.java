...
public class DataConverterMemoryExpiry extends DataConverterNamedEntity {
    public DataConverterMemoryExpiry(Schema outputSchema, String choiceName) {
        super(outputSchema, false, "Memory expiry data fix (" + choiceName + ")", DataConverterTypes.ENTITY, choiceName);
    }
