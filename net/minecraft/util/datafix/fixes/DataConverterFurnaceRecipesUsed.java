...
public class DataConverterFurnaceRecipesUsed extends DataFix {
    public DataConverterFurnaceRecipesUsed(Schema outputSchema, boolean changesType) {
    ...
    private <R> TypeRewriteRule cap(Type<R> type) {
        ...
        OpticFinder<?> opticFinder2 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(DataConverterTypes.BLOCK_ENTITY, "minecraft:blast_furnace"));
        OpticFinder<?> opticFinder3 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(DataConverterTypes.BLOCK_ENTITY, "minecraft:smoker"));
        Type<?> type3 = this.getOutputSchema().getChoiceType(DataConverterTypes.BLOCK_ENTITY, "minecraft:furnace");
        Type<?> type4 = this.getOutputSchema().getChoiceType(DataConverterTypes.BLOCK_ENTITY, "minecraft:blast_furnace");
        Type<?> type5 = this.getOutputSchema().getChoiceType(DataConverterTypes.BLOCK_ENTITY, "minecraft:smoker");
        Type<?> type6 = this.getInputSchema().getType(DataConverterTypes.BLOCK_ENTITY);
        Type<?> type7 = this.getOutputSchema().getType(DataConverterTypes.BLOCK_ENTITY);
