...
public class DataConverterMaterialId extends DataFix {
    public static final Int2ObjectMap<String> ITEM_NAMES = DataFixUtils.make(new Int2ObjectOpenHashMap<>(), (int2ObjectOpenHashMap) -> {
    ...
    public DataConverterMaterialId(Schema outputSchema, boolean changesType) {
    ...
    public TypeRewriteRule makeRule() {
        Type<Either<Integer, Pair<String, String>>> type = DSL.or(DSL.intType(), DSL.named(DataConverterTypes.ITEM_NAME.typeName(), DataConverterSchemaNamed.namespacedString()));
        Type<Pair<String, String>> type2 = DSL.named(DataConverterTypes.ITEM_NAME.typeName(), DataConverterSchemaNamed.namespacedString());
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(DataConverterTypes.ITEM_STACK), this.getOutputSchema().getType(DataConverterTypes.ITEM_STACK), (typed) -> {
            return typed.update(opticFinder, type2, (either) -> {
                return either.map((integer) -> {
                    return Pair.of(DataConverterTypes.ITEM_NAME.typeName(), getItem(integer));
                }, (pair) -> {
                    return pair;
                });
            });
