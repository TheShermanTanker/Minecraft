...
public abstract class DataConverterBlockRenameWithJigsaw extends DataConverterBlockRename {
    private final String name;

    public DataConverterBlockRenameWithJigsaw(Schema oldSchema, String name) {
    ...
    public static DataFix create(Schema oldSchema, String name, Function<String, String> rename) {
        return new DataConverterBlockRenameWithJigsaw(oldSchema, name) {
            @Override
