...
public class DataConverterSchemaV1451_6 extends DataConverterSchemaNamed {
        ...
        public <T> T apply(DynamicOps<T> dynamicOps, T object) {
            ...
            return DataFixUtils.orElse(dynamic.get("CriteriaName").asString().get().left().map((string) -> {
                ...
                if (i < 0) {
                    ...
                    try {
                        MinecraftKey resourceLocation = MinecraftKey.of(string.substring(0, i), '.');
                        MinecraftKey resourceLocation2 = MinecraftKey.of(string.substring(i + 1), '.');
    ...
    public DataConverterSchemaV1451_6(int versionKey, Schema parent) {
