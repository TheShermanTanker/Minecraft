...
public class HttpUtilities {
    ...
    public static CompletableFuture<?> downloadTo(File file, String url, Map<String, String> headers, int maxFileSize, @Nullable IProgressUpdate progressListener, Proxy proxy) {
        return CompletableFuture.supplyAsync(() -> {
            HttpURLConnection httpURLConnection = null;
            InputStream inputStream = null;
            OutputStream outputStream = null;
            if (progressListener != null) {
                progressListener.progressStart(new ChatMessage("resourcepack.downloading"));
                progressListener.progressStage(new ChatMessage("resourcepack.requesting"));
            }
            ...
            try {
                try {
                    ...
                    if (progressListener != null) {
                        progressListener.progressStage(new ChatMessage("resourcepack.progress", String.format(Locale.ROOT, "%.2f", g / 1000.0F / 1000.0F)));
                    }
