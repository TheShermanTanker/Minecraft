...
public class ActiveMetricsRecorder implements MetricsRecorder {
    ...
    private ActiveMetricsRecorder(MetricsSamplerProvider samplerSource, LongSupplier timeGetter, Executor dumpExecutor, MetricsPersister dumper, Consumer<MethodProfilerResults> resultConsumer, Consumer<Path> dumpConsumer) {
    ...
    public static ActiveMetricsRecorder createStarted(MetricsSamplerProvider source, LongSupplier timeGetter, Executor dumpExecutor, MetricsPersister dumper, Consumer<MethodProfilerResults> resultConsumer, Consumer<Path> dumpConsumer) {
