...
public class NativeModuleLister {
            ...
            if (i == 0) {
                ...
                if (!Version.INSTANCE.GetFileVersionInfo(path, 0, i, pointer)) {
                    ...
                    if (!optionalInt.isPresent()) {
                        ...
                        int k = j & '\uffff';
                        int l = (j & -65536) >> 16;
                        String string = queryVersionString(pointer, langTableKey("FileDescription", k, l), intByReference2);
                        String string2 = queryVersionString(pointer, langTableKey("CompanyName", k, l), intByReference2);
                        String string3 = queryVersionString(pointer, langTableKey("FileVersion", k, l), intByReference2);
    ...
    public static void addCrashSection(CrashReportSystemDetails section) {
