...
public class Particles {
    ...
    private static <T extends ParticleParam> Particle<T> register(String name, ParticleParam.Deserializer<T> factory, Function<Particle<T>, Codec<T>> function) {
        return IRegistry.register(IRegistry.PARTICLE_TYPE, name, new Particle<T>(false, factory) {
            @Override
