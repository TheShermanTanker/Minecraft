...
public final class Matrix3f {
    ...
    private static Pair<Float, Float> approxGivensQuat(float upperLeft, float diagonalAverage, float lowerRight) {
        ...
        if (G * diagonalAverage * diagonalAverage < f * f) {
            float h = MathHelper.fastInvSqrt(diagonalAverage * diagonalAverage + f * f);
    ...
    private static Pair<Float, Float> qrGivensQuat(float f, float g) {
        ...
        float l = MathHelper.fastInvSqrt(j * j + i * i);
        j = j * l;
        i = i * l;
        return Pair.of(i, j);
    }
    ...
    public Triple<Quaternion, Vector3fa, Quaternion> svdDecompose() {
        ...
        Vector3fa vector3f = new Vector3fa(matrix3f5.m00 * f, matrix3f5.m11 * f, matrix3f5.m22 * f);
