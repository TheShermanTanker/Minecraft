...
public final class Quaternion {
    ...
    public Vector3fa toXYZ() {
        ...
        return Math.abs(k) > 0.999F * j ? new Vector3fa(2.0F * (float)Math.atan2((double)this.i(), (double)this.r()), l, 0.0F) : new Vector3fa((float)Math.atan2((double)(2.0F * this.j() * this.k() + 2.0F * this.i() * this.r()), (double)(f - g - h + i)), l, (float)Math.atan2((double)(2.0F * this.i() * this.j() + 2.0F * this.r() * this.k()), (double)(f + g - h - i)));
    }

    public Vector3fa toXYZDegrees() {
        Vector3fa vector3f = this.toXYZ();
        return new Vector3fa((float)Math.toDegrees((double)vector3f.x()), (float)Math.toDegrees((double)vector3f.y()), (float)Math.toDegrees((double)vector3f.z()));
    }
    ...
    public Vector3fa toYXZ() {
        ...
        float k = 2.0F * this.r() * this.i() - 2.0F * this.j() * this.k();
        float l = (float)Math.asin((double)(k / j));
        return Math.abs(k) > 0.999F * j ? new Vector3fa(l, 2.0F * (float)Math.atan2((double)this.j(), (double)this.r()), 0.0F) : new Vector3fa(l, (float)Math.atan2((double)(2.0F * this.i() * this.k() + 2.0F * this.j() * this.r()), (double)(f - g - h + i)), (float)Math.atan2((double)(2.0F * this.i() * this.j() + 2.0F * this.r() * this.k()), (double)(f - g + h - i)));
    }

    public Vector3fa toYXZDegrees() {
        Vector3fa vector3f = this.toYXZ();
        return new Vector3fa((float)Math.toDegrees((double)vector3f.x()), (float)Math.toDegrees((double)vector3f.y()), (float)Math.toDegrees((double)vector3f.z()));
    }
