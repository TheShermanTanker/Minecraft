...
public final class Transformation {
    ...
    @Nullable
    private Vector3fa translation;
    @Nullable
    private Quaternion leftRotation;
    @Nullable
    private Vector3fa scale;
    @Nullable
    ...
    public Transformation(@Nullable Vector3fa translation, @Nullable Quaternion rotation2, @Nullable Vector3fa scale, @Nullable Quaternion rotation1) {
        this.matrix = compose(translation, rotation2, scale, rotation1);
        this.translation = translation != null ? translation : new Vector3fa();
        this.leftRotation = rotation2 != null ? rotation2 : Quaternion.ONE.copy();
        this.scale = scale != null ? scale : new Vector3fa(1.0F, 1.0F, 1.0F);
    ...
    private void ensureDecomposed() {
        if (!this.decomposed) {
            Pair<Matrix3f, Vector3fa> pair = toAffine(this.matrix);
            Triple<Quaternion, Vector3fa, Quaternion> triple = pair.getFirst().svdDecompose();
    ...
    private static Matrix4f compose(@Nullable Vector3fa translation, @Nullable Quaternion rotation2, @Nullable Vector3fa scale, @Nullable Quaternion rotation1) {
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        if (rotation2 != null) {
    ...
    public static Pair<Matrix3f, Vector3fa> toAffine(Matrix4f affineTransform) {
        affineTransform.multiply(1.0F / affineTransform.m33);
        Vector3fa vector3f = new Vector3fa(affineTransform.m03, affineTransform.m13, affineTransform.m23);
    ...
    public Vector3fa getTranslation() {
    ...
    public Transformation slerp(Transformation transformation, float f) {
        Vector3fa vector3f = this.getTranslation();
        Quaternion quaternion = this.getLeftRotation();
        Vector3fa vector3f2 = this.getScale();
